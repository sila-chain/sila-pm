...
**Summary:** we'll discuss state of research around shortening Sila's finality time, discussing some of the possible paths we might take to get there, and the (more than just technical) tradeoffs they imply. 
...
* Committee size and min balance: can we do 1 SIL validators  
  * Francesco bearish on 1 SIL, \[redacted\] wants the beacon state in memory, not on disk  
