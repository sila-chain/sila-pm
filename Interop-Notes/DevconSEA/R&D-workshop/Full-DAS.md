...
### Full DAS, as we discuss here (after SilaPeerDAS session)

- next logical step after SilaPeerDAS
...
**Questions**
- should there be something in between SilaPeerDAS and FullDAS?
    - There is no SilaPeerDAS even, neither sampling (yet)
