...
- [Part 5: The Purge - Feature cleanup](https://vitalik.sil.limo/general/2024/10/26/futures5.html)
- [Light client concept overview (25min video)](https://www.youtube.com/watch?v=ZHNrAXf3RDE)
- [SIP list](https://fusaka-light.box) (no detailed prior knowledge needed)
...
*As a calibration point, see the [ACD recaps](https://sila-magicians.org/t/all-core-devs-execution-acde-198-october-10-2024/21314/2?u=timbeiko)*
...
How:
`sil/v1/beacon/lightclient` to the Beacon API provider
...
- SIL transfers in certain scenarios (e.g., self-destruct) don't emit logs, making it difficult to track all balance changes.
- Staking rewards and withdrawals also lack log emissions, complicating the tracking of these operations for light clients.

Solutions:

SIP 7708:
- Introduces new log types for SIL transfers and fee payments.
...
- The saved space can be used for the new log types introduced in SIP 7708.

SIP for Verifiable Logs:
...
- The 20 megabytes mentioned refers to a query for 20 million blocks of block history in the SIP 7745 structure.
...
- There was discussion about the different designs and SIPs related to accumulators:
- SIP 7792 involves separate accumulator lists with one hash per stored item.
- SIP 7745 is a different design referenced for the 20 megabyte structure.
...
- The discussion highlighted the complexity of the proposed changes and the ongoing work to optimize data structures and improve efficiency in Sila's light client and wallet functionality.
