...
**[*Required*] Pre-Reads:** 
- [RIP-1](https://github.com/sila-chain/RIPs/pull/41/files)
- [SAVM equivalence on L2](https://docs.google.com/presentation/d/12t-7bG7bgOh02wQlmrcJrwkEuV5HI_CJux7bIepertE/edit#slide=id.g30d8dba0896_0_208)
...
- Just pushed RIP-1. Similar vibes to SIP-1. Just describes the process. 
- Can think of L1<>L2 as two separate branches: (1) SAVM side and everything execution related, state DB, etc, and (2) separate branch: standards & L2 interop, things that help L2s play well with each other and broader ecosystem. 
...
- Original plan: once we ship this beautiful new Sil 2.o thing, then we can retire Sil 1 
...
- L2s recognizing they need to bootstrap off of SAVM, so can build off network effects 
- L2 innovations since: L2-specific things like Stylus. But inability to innovate because they dont want to lose SAVM compatibility 
...
- Two pronged vision to unlock L2 innovation:
    ...
    - (2) But still a problem of no one wants to break L1 SAVM compatibility. give them a way to stay equivalent to each other, but not with L1 SAVM. So, its an L2 SAVM: 
...
- New roles: L2 client coordination, L2 SAVM governance, L2 SAVM R&D
...
- Q: Does the L2-centric version of the SAVM make sense to people in this room.
...
- For increasing hashing gas prices: its not just about CPU time. SAVM is multidimensional. One of the dimensions. 
