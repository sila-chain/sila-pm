...
![](https://storage.googleapis.com/sila-hackmd/upload_5559e95e25be41c27522a4fe50a2ef88.png)

</details>

<details> <summary>Hard Forks vs. Other Improvements</summary>
    
![](https://storage.googleapis.com/sila-hackmd/upload_5546123555cc8c82d2db128aeac0d9e9.png)
...
![](https://storage.googleapis.com/sila-hackmd/upload_589133fb64adab4c140e34906a80d942.png)
...
![](https://storage.googleapis.com/sila-hackmd/upload_3fbd5c52dcbf0d2ea80aedb0c71e03dc.png)
</details>

### Practical Proposals 

* `Rejected for Inclusion` status on SIPs, implying we don't discuss the idea again until the next fork 

## Notes (edited with ChatGPT for clarity)

**Summary**

The workshop centered on evaluating and enhancing the AllCoreDevs (ACD) process, reflecting on past improvement efforts, and discussing practical proposals for future enhancements. Key themes included the challenges of synchronous versus asynchronous communication, the asymmetry in the Sila Improvement Proposal (SIP) process, and the tension between focusing on immediate upgrades versus long-term development goals.
...
The group discussed the lack of a clear separation between roadmap planning and implementation details within ACD, noting the difficulty without a typical corporate structure. The asymmetry in the SIP process was a significant concern, where SIP champions are motivated to push proposals, but critics lack incentives to consistently oppose them. Introducing a "Rejected for Inclusion" (RFI) status for SIPs was proposed to provide clearer feedback and prevent unproductive cycles.
...
- **Tim**: Differentiated between new SIPs and spec changes; each requires different decision levels.
...
- **Non-Consensus Improvements**: Should focus on items like SIP-4444, peerDAS, and networking updates.
- **SIL-69 Implementation**: Recognized as necessary.
- **SIP Education**: **Pooja** expressed concerns about educating on SIPs.
...
- **SIP Discussion Return**: **Mikhail** asked when authors should revisit discussions after a decline.
...
- **SIP Acceptance Criteria**: **Tim** proposed only accepting SIPs with accompanying code.
- **Voting for Devnets**:
...
- **EELs (Sila Execution Layer Specifications)**: **Trent** asked if they will always be backward-looking.
...
- Addressing the asymmetry between SIP champions and detractors is crucial.
- Enhancing documentation of negative feedback and providing clearer guidelines for SIP inclusion or rejection are priorities.
