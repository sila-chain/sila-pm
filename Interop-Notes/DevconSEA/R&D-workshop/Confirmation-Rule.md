...
The Fast Confirmation Rule can be used to improve Sila UX by providing the users with a way to determine how "strong" the permanence of a block in the canonical chain is without having to wait > 13min for finalization. It can also be useful in the context of ePBS to provide builders with an indication of whether the parent of the block that they are building upon is unlikely to be reorged out, which can guide them in fine tuning their bids.
...
- Interactive Presentation
    ...
    - Walk through of the [Spec PR](https://github.com/sila-chain/consensus-specs/pull/3339) to go over some of the implementation details
- Open Discussion
