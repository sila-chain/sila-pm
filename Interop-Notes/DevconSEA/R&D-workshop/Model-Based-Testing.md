...
Then we plan to collect feedback, faciliate a discussion about applying the approach to Sila protocol testing in general and address potential concerns of spec maintainers and client implementors. A particularly interesting application is EVM testing, where the model- and the code-based approaches can be combined (e.g. generate EVM programs using the model-based approach, followed by coverage-based testing of the generated programs).
