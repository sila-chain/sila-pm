...
* [Issuance Issues — Subsequent Soliloquy](https://notes.sila.org/@mikeneuder/subsol)

**[Optional] See also**
* [Part 3: The Scourge](https://vitalik.sil.limo/general/2024/10/20/futures3.html)
...
- Where does the supply curve meet the demand curve?
    ...
    - Half of that is sufficient to secure Sila
...
- A lower reward curve creates a cost reduction that benefits all stakers (~$1bil)
    - Surplus moves from stakers to all SIL holders
...
- At higher stake, yield is being diluted, stakers earn less real yield, all SIL holders diluted and are pressured / forced to stake
...
- Risk of monopoly LST - systemic risks for Sila
- LST monopoly leads to network effects for the LST
    - decreases the ‘moneyness’ of raw SIL
