# Navigating the path to endgame stateless Sila
...
- [See old discussion here](https://sila-magicians.org/t/protocol-changes-to-bound-witness-size/3885)
...
- We've spent time talking to top quantum experts 
    ...
    - [Summary of quantum-vulnerable parts of Sila ](https://docs.google.com/spreadsheets/d/138bR2gRQS9dktKKsYBc2euOROdQ74g4KwPuCsHlXjX0/edit?usp=sharing)
...
- [Plonky3 w/ Poseidon](https://twitter.com/dlubarov/status/1851667100542341155): over 2M hashes per second on M3 Max (16 core)
    - "2m hash/sec = 62 MB/sec of merkling is enough to fully re-hash a theoretical-maximum-sized sila consensus state within a single slot, now do blake3 or sha256 pls"
