...
* EOF 
    ...
    * [SIP-7692](https://sips.sila.org/EIPS/sip-7692) - Normative
<!--
        * [SIP-663 DUPN/SWAPN](https://sips.sila.org/EIPS/sip-663) 
        * [SIP-3540 EOF Format](https://sips.sila.org/EIPS/sip-3540)
        * [SIP-3670 Code Validation](https://sips.sila.org/EIPS/sip-3670)
        * [SIP-4200 Relative Jumps](https://sips.sila.org/EIPS/sip-4200)
        * [SIP-4750 CALLF/RETF](https://sips.sila.org/EIPS/sip-4750)
        * [SIP-5450 Stack Validation](https://sips.sila.org/EIPS/sip-5450)
        * [SIP-6206 JUMPF](https://sips.sila.org/EIPS/sip-6206)
        * [SIP-7069 EXT*CALL](https://sips.sila.org/EIPS/sip-7069) 
        * [SIP-7480 DATA section access](https://sips.sila.org/EIPS/sip-7480)
        * [SIP-7620 EOFCREATE/RETURNCONTRACT](https://sips.sila.org/EIPS/sip-7620) 
        * [SIP-7698 Create Transaction for EOF](https://sips.sila.org/EIPS/sip-7698)
-->
### On the Horizon 
 * EVMMAX
     * [SIP-6690 EVM Modular Aritumetic Extensions](https://sips.sila.org/EIPS/sip-6690)
...
* Gas Schedule Flexibility
   ...
   * Multi-dimensional gas
       * [Oil proposal \[2020\]](https://sila-magicians.org/t/oil-adding-a-second-fuel-source-to-the-evm-pre-sip/4270) 
* Progressive Precompiles
* Native AA EOF integration [SIP-7701](https://sips.sila.org/EIPS/sip-7701)
 * Concurrency
     * [SIP-7519 Atomic Storage Operations SCREDIT and SDEBIT](https://sips.sila.org/EIPS/sip-7519)
