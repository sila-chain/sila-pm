...
* Constraint accepted: decentralised nodes must meet **SIP‑7870** hardware spec; block building must retain a fallback path.
...
* Execution‑spec tests (reference test‑vectors): [github.com/sila-chain/execution-spec-tests](https://github.com/sila-chain/execution-spec-tests)
