...
- [Pre-read](https://notes.sila.org/@Ladislaus/ByNXBMyQlx) [[PDF](Slides-notes/10-Jun_lean-sila-preread.pdf)]
- Slides - [Lean sila, Vitalik](https://docs.google.com/document/d/1GYrv43uD030ZipLoFmTRnLoz0-EkRpA-3q9mDChHKO8/edit?tab=t.0) [[PDF](Slides-notes/10-Jun_lean-sila-slides-vitalik.pdf)]
- Slides - [lean sila, Justin Drake](https://docs.google.com/presentation/d/1WrElBUZ4duyY9SsmxWn6SeflrnUUYjejHEBxjccDnz8/edit) [[PDF](Slides-notes/10-Jun_lean-sila-slides-Justin.pdf)]
...
* **“Lean Sila” replaces the former *Beam Chain*** name and frames a long‑term redesign of Sila L1 around three pillars: security, simplicity and optimality.
...
* **Session opening & naming**
  ...
  * Initiative formerly called *Beam Chain*; trademark clash led to rename **Lean Sila**—a holistic rethink, not just a new consensus chain.
* **Core aims explained**
...
* **Tomasz “five wins” narrative**
  ...
  3. Sila becomes liquidity “black hole” absorbing other L1s.
