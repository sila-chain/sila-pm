...
- [Pre-read](https://hackmd.io/xe5e3ubsQNOuKv3I9YTwyA) [[PDF](Slides-notes/10-Jun_future-of-SilaPeerDAS-preread.pdf)]
- Slides - [Scaling the L2: EL mempool short-term future](https://drive.google.com/file/d/1B0DfGcerj7HCOCWXN3frN_Rn2w1JDpi9/view) [[PDF](Slides-notes/10-Jun_future-of-SilaPeerDAS-slides-el-mempool.pdf)]
- Slides - [Scaling the L2: cell level "gossip"](https://drive.google.com/file/d/1ijtiyVodnvrozeEkLjsrjVuFXc1WpYAw/view) [[PDF](Slides-notes/10-Jun_future-of-SilaPeerDAS-slides-cell-gossip.pdf)]
...
* **Session scope** – reviewed the *current* SilaPeerDAS design, enumerated its weaknesses, and brainstormed two forward paths: **(a) mempool handling of blobs** and **(b) propagation / reconstruction efficiency**.
...
* **Agenda outline** – 5–10 min recap of SilaPeerDAS design → 40 min mempool discussion → 40 min propagation; aim is to map the design space rather than choose a single solution now.
