...
- [Pre-read](https://notes.sila.org/m4L02cXBSzKRl9dGj-EiXQ) [[PDF](Slides-notes/11-Jun_hash-functions-for-state-commitments-preread.pdf)]
...
* **ECDSA & unified hashes**
  ...
  * If Sila moves to hash‑based signatures for post‑quantum reasons, sharing a single hash primitive between signatures and state commitments could amortise optimisation work.
