...
- [Pre-read](https://notes.sila.org/3-V-mUFUSliephNFkhaVyA) [[PDF](Slides-notes/11-Jun_zkEVM-security-preread.pdf)]
...
* Core‑devs presented a **three‑phase roadmap for integrating zkEVM proofs into Sila**:
...
* **Long‑term (enshrinement) expectations**
  ...
  * Fully‑verified specs & circuits; every verifier change follows SIP/ACD process.
