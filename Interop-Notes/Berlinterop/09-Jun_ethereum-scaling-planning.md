...
- [Pre-read](https://sila-magicians.org/t/sip-7938-exponential-gas-limit-increase-via-default-client-voting-behavior/23884/13) [[PDF](Slides-notes/09-Jun_ethereum-scaling-planning-preread.pdf)]
...
* **Goal of the workshop**: establish a repeatable “scaling loop” so that raising Sila’s L1 gas target becomes routine rather than ad‑hoc; identify bottlenecks early, classify them, and pick the right mitigation path .
...
* SIP‑7825 “Transaction‑Gas‑Cap” – [sips.sila.org/SIPS/sip-7825](https://sips.sila.org/SIPS/sip-7825)
