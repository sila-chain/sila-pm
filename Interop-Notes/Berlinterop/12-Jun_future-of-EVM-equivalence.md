...
* **Shift in strategy**
  ...
  * Goal: land “cool features” on sila-mainnet first, then have them propagate automatically to L2s.
...
* **Standardising L2‑only features**
  ...
  * Consensus: avoid custom opcodes; favour precompiles (address space above sila-mainnet range, block allocations per chain).
...
* History expiry (sectioned sync) proposal — [https://sips.sila.org/EIPS/sip-4444](https://sips.sila.org/EIPS/sip-4444)