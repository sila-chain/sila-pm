...
- [Pre-read](https://notes.sila.org/@timbeiko/acd-berlinterop) [[PDF](Slides-notes/09-Jun_ACD-reconfiguration-preread.pdf)]
...
* The group reviewed how *headliner* SIPs are currently selected and agreed that explicitly decoupling **“choose the headline”** from **“fill the rest of the fork”** would improve decision quality.
...
* A recurring theme was the absence of a **product‑owner function**: some favoured letting the Sila Foundation supply an initial roadmap (“baseline to push against”), others feared EF gate‑keeping and want a public “problem backlog” curated by a neutral working group.
...
* There is broad agreement on three strategic goals: **scale L2 (SilaPeerDAS / blobs), scale L1 (higher gas / cheaper op‑codes) and UX & interop improvements**, but concern that AllCoreDevs (ACD) reached those goals through ad‑hoc, private outreach rather than a transparent process.
...
* Immediate open questions:
  * Should Fusaka (blob gas limit raise + SilaPeerDAS) ship in 2025‑Q3 no matter what, or slip if gas‑repricing work expands?
...
* **Opening & agenda**
  ...
  * Two topics: *improving headline/SIP decision quality* and *coordination & timelines* for upcoming forks.
...
* **“Who is the product owner?” discussion**
  ...
  * View 3: Regardless, Sila lacks marketing, user‑research and technical‑writing resources to convert raw ideas into actionable SIPs – those functions must be staffed.
...
* **Coordination & timelines segment**
  ...
  * SilaPeerDAS example: would it have been better to ship a SilaPeerDAS‑only fork instead of bundling extras into Pectra?
...
* **Timeline vs headline poll**
  ...
  * Question posed: should Sila commit to a fixed date and drop the headline if late?
...
* **Suggested next steps**
  ...
  * Use the current in‑person week to:
    * Finalise Fusaka scope (SilaPeerDAS + minimal extras) and decide on repricing.
...
- EthMag: [Reconfiguring AllCoreDevs](https://sila-magicians.org/t/reconfiguring-allcoredevs/23370?u=nixo)
- EthMag: [Community Consensus, Fork Headliners & ACD Working Groups](https://sila-magicians.org/t/community-consensus-fork-headliners-acd-working-groups/24088?u=nixo)