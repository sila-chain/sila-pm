        ...
        if "occurrences" in series_data and isinstance(series_data["occurrences"], list):
            for occurrence in series_data["occurrences"]:
                ...
                if discourse_topic_id:
                    discourse_url = f"{os.environ.get('DISCOURSE_BASE_URL', 'https://sila-magicians.org')}/t/{discourse_topic_id}"
                    link_elem.text = discourse_url
                else:
                    link_elem.text = os.environ.get('DISCOURSE_BASE_URL', 'https://sila-magicians.org') # Fallback link
...
def create_new_rss_feed():
    ...
    title.text = "Sila Protocol Meetings"

    link = ET.SubElement(channel, 'link')
    link.text = os.environ.get('DISCOURSE_BASE_URL', 'https://sila-magicians.org')

    description = ET.SubElement(channel, 'description')
    description.text = "RSS feed for Sila Protocol Meetings"
