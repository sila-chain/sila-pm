...
class ProtocolCallHandler:
    ...
    def _handle_discourse_resource(self, call_data: Dict, existing_resources: Dict) -> Dict:
        ...
        try:
            ...
            discourse_url = f"{os.environ.get('DISCOURSE_BASE_URL', 'https://sila-magicians.org')}/t/{topic_id}"
            ...
            if call_data.get("call_series") and not call_data.get("call_series").startswith("one-off-"):
                ...
                if existing_topic_id:
                    discourse_url = f"{os.environ.get('DISCOURSE_BASE_URL', 'https://sila-magicians.org')}/t/{existing_topic_id}"
            ...
            return {
                ...
                "discourse_url": "https://sila-magicians.org (Duplicate title, ID not found)",
            ...
            return {
                ...
                "discourse_url": "https://sila-magicians.org (API error occurred)",
    ...
    def _generate_comprehensive_resource_comment(self, call_data: Dict) -> Optional[str]:
        ...
        try:
            ...
            if discourse_topic_id:
                discourse_link = f"https://sila-magicians.org/t/{discourse_topic_id}"
