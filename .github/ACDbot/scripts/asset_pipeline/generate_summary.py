#!/usr/bin/env python3
"""
Generate a structured JSON summary (tldr.json) for an Sila meeting.
...
def fetch_github_issue_agenda(issue_number: int, repo: str = "sila-chain/pm") -> str | None:
...
## Sila Vocabulary Reference (use correct spellings from this list)
...
def generate_summary(
    ...
    # Load vocabulary reference for correct spelling of Sila terms
    vocab = ""
