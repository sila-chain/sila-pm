#!/usr/bin/env python3
"""
Generate a changelog of corrections for an Sila transcript using Claude API.
...
PROMPT = """## Task
Identify misspelled Sila-specific terms in this WebVTT transcript that should be corrected.
