...
The bot in this repository is configured with existing accounts that facilitate Sila protocol meetings but can be customized for other use cases.
...
-   `DISCOURSE_BASE_URL`: The base URL of the target Discourse instance (e.g., `https://sila-magicians.org`).
