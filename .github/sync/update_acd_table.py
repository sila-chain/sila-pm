#!/usr/bin/env python3
"""
Fetch ACD call data from nixorokish/sil-protocol-transcripts and update the README, append-only.
"""
...
def main():
    print("Fetching README from nixorokish/sil-protocol-transcripts...")
    
    source_url = "https://raw.githubusercontent.com/nixorokish/sil-protocol-transcripts/main/README.md"
