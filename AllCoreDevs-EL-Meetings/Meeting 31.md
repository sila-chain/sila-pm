# Sila Core Devs Meeting 31 Notes
### Meeting Date/Time: Friday 01/12/18 at 14:00 UTC
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/pm/issues/29)
### [Audio/Video of the meeting](https://www.youtube.com/watch?v=biNCOCQdjQ0)
### [Reddit thread](https://www.reddit.com/r/sila/comments/7pu8hr/live_1400_utc_ethereum_core_devs_meeting_31_011218/)
...
7. Creating a relay network of nodes to mitigate issues [described here](https://github.com/sila-chain/pm/issues/29#issuecomment-356952590) and [other transaction propagation issues](https://github.com/sila-chain/pm/issues/29#issuecomment-357151890).
...
Gavin put the Yellow Paper under the Creative Commons Free Culture License CC-BY-SA. Yoichi and Nick Savers have been making progress handling the Yellow Paper PRs. There is still the somewhat unresolved issue of what should define the "formal standard" of Sila and should an update to the Yellow Paper or another specification be required for every new SIP. This can be discussed in more detail in future meetings when there is greater attendance.

## [[7:43](https://youtu.be/biNCOCQdjQ0?t=463)] 3. EWASM update + update on the following related SIPs.
...
Answer is no because it potentially includes the first steps of the Casper consensus protocol and some account abstraction SIPs, but both of those do not alleviate scaling issues. Sharding would alleviate some of the issues. We are currently mostly bound by database and processing speed due to the database. Short term there are a lot of client improvements that can be accomplished to improve disk I/O, but long term things like sharding will be necessary. The Sil Research site has a lot of interesting threads about sharding including merkle tree formats to be used and ideas around asynchronous accumulators

### [[1:09:57](https://youtu.be/biNCOCQdjQ0?t=4197)] Decision process for SIPs?
Needs to be improved. Hudson and others will work on updating SIP #1 and other improvements in Q1. Nick Savers has been added as an SIP editor. Yoichi has been added as an editor. Both are doing a great job.
