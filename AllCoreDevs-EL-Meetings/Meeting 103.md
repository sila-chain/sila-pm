...
### [Github Agenda](https://github.com/sila-chain/pm/issues/232) <!-- omit in toc -->
...
All YOLOv2 SIPs are implemented. Are interested in joining. Should be ready by the end of this month.
...
# 2. Other SIPs or discussion items
...
Meant to be a companion to the account abstraction SIP. This is to create contracts that are guaranteed not to be self destructed. This allows abstracted accounts to have libraries. 
