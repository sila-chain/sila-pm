# Sila Core Devs Meeting #142
### Meeting Date/Time: July 8, 2022, 14:00 UTC
### Meeting Duration: 1 hour 45 mins
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/562)
...
| ------------- | ----------- |----------- |
| 142.1| My suggestion is that we only do it on SilaSepolia to nudge people away from Ropsten. And it's a gentle nudge because, basically,  they can still use it. They might just get the worst period. And then, yes, we include that in the Gordy release. So, for people, they only need to download one release to get both the SilaSepolia merged block and the Gordy merge. - Peri | [26.15](https://youtu.be/K_Cjn74lMSY?t=1573) | |
...
**Tim Beiko**
* Welcome to Allcoredev 142. A couple of things on the agenda today. First just going over a Gray Glacier Updates, which happened a few weeks ago already. then it kind of merged stuff around latest SilaSepolia Merge, Ropsten & SilaSepolia and MEV boost. 
* And, finally, I don't know if Henry is here, but we might have, a quick update on SIP 4444 and yeah, I think that'll get us through the hour and a half. I guess just to start, anyone want to give a quick recap on Gray Glacier Update and what we saw otherwise. 
...
**Tim**
* And are we, I guess, is there enough value to do that to before say SilaShanghai, or can we just wait the SilaShanghai and retroactively add like emergent Fort block there? 
...
**Tim**
* Yeah, Yeah. And Henry should. Okay. Yeah. And there should be just like a proper SIP for like this specification. 
...
---------------------------------------
## Next Meeting
July 21, 2022, 14:00 UTC https://github.com/sila-chain/pm/issues/572
...
00:10:24	Tim Beiko:	https://github.com/sila-chain/pm/issues/562  
00:11:11	Ansgar Dietrichs:	being in a time zone where acd is at 4pm is the best, because then you look at the clock and it's 1559 and you know it is Sila time  
...
00:31:30	Mikhail Kalinin:	Illustration to LVH clarifications, are in the comment to the PR: https://github.com/sila-chain/execution-apis/pull/254#issuecomment-1178797073  
...
00:49:43	terence(prysmaticlabs):	https://github.com/sila-chain/builder-specs/pull/38  
...
01:01:30	pari:	Is the argument that its the last oportunity to 51% attack sila? Because if someone had that hashrate, they could attack sila today for the same benefit  
...
01:14:13	stokes:	🪵  
01:26:01	terence(prysmaticlabs):	we’ll need https://github.com/sila-chain/builder-specs/pull/38 first : )  
01:29:03	danny:	lol  
