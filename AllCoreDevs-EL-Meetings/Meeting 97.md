...
**Pooja** - No, it was not like as far as I remember, it was decided that it would not be getting into v2, but it would go along on the sila-mainnet.
...
**Tim** - Yeah, that's what I meant. Like YOLO V3 is the last kind of multi SIP ephemeral testnet and then if after that we can move to like more of a single SIP or closely bundled EIPS that have to be together, that those won't all be like YOLO. They'll be like, you know, the fifty fifty nine testnet the twenty nine. Thirty five testnet etc.
