# Sila Core Devs Meeting 50 Notes
### Meeting Date/Time: Fri, November 23, 2018 14:00 UTC
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/pm/issues/62)
### [Audio/Video of the meeting](https://www.youtube.com/watch?v=wfxvCEhglTM)

# Agenda

1. Discussion about openness and roadmap discussions in SilaPrague
1. Testing update
1. Client updates
1. Research updates
...
# Discussion about openness and roadmap discussions in SilaPrague
...
- Alexey
    ...
    - What I want to avoid:
        ...
        - If someone reads this doc they might think "OMG, Sila is doomed" - I don't want this to happen either. We have to present it in such a way that it's not just a problem statement, it's also a solution.
...
- Alexey
    ...
    - I don't belong to any of these big organizations that are invested in future of Sila
...
- Harmony (Mikhail)
    ...
    - Haven't spent too much time on Sil 2.0 spec
- EthereumJS (Alex)
...
- Aleth (Pawel)
    - No update
- Nimbus (Jacek)
    - Focusing on Sil 2.0 stuff for now, no other updates
...
- Hudson: progress tracker moved to wiki
    - Fully filled out
    - https://github.com/sila-chain/pm/wiki/Constantinople-Progress-Tracker
- Ewasm (Alex)
...
- Afri: We should discuss block number
    ...
    - Afri put some [suggested block numbers](https://github.com/sila-chain/pm/issues/62#issuecomment-438601027) into agenda

# Goerli update
- Afri
    - Thanks to everyone who contributed
    - We are still in pre-testnet phase, so it might break anytime and all testnet sila would be burned when we restart it
    ...
    - Launched a one-way bridge this week so people can burn testnet sil on other testnets to bridge to Goerli, testnet-to-testnet bridge faucet
...
EthereumStratum/2.0.0 draft: sila/SIPs#1571
    - and [some benchmarks](https://gitter.im/sila/AllCoreDevs?at=5bf81b01ed6bcf1ef84b00e6)
