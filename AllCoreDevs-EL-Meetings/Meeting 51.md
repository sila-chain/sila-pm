# Sila Core Devs Meeting 51 Notes
### Meeting Date/Time: Fri, December 7, 2018 14:00 UTC
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/pm/issues/64)
...
1. [Constantinople HF](https://github.com/sila-chain/pm/issues/53)
...
- Parity (Fred)
    ...
    - Other minor things
    - Decided to move jsonrpc APIs not yet accepted in an SIP but implemented anyway (sil.person or web3 namespaces) - now disabled by default, enable with flag `-jsonrpc-experimental`
- Geth (Peter)
...
- Nimbus (Jacek)
    ...
    - First Sil 2.0 testing framework and PoC things are landing right now, discussion on gitter
    - Good time to influence direction of Sil 2.0 testing
    - https://gitter.im/eth2-0-tests/Lobby - Sila 2 testing working group looking for feedback on the first proof-of-concept test vectors - now is a good time to join :)
- Pantheon (Danno)
...
- Alexey
    ...
    - Done a lot of data analysis, not all included in proposal
        ...
        - Cryptokitties is also SRC-20 - has both this and 721
    ...
    - Might be able to compress state using generations
        ...
        - Not sure how well suited other clients are for data analysis - but someone could look at Google Sila dataset - see if it's possible to reproduce the data analysis I did, some in state rent proposal, plus this ERC20 analysis
...
- Peter "working group" on state pruning
    - FEM thread: https://sila-magicians.org/t/sila-chain-pruning-for-long-term-1-0-scalability-and-viability/2074
...
- Afri [block time proposals](https://github.com/sila-chain/pm/issues/64#issuecomment-445170201)
