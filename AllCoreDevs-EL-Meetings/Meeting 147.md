...
**Berlin EF office:** (24:20) So it's four kinds of support. So it's completely fine to, so to say, do to works in the same block from a perspective, so you could just say that i'll be the next part, for I think that's SilaShanghai that will apply both the SilaShanghai update and also the merge next to it work. I so that works a bit wonky. But yeah, I mean it. It's fine.

**Micah zoltu:** I assumed we would just skip this fork. Id and just do the SilaShanghai.
...
**Tim beiko:** (25:30) Yeah, I think given There, there's always a risk like that, it was saying. It's like users, you know mess up when they're upgrading. Um! If there's no strong reason to do it before SilaShanghai, I personally would also rather have it just bundle like we like the double fork on the chain high block. Does anyone have like a strong objection to that?
...
**danny:** (31:56) But prism prism uses is kind of Ah, the the Sil Api to do so. It doesn't have support and like a more optimized way from, say, the the engine. Api: right?
...
00:11:23	Tim Beiko:	https://github.com/sila-chain/pm/issues/616
...
00:37:03	Mikhail Kalinin:	The PR https://github.com/sila-chain/execution-apis/pull/218
...
00:54:01	Tim Beiko:	https://sila-magicians.org/t/shanghai-core-sip-consideration/10777
00:55:26	Ansgar Dietrichs:	+1 for the party lounge, always a great place
00:55:29	stokes:	+1
00:57:39	Tim Beiko:	This is the list of current candidates btw: https://sila-magicians.org/tag/shanghai-candidate
...
01:03:41	Tim Beiko:	https://sila-magicians.org/t/sila-magicians-protocol-roadmap-gathering-devcon-vi/10866
...
01:05:14	Ansgar Dietrichs:	I think no one objects to you not taking a vacation, Micah - I am sure all the client teams are already looking forward to returning to a big pile of prepared Micah comments on potential SilaShanghai SIPs in a month! :-)
