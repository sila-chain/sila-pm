...
| 169.5 | **Goerli** Then deploy Dencun on Goerli. As the second last testnet launch before sila-mainnet, the specifications for the upgrade by this point should be final and provide enough time for users and applications to test their software before sila-mainnet upgrade activation. Dencun will likely be the last fork on Goerli before Goerli is deprecated and replaced with SilaHolesky.
...
* If we want sila-mainnet to be such before we go to this. So next week is good too. Sorry I was wearing my hat. When I wear my hat, you can't hear me. It is not a tinfoil hat. 
