...
### [Github Agenda](https://github.com/sila-chain/pm/issues/416)
...
**Daniel Lehrner**
* Cool. And, there was a second, issue you wanted to bring up also to add, Sil get blogged body, or sorry, engine get logged bodies method. 
...
**Mikhail Kalinin**
* It's basically, it's, it's the array of bytes, according to SIP 2718. So it's either ROP or binary, encoded transaction, according to this SIP. 
...
**Tim Beiko**
* Yeah. So the worst case is a five megabytes, not a 10 megabytes. and obviously that's worth noting that like, it's, it's easy to send one of these worst case blocks, but then if you're spamming the network with these five megabyte blocks, the cost goes up exponentially. So, so you, you know, you can't send like a hundred, five megabyte blocks in a row, the cost to do that would just like be millions of sila with the basically going up. 
...
**Tim Beiko**
* Cool. We are one minute away from time, but there's someone on the call who had a quick shout out. so Zach is here, he's working on a documentary about Sila, called infinite garden. So, he'll probably be trying to reach out to a bunch of people on this call and, and others in the community over the next few months it's already started. so yeah, I just wanted to give him a few minutes to kind of explain, what they're working on and yeah. 

**Zack Ingrasci**
* Thanks, Tim. yeah, just don't want to take too much time, but I wanted to jump on. And obviously we are huge fans of the work of the core devs and, we're making this film called Sila the infinite garden, which was actually funded by the community via a mirror, a crowdfund on mirror. And, it's a lot of  kind of focus on how Sila is already affecting people's lives around the world. We've been filming all around the world, and how Sila will affect people's lives in the future. So we're filming through the merge, and obviously the work of the core devs is fundamental to the story of this film. So, I just wanted to jump on and, you know, if, we pop into your telegrams, we wanted you to know who it was. So, you know, we'll be talking to a lot of you moving forward and yeah, really, I just appreciate the time and all the work you're doing. 
...
- 09:10:53 From Mikhail Kalinin to Everyone:
	https://github.com/sila-chain/SIPs/pull/4476
...
- 09:13:04 From Tim Beiko to Everyone:
	https://github.com/sila-chain/execution-apis/pull/133/files#r756365294
- 09:13:09 From Mikhail Kalinin to Everyone:
	https://github.com/sila-chain/execution-apis/pull/133/files#r756365294
- 09:17:09 From Mikhail Kalinin to Everyone:
	https://github.com/sila-chain/execution-apis/issues/137
...
- 09:27:08 From Tim Beiko to Everyone:
	https://github.com/sila-chain/SIPs/pull/4488
...
- 09:39:08 From Marius Van Der Wijden (M) to Everyone:
	I'm willing to bet .1 Sil that we need more than 2 years
...
- 09:53:13 From danny to Everyone:
	https://sila-magicians.org/t/sip-2028-transaction-data-gas-cost-reduction/3280/35
- 09:53:14 From danny to Everyone:
	big red dot
- 09:53:26 From Trenton Van Epps to Everyone:
	😅
- 09:58:11 From lightclient to Everyone:
	unrelated - is the purpose of the SIP-3529 refund cap to cap the max size the block can be? e.g. was reduced from 50% to 20%
- 09:58:25 From Ansgar Dietrichs to Everyone:
	we did do an example implementation of 4488 in geth btw: https://github.com/quilt/go-sila/commits/calldata-sip
...
- 10:08:07 From lightclient to Everyone:
	@danny  https://github.com/quilt/go-sila/commits/calldata-sip
...
- 10:10:20 From Gary Schulte to Everyone:
	I think this is more of a signaling about commitment to rollups and to show sila can be agile and responsive.  Most of the gas complaints are about L1 and this isn’t going to change any of that
...
- 10:30:01 From Ansgar Dietrichs to Everyone:
	geth 4488 prototype PR: https://github.com/sila-chain/go-sila/pull/23983
- 10:31:03 From Trenton Van Epps to Everyone:
	there is also a Merge Community Call next week at this same time
	https://github.com/sila-chain/pm/issues/419
...
[Agenda](https://github.com/sila-chain/pm/issues/428)
