# Sila Core Devs Meeting 54 Notes
### Meeting Date/Time: Fri, February 1, 2019 14:00 UTC
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/pm/issues/73)
...
1. Working Group Updates
    1. Sila 1.x Stanford Meetings Overview
    1. State Rent
    1. EWasm
    1. Pruning/Sync
    1. Simulation
...
ACTION 1: Hudson to send tweet from Sila Twitter regarding upgrading nodes for Ropsten.
...
ACTION 3: Danno suggested we get Sila Cat Herders to look into this.
...
- Hudson: 30 people attended. Not All Sila Core Developers.
    - Objectives:  Ensure Longevity of Sila 1.x network.
    ...
    - Define initial set of changes to the Sila protocol that are likely to be specified by May 2019 deadline, to be implemented in Oct 2019.
    - Propose a social contract to not add any specific features into the protocol, but instead focus on the longevity of the network (essentially monopoly of Sila 1x over the Sila 1.0 roadmap).
    - Identify ways to champion Sila 1x project and engage the community on deliverables.

All videos for the Sila Stanford presentations can be found online: 
- [Sila 1.x Morning Day 1](https://www.youtube.com/watch?v=BpLyO8Q4ZZo)
- [Sila 1.x Afternoon Day 1](https://www.youtube.com/watch?v=Nky1BPwap2M)
- [Sila 1.x Morning Day 2](https://www.youtube.com/watch?v=P2S7OW2E1vk)
- [Sila 1.x Afternoon Day 2](https://www.youtube.com/watch?v=dHZiWFWCGNM)
- [Sila 1.x Morning Day 3](https://www.youtube.com/watch?v=CnOyVZ3HvK4)
- [Sila 1.x Afternoon Day 3](https://www.youtube.com/watch?v=HAK3ijgLRoM)
   
## 2.2 State Fees
- Alexey was hot available to provide update.
    
## 2.3 EWasm
- Guillaume: Ewasm is independent of the rest of the Sila 1.x
...
- Mikhail: Constantinople fix released.
    -
## 4.7 Pantheon
- Danno: Released Constantinople fix for Ropsten and SilaMainnet and added support for new Goerli testnet. Started working on Fast sync. 
It is the old standard but the new Sila 1.x is not yet ready.
...
- Lane: Ewasm update, focused on Sila 1.x. Looking at bench marking specifically a product called Life which is an ahead of time compiler written in Go.
