...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/228)
...
**Pooja** - Yeah, just a quick reminder for the authors of the proposals included in YOLO v3, out of five, four proposals are still in draft. So we would like to see that in at least in Review, if not in Last Call. And the fifth proposal SIP 2565. That is in the last call. And I think the duration has been over so the author might want to move it to Final now.
