...
**Danny Ryan** (48:23) - So I look at the look at the checklist and seems like a lot. I'm not deep in this. Do we think that we will have we will be able to do sila-mainnet shadow forks of a feature complete frozen spec in January, just given given where we're at on that?
...
**Tim Beiko** (49:02) - Does any yeah EL team feel like really uneasy from that. Like the idea of an EOF and sila-mainnet shadow fork with EOF and withdrawals in in January? Okay, Proto?
...
**Justin Florentine** (50:36) - Besu is happy with that EOF is well on hand, withdrawals is well in hand. We should be happy with a sila-mainnet shadow fork in January, I guess let's talk about maybe more specific when January. I mean early January feels like a non starter due to vacations and whatnot.
...
**Tim Beiko** (1:13:35) - Correct. So I think on the first January on the first week on the All Core Devs, we want to make sure like the clients have implementations that are basically done. They work together like they're interoperating between the two All Core Devs so that on the nineteenth, we can basically be planning sila-mainnet shadow forks.
