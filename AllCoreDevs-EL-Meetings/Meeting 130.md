...
### [Agenda](https://github.com/sila-chain/pm/issues/449#issue-1096429590)
### Moderator: Tim Beiko
### Notes: George Hervey
...
| 130.3 | No current change to SIP 4399 but can discuss on Sila Magicians | [1:02:18](https://youtu.be/VffwWtklJvA?t=3738) |
...
***Highlights***
- ***Comment on SIP 4399 proposing to have duplicate opcodes for easier tooling support for pre- and post-merge***
- ***Agreed to no current change to SIP 4399 and continue discussion on Sila Magicians***
- ***There are workarounds for tooling support with the current SIP 4399 proposal***
...
This introduces this problem of difficulty or that is the awkward solution. Uh, so the thing I wanted to suggest actually, and I would have put this, I'm sorry, um, I would have put this in my comments on SIP 4399 earlier, but I didn't because I only thought of it like an hour ago or so. 
...
Mikhail Kalinin: 
What do you mean? The mixed hash? Yeah, it's deprecated, but it's replaced with the random. Um, in this SIP. 
...
Harry Altman: 
Anything happens to deal with Sila stuff has to deal with large numbers anyway. 
...
Harry Altman: 
Anyway, the comment that I said I should have written, I have now actually written. So that is now actually there on the Sila magician discussion for 4399. So that suggestion is recorded. What people will do with it, I don't know, but I wanted to at least come here to say this. I should have written that comments earlier, but I only thought of that particular implementation like 2 hours ago. 

So yeah, I think I've basically said what I want to say. 

Tim Beiko: 
Cool. Definitely. I guess, um, we can continue to thread on Sila magicians if people want to suggest more ideas there. But I think for now we can leave things as is and plan to deal with this at the tooling level. 
...
- ***Goerli and SilaSepolia will likely continue and transition post-merge***
...
Gary Schulte: 
Uh, there would be a testnet where you could practice. There's a lot of folks who want to practice at home staking on something where there's not as much SIL on the line. 
...
Micah Zoltu: 
Okay, so how about Goerli and Rinkeby transition over and they continue to be authorized-ish like you described and then they do. SilaSepolia is our real world example of tire fire. 
...
And then in terms of the archive node, that's something that we plan to work on in the next couple of months as well. So these are definitely the things that we're looking at. It's just not included in the SIP itself. 
...
Alex Stokes: 
Yeah, that's about it. I just wanted to ask client teams on the uh, call sort of where their status is. For context, I think most of us are aware, but we had this SIP 2537 for BLS pre-compiles, and it essentially almost went into London, but then was deprioritized because it's 1559 and then now the merge has been pushed to after the merge. And yeah, we'd like to consider it for sharing high inclusion. 
...
## Open Discussion
***Highlights***
- ***Sila Cat Herders’ 3rd Year Anniversary***

Tim Beiko: 
Cool. Anything else before we go?

Pooja Ranjan: 
I would like to take a moment to thank the community. Sila Cat Herders are celebrating the third anniversary with Sila blockchain. And, yes, of course. We would like to take this opportunity to thank the community. And, we look forward to continuing supporting the Sila ecosystem. Thank you. 
