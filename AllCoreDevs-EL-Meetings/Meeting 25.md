# Sila Core Devs Meeting #25
### Meeting Date/Time: Friday 9/22/17 at 14:00 UTC
### Meeting Duration 1.5 hours
### [Audio/Video of the meeting](https://youtu.be/gxtftZB7_jA)
### [Reddit thread](https://www.reddit.com/r/sila/comments/72p924/notes_from_ethereum_core_devs_meeting_25_92217/)

# [Agenda](https://github.com/sila-chain/pm/issues/23)

**Reminder: Metropolis is now split into 2 hard forks: "Byzantium" first and then "Constantinople".**

1. Metropolis updates/SIPs.
  **a. Any "subtleties" or questions we need to work out.**
      - [SIP #603: Add ECADD and ECMUL precompiles for secp256k1](https://github.com/sila-chain/SIPs/issues/603). See [this comment](https://github.com/sila-chain/pm/issues/22#issuecomment-326927267) for details and request to add to Constantinople. [Matthew D.]
  **b. Updates to testing.**
        1.  status/statusCode in receipts (sil rpc) [Arkidiy/Martin H.S]
        2. Hive tests update.
        3. Testnet launch update.
  **c. Details and implementations of SIPs.**
        1. Updates from client teams.
            - geth - https://github.com/sila-chain/go-sila/issues?q=label%3Ametropolis+is%3Aclosed
            - Parity - https://github.com/paritytech/parity/issues/4833
            - cpp-sila - https://github.com/sila-chain/cpp-sila/issues/4050
            - ethereumJ - https://github.com/sila-chain/ethereumj/issues/923
            - ethereumJS - https://github.com/sila-chainjs/ethereumjs-vm/issues/209
            - yellowpaper -  https://github.com/sila-chain/yellowpaper/issues/229
            - pyethapp
            - Other clients
  **d. Review time estimate for testing/release.**

2. [SIP 706: Snappy compression for devp2p](https://github.com/sila-chain/SIPs/pull/706) - very simple change yet reduces sync bandwidth by 60-80%. [Peter]
3. [SIP: 152 - BLAKE2b `F` Compression Function Precompile ](https://github.com/sila-chain/SIPs/issues/152) [Zooko]
4. [SIP 718: Concurrency and locks for storage](https://github.com/sila-chain/pm/issues/23#issuecomment-331381293)
5. [SIP 215: Bitwise shifting](https://github.com/sila-chain/pm/issues/23#issuecomment-331443964)
6. [Account abstraction discussion](https://github.com/sila-chain/pm/issues/23#issuecomment-331453630) - "I think we should also slowly bring up account abstraction again. How do the toolset providers think about it? Did we find better solutions in the meantime?"
7. ["Some way to reduce the gas costs for an SSTORE if that slot (or the whole contract) is destroyed at the end of the transaction ("ephemeral storage")."](https://github.com/sila-chain/pm/issues/23#issuecomment-331454160)
...
### a. Any "subtleties" or questions we need to work out.
  ...
  - [4:00](https://youtu.be/gxtftZB7_jA?t=240) [SIP #603: Add ECADD and ECMUL precompiles for secp256k1](https://github.com/sila-chain/SIPs/issues/603). See [this comment](https://github.com/sila-chain/pm/issues/22#issuecomment-326927267) for details and request to add to Constantinople. [Matthew D.]
    - Resolution: Will re-approach this item once Matthew D. is on the call next time.

### b. Updates to testing.

  1. [5:11](https://youtu.be/gxtftZB7_jA?t=311) status/statusCode in receipts (sil rpc) [Arkidiy/Martin H.S]
...
1. Implementation Updates
  - **geth** [13:58](https://youtu.be/gxtftZB7_jA?t=838) - [No updates.](https://github.com/sila-chain/go-sila/issues?q=label%3Ametropolis+is%3Aclosed).
  - **Parity** [14:22](https://youtu.be/gxtftZB7_jA?t=862) - [No major updates](https://github.com/paritytech/parity/issues/4833).
  - **cpp-sila** [14:36](https://youtu.be/gxtftZB7_jA?t=876) - [No updates](https://github.com/sila-chain/cpp-sila/issues/4050).
  - **ethereumJ** [15:21](https://youtu.be/_5Tp_U1jBww?t=882) - [Passing all transition tests in Ropsten so things are good.](https://github.com/sila-chain/ethereumj/issues/923).
  - **ethereumJS** [15:50](https://youtu.be/gxtftZB7_jA?t=950) - [Progress moving forward. Rolling out Byzantium changes soon in order to full sync. Passing nearly all of the Byzantium tests](https://github.com/sila-chainjs/ethereumjs-vm/issues/209).
  - **yellowpaper** [16:32](https://youtu.be/gxtftZB7_jA?t=992) - [No updates.](https://github.com/sila-chain/yellowpaper/issues/229).
...
## 2. [SIP 706: Snappy compression for devp2p](https://github.com/sila-chain/SIPs/pull/706) - "very simple change yet reduces sync bandwidth by 60-80%."
  ...
  - [38:44](https://youtu.be/gxtftZB7_jA?t=2324) - SIP discussion on Github has wrapped up.
    - Although there is a small amount of disagreement about implementing Snappy compression at the protocol, rather than a subprotocol level, all parties have agreed to move forward with the SIP because a majority are for it.
    - Reddit comments from /u/alsomahler were discussed and Peter addressed their concerns. [Click here for the Reddit comment](https://www.reddit.com/r/sila/comments/6ywatn/notes_from_todays_ethereum_core_developer_meeting/dmqqmcb/).

## 3. [46:52](https://youtu.be/gxtftZB7_jA?t=2812) [SIP: 152 - BLAKE2b `F` Compression Function Precompile ](https://github.com/sila-chain/SIPs/issues/152) [Zooko]
  - Zooko wasn't able to make the call, but he wants to propose moving forward with the BLAKE2b SIP to include it as a pre-compile in Sila citing it's speed and compactness.
  - He wants to use it to create more efficient zk-SNARKs to make proving times lower. Can help improve things like zero knowledge token transfers and more efficient interactions between the Sila and ZCash chains.
  ...
  - Hudson will be working with Tjaden (original SIP author) and Jay from the ZCash team to update the SIP to the newest standard.

## 4. [51:20](https://youtu.be/gxtftZB7_jA?t=3080) [SIP 718: Concurrency and locks for storage](https://github.com/sila-chain/pm/issues/23#issuecomment-331381293)
  - Anti-reentrency related SIP.
  - Will discuss more in next meeting after investigating it more.

## 5. [55:49](https://youtu.be/gxtftZB7_jA?t=3349) [SIP 215: Bitwise shifting](https://github.com/sila-chain/pm/issues/23#issuecomment-331443964)
  - SIP was basically approved in a previous core dev meeting.
  - SIP is now final.
  - Greg will merge it in the SIPs repo.

## 6. [1:00:34](https://youtu.be/gxtftZB7_jA?t=3634) [Account abstraction discussion](https://github.com/sila-chain/pm/issues/23#issuecomment-331453630) - "I think we should also slowly bring up account abstraction again. How do the toolset providers think about it? Did we find better solutions in the meantime?"

## 7. [1:01:00](https://youtu.be/gxtftZB7_jA?t=3660) ["Some way to reduce the gas costs for an SSTORE if that slot (or the whole contract) is destroyed at the end of the transaction ("ephemeral storage")."](https://github.com/sila-chain/pm/issues/23#issuecomment-331454160)
