# Sila Core Devs Meeting Constantinople Session 2
...
### [GitHub Agenda Page](https://github.com/sila-chain/pm/issues/61)
### [Constantinople Progress](https://github.com/sila-chain/pm/issues/53)
...
* Dimitry: testing update
    ...
    * I travel to SilaPrague next Monday, I have a lot of time to focus on tests, plan to finish next week
...
* Dimitry: Would like to see us do the HF on a testnet and run it for half a year
    ...
    * We could apply SIPs one by one on the testnet
