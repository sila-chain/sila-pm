...
## 1. [Istanbul HF Community Call Next Wednesday :)](https://sila-magicians.org/t/istanbul-hard-fork-community-call/3816)
...
**Alex**
Is this a good time to briung up the other question which was raised on the channel that some of the Istanbul SIPs are still in draft, and that they should be marked Final or go to Last Call? It's a similar question.
...
**James**
Yeah, and historically, core SIPs haven't gone through the Last Call process. I don't know if that was meant to happen or if it just sort of happened. The better way to do what Last Call is trying to do is having the RSS feed pull out the SIPs marked as eligible for inclusion, so community members know to look at those, as the core devs have already looked at them and taken that seriously.
...
**Alex**
Generally, I think it would be a good idea to do Last Call even for core hard fork SIPs, because if it gives us a chance to reach out to more people, that's always good. But in this particular case, I'm not sure if it's going to make any difference if you're talking about putting it into Last Call just for a few days.
...
## 3. [Eligibility for Inclusion SIP Review](https://youtu.be/BMMkxeH72U0?t=3123r)

**Hudson**
I don't think there's any that we're going over today.

The Sila improvement proposal meeting hasn't happened yet. I was waiting until we had the Sila Cat Herder call to talk about what we were going to do more. And we had that call on Tuesday, so I'll try to plan for the meeting as soon as I can plan for it, but then the date for that will be out a little bit.
...
**Hudson**
Okay. So make note to check on that if you care about it. It's in the Magician's thread for SIP 1803.
