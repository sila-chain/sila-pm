# Sila Core Devs Meeting #21
### Meeting Date/Time: Friday 7/28/17 at 14:00 UTC
### Meeting Duration 1.5 hours
### [Audio/Video of the meeting](https://youtu.be/GK4a6Y5wnFY)

# [Agenda](https://github.com/sila-chain/pm/issues/19)

1. Metropolis updates/SIPs.
  **a. Any "subtleties" or questions we need to work out.**
        - SIP 96 (BLOCKHASH) has some unaddressed comments and issues about the BLOCKHASH contract: https://github.com/sila-chain/SIPs/pull/210 [Paweł]
...
1. Metropolis updates/SIPs.
a. Any "subtleties" or questions we need to work out.
- SIP 96 (BLOCKHASH) has some unaddressed comments and issues about the BLOCKHASH contract: sila/SIPs#210 [Paweł] [4:06](https://www.youtube.com/watch?v=GK4a6Y5wnFY&t=246s)
...
- geth - sila/go-sila#14337
- Parity - paritytech/parity#4833
- cpp-sila - sila/cpp-sila#4050
- yellowpaper - sila/yellowpaper#229
- pyethapp
- Other clients
