...
### [Agenda](https://github.com/sila-chain/pm/issues/459)
### Moderator: Tim Beiko
### Notes: Stefan Wüst
## Decisions Made
...
**Danny:**
yeah yeah something that looks close to sila-sila-mainnet and is stable
...
**Tim Beiko:**
yeah i think this is like a really really valuable effort on some of the work that's like yeah behind the scenes and i think it would be really nice if we could be in a spot where we do use this to specify the consensus changes of SIPs and similarly if consensus layer teams could start using SIPs to specify the english definitions of their changes so we could have a single system where you know SIPs are just like the written text that that describes the rationale and and overview of a change and then it just links to a pr on whether it's the execution layer specs or the consensus layer specs which which actually has the technical the the technical details and that will add some SIP editing job for micah which he's not about happy about it seems. but i think and and i think the reason i i guess my short argument for SIPs on the consensus layer is they do make it much much easier to communicate these changes to a broader set of people people are like like it's easy to anchor like this change is sip-1234 and people know that rather than like this pr to the spec it's just like an accessibility thing i think and

**Danny:**
i very much agree like it and it's not always just a pr sometimes it's six prs right after some subsequent changes so like mapping that into a a single place to discuss the change set i think is is very very valuable so i was gonna i was gonna say i do not recommend only having an executable spec and trying to map a you know what we do in the sip process for that i i think you need something to accompany it

**Sam Wilson:**
yeah yeah so i think that direction ideally we'd have both so you'd have like just the specification part of the sip where possible would be rewritten as like a python diff yeah
...
| -----| ------------------------------------------------------------------------ | -------------------------------------------------------------|
| Pari | Kintsugi Incident Report | https://notes.sila.org/@ExXcnR0-SJGthjz1dwkA1A/BkkdHWXTY |
...
| Marius | Geth right now blocks fcu until the payload is created | https://notes.sila.org/@ExXcnR0-SJGthjz1dwkA1A/BkkdHWXTY |
| Greg Colvin | That’s a quick summary of the SAVM SIPs on the table. | https://github.com/sila-chain/pm/issues/450#issuecomment-1014942130 |
| Tomasz Stańczak | as for SIP-2930, there is a way to do that with STARKs now with Oiler Fossil | https://github.com/OilerNetwork/fossil |
| Tomasz Stańczak | Sila wallets today and tomorrow — SIP-3074 vs. SRC-4337 | https://medium.com/nethermind-sil/sila-wallets-today-and-tomorrow-sip-3074-vs-src-4337-a7732b81efc8 |
...
[Agenda](https://github.com/sila-chain/pm/issues/472)