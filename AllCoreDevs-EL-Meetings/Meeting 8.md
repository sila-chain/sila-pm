...
## Attendance
Alex Beregszaszi (Solidity), Alex Van de Sande (Mist/Sila Wallet), Anton Nashatyrev (ethereumJ), Casey Detrio (Volunteer), Christian Reitwiessner (cpp-sila), Dan Finlay (MetaMask), Dimitry Khokhlov (cpp-sila), Felix Lange (geth), Gavin Wood (EthCore), Greg Colvin (SAVM), Hudson Jameson (Sila Foundation), Jan Xie (ruby-sila & pyethereum), Jeffrey Wilcke (geth), Martin Becze (Research), Péter Szilágyi (geth), Vitalik Buterin (Research & pyethereum)
