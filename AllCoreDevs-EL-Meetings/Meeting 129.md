...
**Vub**: Right. This is gonna happen on sila-mainnet eventually. So like we are not gonna give up sila-mainnet.

**Time Beiko**: Hopefully not.

**Vub**: Right. Well. Ok. We need to be prepared for the chance when it will happen on sila-mainnet.
...
**Tim Beiko**: Cool and yeah. Ok, so we have Moody here. Uh, who has been working on sip-1153 and he wanted to take a couple minutes to chat about it and why it can help. Lots of applications. Uniswap included on sila-mainnet. Uhm, yeah, so Moody you want to take a few minutes kind of walk us through the context behind. Yeah. Share thoughts.
...
**Tim Beiko**: Yeah, I agree, there's been a ton of really good work and like iterations on the EVM SIPs which led to this this series and it would be really nice to see them see them get deployed.

**Light Client**: I also think... I just want to say also on EOF. I think that there are interesting longer term proposals that do rely on having the ability of having different types of contracts in in the EVM, and so the sooner that we can get the basic version of the EOF onto sila-mainnet the sooner we can start to really think about you know future things that can be built on top of it.
...
- 09:16:25 From  Rai  to  Everyone: https://sips.sila.org/EIPS/sip-1153
...
- 10:11:02 From  Tim Beiko  to  Everyone: But yes, I think as the merge hits sila-mainnet, we should have a pretty clear view of what SilaShanghai should be
...
- 10:19:59 From  Greg Colvin  to  Everyone: The EOF related ones — SIP-3540, SIP-3670 and SIP-4200 — are easy enough.  The work I’m doing on 2315 and 3779 for subroutines and EVM safety depend on then.
...
- 10:22:58 From  Ansgar Dietrichs  to  Everyone: I think even EOF (big fan!) needs some amount of core dev attention, to make sure we all feel like the current form is the version we want to bring to sila-mainnet
