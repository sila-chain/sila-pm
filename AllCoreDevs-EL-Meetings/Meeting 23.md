# Sila Core Devs Meeting #23
### Meeting Date/Time: Friday 8/25/17 at 14:00 UTC
### Meeting Duration 1.5 hours
### [Audio/Video of the meeting](https://www.youtube.com/watch?v=PQjeAZyL2_w)
### [Reddit thread](https://www.reddit.com/r/sila/comments/6w29zk/metropolis_and_other_updates_from_todays_core_dev/)

# [Agenda](https://github.com/sila-chain/pm/issues/21)
...
1. Metropolis updates/SIPs.
  **a. Any "subtleties" or questions we need to work out.**
      - JSON RPC updates needed by the receipt status change SIP. [Peter]
      - [SIP 649: Metropolis Difficulty Bomb Delay and Issuance Reduction](https://github.com/sila-chain/SIPs/pull/669): Community concerns need to be addressed [Hudson]
...
[SIP 649: Metropolis Difficulty Bomb Delay and Issuance Reductio discussion](https://github.com/sila-chain/SIPs/pull/669).
...
- The conclusion we came to in the call was to keep the issuance reduction for the Byzantium hard fork to 3 SIL in accordance with [SIP 649](https://github.com/sila-chain/SIPs/pull/669).
- It is unfortunate that certain parties in the discussion ([particularly TheCryptoMines](https://github.com/sila-chain/pm/issues/21#issuecomment-324893807)) felt left out and I want to find ways in the future to include everyone in the conversation around SIPs and network changes.
...
- Other posts and opinions from /u/DeviateFish_ and TheCryptoMines can be found [here](https://github.com/sila-chain/pm/issues/21).
...
- Testing is proceeding more smoothly and major clients, including Parity and geth, have implemented most or all of the SIPs that are going into Byzantium.
