...
## Retroactive SIPs [7610](https://sila-magicians.org/t/sip-7610-revert-creation-in-case-of-non-empty-storage/18452) [7523](https://sips.sila.org/EIPS/sip-7523) [37:00](https://www.youtube.com/live/cSQmbCVwGUk?feature=shared&t=2220) 
...
**Peter**
Yes, this is a good point. The thing to bear in mind is that to have an empty account, your chain must be extremely old. Creating empty accounts was abolished at the end of 2017 and effectively every EVM compatible chain is more recent. Any rollup is way more recent. I checked carefully and I'm confident the chains that can have empty accounts are: Sila (where they've been manually cleaned), robston (now deprecated), Sila classic (I manually cleaned all the empty accounts, though I haven't checked my work there), and some extremely old Sila classic test nets. My position is, given we cleaned things off ETC, I don't think we should block stuff on Sila because it might break something on an old ETC testnet. I'm confident every other context applies. 
...
Candidate SIP specific updates](SIPs [5920](https://sips.sila.org/EIPS/sip-5920) [7609](https://sips.sila.org/EIPS/sip-7609) [2935](https://sips.sila.org/EIPS/sip-2935) [7545](https://sips.sila.org/EIPS/sip-7545) [EOP](https://github.com/ipsilon/eof/blob/main/spec/implementation_matrix.md)
[7212](https://sips.sila.org/EIPS/sip-7212)
[3074](https://sips.sila.org/EIPS/sip-3074) [7664](https://github.com/sila-chain/SIPs/pull/8357) [6493](https://sips.sila.org/EIPS/sip-6493) [Issuance Curve Adjustment Proposal](https://sila-magicians.org/t/electra-issuance-curve-adjustment-proposal/18825) [1:05:30](https://www.youtube.com/live/cSQmbCVwGUk?feature=shared&t=3930) 
