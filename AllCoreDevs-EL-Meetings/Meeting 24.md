# Sila Core Devs Meeting #24
### Meeting Date/Time: Friday 9/8/17 at 14:00 UTC
### Meeting Duration 1.5 hours
### [Audio/Video of the meeting](https://www.youtube.com/watch?v=_5Tp_U1jBww)
### [Reddit thread](https://www.reddit.com/r/sila/comments/6ywatn/notes_from_todays_ethereum_core_developer_meeting/)

# [Agenda](https://github.com/sila-chain/pm/issues/22)
...
1. Metropolis updates/SIPs.
  **a. Any "subtleties" or questions we need to work out.**
          - [EIP96 = PR210](https://github.com/sila-chain/SIPs/pull/210/files#r133664542) contains three different hex code for the BLOCKHASH contract, but there should be at most two (runtime code and initcode). [Yoichi]
...
### a. Any "subtleties" or questions we need to work out.
  ...
  - [0:36](https://youtu.be/_5Tp_U1jBww?t=36) Topic: [EIP96 = PR210](https://github.com/sila-chain/SIPs/pull/210/files#r133664542) contains three different hex code for the BLOCKHASH contract, but there should be at most two (runtime code and initcode).
    - Resolution: Figured out on the call. Issue resolved.
  - [3:48](https://youtu.be/_5Tp_U1jBww?t=228) [SIP #603: Add ECADD and ECMUL precompiles for secp256k1](https://github.com/sila-chain/SIPs/issues/603). See [this comment](https://github.com/sila-chain/pm/issues/22#issuecomment-326927267) for details and request to add to Constantinople.
      - Resolution: Sounds like a good idea. Easy to add to all clients. Needs more feedback on the SIP PR and for editors to make sure it is correctly written. The change would be added to Constantinople if it is accepted. We will discuss official acceptance in future meetings.

### b. Updates to testing.


  - [9:23](https://youtu.be/_5Tp_U1jBww?t=563) On Hive multi-client cross-compatibility testing we are seeing better numbers wrt passing tests. geth has < 10 failing tests. cpp-sila has 700 errors, but because we cannot locally reproduce them there may be another unrelated issue causing it to fail. Many people pointed out mistakes in tests this week and that helped a lot. Parity is 

### c. Details and implementations of SIPs.

1. Implementation Updates
  - **geth** [12:01](https://youtu.be/_5Tp_U1jBww?t=721) - [Basically done besides some testing. peter spots a cat around [12:38](https://youtu.be/_5Tp_U1jBww)](https://github.com/sila-chain/go-sila/issues?q=label%3Ametropolis+is%3Aclosed).
  ...
  - **cpp-sila** [13:38](https://youtu.be/_5Tp_U1jBww?t=818) - [Progress made. Several minor fixes occurred.](https://github.com/sila-chain/cpp-sila/issues/4050).
  - **ethereumJ** [14:42](https://youtu.be/_5Tp_U1jBww?t=882) - [Implemented all SIPs. Passing all blockchain, state, and transition tests, but still needs to implement/update compatibility with the new test format and with Hive.](https://github.com/sila-chain/ethereumj/issues/923).
  ...
  - **yellowpaper** [16:58](https://youtu.be/_5Tp_U1jBww?t=1018) - [Needs to add SIP 649, pointed out by /u/5chdn.](https://github.com/sila-chain/yellowpaper/issues/229).
...
## 2. [SIP 706: Snappy compression for devp2p](https://github.com/sila-chain/SIPs/pull/706) - "very simple change yet reduces sync bandwidth by 60-80%."
  ...
  - [41:06](https://youtu.be/_5Tp_U1jBww?t=2466) [Active SIP PR discussion on-going](https://github.com/sila-chain/SIPs/pull/706). Most clients are in favor of implementing this change besides Parity.
  - Arkidiy from Parity [suggests that this be made as an optional subprotocol](https://github.com/sila-chain/SIPs/pull/706#issuecomment-328123598).
  - [Peter responds to Arkidiy](https://github.com/sila-chain/SIPs/pull/706#issuecomment-328132190).
  - We will bring up this item in future core dev meetings. This change would affect the Sila network layer and not require a hard fork, just client agreement.
