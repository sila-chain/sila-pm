...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/815) <!-- omit in toc --> 
...
**MauriusVanDerWijden** [35:59](https://www.youtube.com/watch?v=Voavkk8Es5E&t=2159s):   So we don't have 4788 yet in the code and I think at least one or two other SIP’s. I would rather use this time to  stress test Devnet 7 and in parallel work on work on getting those other things in and not wait with the stress testing until the next devnet.
...
**Mario Vega** [37:31](https://www.youtube.com/watch?v=Voavkk8Es5E&t=2251s): Yeah we are still working on having all the atheists. I think in the next couple of weeks we should have them already for testing.  Yeah sure and I believe the SIP's are going to be a domain.
...
## `shouldOverrideBuilder` flag for SilaCancun -- [Scope shouldOverrideBuilder flag for SilaCancun execution-apis#425](https://github.com/sila-chain/execution-apis/pull/425)
...
**Mikhail Kalinin** [54:33](https://www.youtube.com/watch?v=Voavkk8Es5E&t=3273s):  So yeah thanks a lot for the discussion. Recapping if there are no, if there is no opposition on the call if anyone listened to us and has an opposition to this tiny change please express it in the SIP or sorry in the PR. I will be aiming to merge this on next Monday so that's the plan.


## Bounded 4788 storage to be merged -- [Update SIP-4788: Bound precompile storage SIPs#7178](https://github.com/sila-chain/SIPs/pull/7178)
