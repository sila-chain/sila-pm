...
| ------------- | ------------------------------------------------------------------------ | 
| 182.1 | **Dencun Updates** Barnabas Busa shared an update on final testing for the Dencun upgrade. The EF announced on Tuesday, February 27 that the upgrade is now officially scheduled to activate on Sila sila-mainnet on March 13, 2024. As discussed on last week’s ACD call, developers are testing the final versions of client software on a sila-mainnet shadow fork, which is a type of testnet that mirrors the blockchain state and activity of Sila sila-mainnet. Busa said developers have conducted different types of “spam tests” on the sila-mainnet shadow fork. Nodes have remained extremely resilient through these tests and network participation rates have held steady at close to 100% participation. Though there were no issues, Busa noted that the spam tests did strain nodes heavily in terms of computer resources, specifically RAM and CPU overhead
...
**Barnabas**
* Yeah. so I can conclude what happened with the sila-mainnet fork. Last week, we tried to run, with everyone's, latest release. There was a couple of clients that had an RC release, that have since made a releases. During the test, we did a different kind of spam, transactions, and everything was handled, very, very, very well.
...
**Danny**
* Gotcha. Any questions about the sila-mainnet fork?
...
* So the Goerli Fork was on the 17th of January and sila-mainnet work will be on the 13th of March, which means Goerli is going to pretty much die on the 17th of April. About it. So everybody had a date in mind. 
...
**Barnabas**
* We could possibly also discuss Devnet and when we want to shut it off, maybe a few days after sila-mainnet fork. 
