...
### Moderator: Tim Beiko
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/895)
...
**Tim Beiko** [02:23](https://www.youtube.com/watch?v=TQ2XEvMzvFg&t=143s): Welcome everyone to ACDE number #174. So we'll cover Dencun today. Some updates on the Goerli Fork, Client updates. There's also some RPC discussion that people wanted to bring up. And then aside from that Guillaume has a Verkle SIP to discuss. And then given its Devconnect next week and US Thanksgiving after that. It makes sense to figure out which calls we want to have in the next couple weeks and whether we want to cancel. So any of them? I guess, to start on the Goerli Shadow Fork. Pari, I believe you shared this analysis. Do you want to give us a quick walk through how things went? 
...
**Devconnect** [27:30](https://www.youtube.com/watch?v=TQ2XEvMzvFg&t=1650s): Yeah just curious maybe toss links to those repos and the SIL magician stand.
