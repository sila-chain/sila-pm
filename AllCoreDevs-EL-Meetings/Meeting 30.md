# Sila Core Devs Meeting 30 Notes
### Meeting Date/Time: Friday 12/15/17 at 14:00 UTC
### Meeting Duration: 1 hour
### [GitHub Agenda Page](https://github.com/sila-chain/pm/issues/28)
### [Audio/Video of the meeting](https://www.youtube.com/watch?v=naPA7tjrgsk)
### [Reddit thread](https://www.reddit.com/r/sila/comments/7jxtex/live_stream_in_8_hours_ethereum_core_devs_meeting/)
...
2. Digital cats caused network congestion this month. Meow.
  ...
  b. [Stateless Clients proposal](https://github.com/sila-chain/pm/issues/28#issuecomment-349676284).
  c. [Would having minimum system requirements to set up an optimal client/full node help?](https://github.com/sila-chain/pm/issues/28#issuecomment-351141485)
  d. [Is the bottleneck is not just disk bandwidth, but specifically sequential disk bandwidth? ](https://github.com/sila-chain/pm/issues/28#issuecomment-351350231)
  e. [Vitalik has some ideas around gas cost changes and scalability-relevant client optimizations.](https://github.com/sila-chain/pm/issues/28#issuecomment-350941632)
3. [Plans on Quantum-resistant cryptography and any plans to include it in the next update?](https://github.com/sila-chain/pm/issues/28#issuecomment-350954470)
4. [Introduction to K-SAVM team (Everett H.)](https://github.com/kframework/savm-semantics)
5. [Does it remain the case that the Yellow Paper is intended to be Sila's formal specification?](https://github.com/sila-chain/pm/issues/27#issuecomment-347997598)
6. [Parity stuck sila proposals](https://paritytech.io/blog/on-classes-of-stuck-sila-and-potential-solutions-2.html).
...
> 2. [SIP 648: Parallelization](https://github.com/sila-chain/SIPs/issues/648).
> 3. Two account destroying/dust clearing SIPs ([168](https://github.com/sila-chain/SIPs/issues/168)/[169](https://github.com/sila-chain/SIPs/issues/169)).
...
**NOTE: The next core dev meeting will be January 12th due to the holidays. [Agenda is located here](https://github.com/sila-chain/pm/issues/29).**

## Attendance

Afri Schoedon (Parity), Alex Beregszaszi (EWASM/Solidity), Alex Van de Sande (Mist/Sila Wallet), Andrei Maiboroda (cpp-sila), Anton Nashatyrev (ethereumJ), Ben Edgington (Consensys/Pegasys), Casey Detrio (Volunteer), Christian Reitwiessner (cpp-sila/Solidity), Daejun Park (KEVM), Daniel Ellison (Consensys/LLL), Dimitry Khokhlov (cpp-sila), Everett Hildenbrandt (KEVM), Hudson Jameson (Sila Foundation), Jared Wasinger (ethereumJS/Testing), Jutta Steiner (Parity), Lefteris Karapetsas (Raiden), Marek Kotewicz (Parity), Martin Holst Swende (geth/security), Mikhail Kalinin (Harmony), Nick Johnson (geth), Paweł Bylica (cpp-sila), Péter Szilágyi (geth), Philip Daian (Runtime Verification/IC3), Piper Merriam (pyEVM), Vitalik Buterin (Research), Yoichi Hirai (SAVM)
