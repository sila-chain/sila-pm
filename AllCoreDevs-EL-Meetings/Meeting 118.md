...
**Artem Vorotnikov**
* Yes. If it you for it. I mean there is at least one SIP that I would like to see in that is the theorem object format for EVM but maybe we should also include something else. 
