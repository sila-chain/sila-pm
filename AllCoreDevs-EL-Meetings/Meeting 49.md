# Sila Core Devs Meeting 49 Notes
### Meeting Date/Time: Fri, November 9, 2018 14:00 UTC
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/pm/issues/60)
...
1. Client Updates
1. Research Updates
1. [Görli PoA-testnet progress](https://github.com/sila-chain/pm/issues/60#issuecomment-436588176) (@5chdn)
1. [Constantinople/Ropsten HF](https://github.com/sila-chain/pm/issues/53)
   - hardfork timing [1](https://github.com/sila-chain/pm/issues/60#issuecomment-436926864), [2](https://github.com/sila-chain/pm/issues/60#issuecomment-437300192)
   - difficulty bomb
1. On the Yellow Paper/Jello Paper spec
1. [ProgPoW update](https://github.com/sila-chain/pm/issues/60#issuecomment-437321761)
    - Sila stratum/mining pool support
    - [EthereumStratum 2.0.0 draft](https://github.com/sila-chain/pm/issues/60#issuecomment-437343594) (@chfast)
...
# Client updates
- Parity (Fred)
    - We forked SilaKovan to the latest changes and it's working
...
- EthereumJ (Mikhail)
    ...
    - Continuing to work on SIL 2.0 implementation
- Aleth (Pawel)
...
- Pantheon (Danno)
    - Had offsite all week in SilaPrague
...
- Holger's proposal: https://github.com/sila-chain/pm/issues/60#issuecomment-437300192
...
- Alexey: Is anyone working on JP? It's been suggested as the spec
    ...
    - Martin: They plan to build an Sil client - there is already an implementation which uses K engine - and put it through hive tests, lib fuzzer, etc.
...
- Peter: currently returns three parameters
    - https://github.com/sila-chain/pm/issues/60#issuecomment-436588176
...
- Piper: Sounds good to me, let's make sure this goes to inflight SIP for properly specing JSON-RPC APIs
...
- People asked why there's a need for a separate process, apart from SIP?
    - It's debatable, let's get the doc done first and see whether it fits into an SIP
    - An SIP is more of a functionality spec, doesn't tell you how to do it
...
- Lane
    - I like the coordinator idea, we discussed this during the ETH2 gathering in SilaPrague and there was consensus around this
    - I think EEP should be separate from SIPs (also maybe SRCs)
...
- Hudson: JSON-RPC wiki spec
    - Fred: It's publicly editable by anyone
        ...
        - Doesn't fit within SIP framework
...
- Hudson: Separating SRCs from SIPs
    - Lane: In brief, I support separating consensus changes from SRCs
