...
### [Github Agenda](https://github.com/sila-chain/pm/issues/365)
...
|119.2 | Upcoming upgrade names - leave a comment on [FEM discussion link](https://sila-magicians.org/t/sila-roadmapping-improvements/6653/18) | [15:20](https://youtu.be/jNxAB3WpAD0?t=918) |
...
**Danny**
do we know if most of the functionality has been tested on sila-sila-mainnet? like people try to send an ef.
...
# 2. Post London SIP-1559 Assessment (Breakout #12) #369
**Trenton**
