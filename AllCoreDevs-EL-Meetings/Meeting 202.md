...
| 202.15 | **Announcements** EF Researchers Davide Crapis and Ansgar Dietrichs proposed the creation of an “EVM Resource Pricing Working Group” to coordinate efforts across different Sila research groups on benchmarking and repricing EVM opcodes. Developers on the call were largely in favor of this proposal.
...
**Roman**
* Do you have any coordinated testing process rather than doing it on sila-mainnet? Something like Devnet equivalent for the for the networking protocol change? 
...
* Let me grab a link for that one. And essentially yeah I think the update here is just that this has been merged. There was some language here updated in SIP 7723 around different statuses for parts of the apps throughout the process. just yeah, updating again how we use some of these things. There's this notion of CFI, SFI and then how they relate to devnets. we covered this I think last week on ACD. So yeah, should be pretty straightforward. And I think the update here is just that this has been merged. Okay. Next up, a new EVM resource pricing working group. So David and Ansgar, have an announcement here. I don't know if one of you on on the call. 
