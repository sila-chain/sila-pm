...
**100.3.1**: [SIP 2972](https://sips.sila.org/EIPS/sip-2972)
**100.3.2**: [SIP 2976](https://sips.sila.org/EIPS/sip-2976)
...
**Martin** - whatever we do, I mean, this is the basis for our security policy. It's got to be towards the sila-mainnet. Everything else is secondary. So that's like number one. I do I mean, we could have some kind of downstream agreement, but we wouldn't..
