...
**note**: this file was copied from [here](https://notes.sila.org/@ethpandaops/dencun-devnet-10#) for reference.

`Devnet-10 will be short lived (sub one week), it will be mainly used to test the new churn limit SIP (SIP-7514). If you are a CL dev, you have to make sure that MAX_PER_EPOCH_ACTIVATION_CHURN_LIMIT config variable is configurable, and we should be able to override it! `
...
`Devnet-10 will be using the updated (sila-sila-mainnet) kzg trusted setup file!`
...
**Consensus Spec** [v1.4.0-beta.3](https://github.com/sila-chain/consensus-specs/releases/tag/v1.4.0-beta.3) :heavy_check_mark:

* [PR-3499 - Add max epoch activation churn limit (SIP-7514)](https://github.com/sila-chain/consensus-specs/pull/3499) - Merged :heavy_check_mark:
Issue to consider: [3261](https://github.com/sila-chain/consensus-specs/issues/3261)
...
* [PR-87 - RFC: Use MAX_BLOB_COMMITMENTS_PER_BLOCK as max length for BlindedBlobsBundle SSZ lists](https://github.com/sila-chain/builder-specs/pull/87) - Merged :heavy_check_mark:
...
- [PR-7672 - Update SIP-4788: post audit tweaks](https://github.com/sila-chain/SIPs/pull/7672/files) - Merged :heavy_check_mark:
- [PR-7456 - Update SIP-4788: initial stab at v2](https://github.com/sila-chain/SIPs/pull/7456) - Merged :heavy_check_mark:
...
- [PR-398 - Add dataGasUsed and dataGasPrice to receipts for 4844 txs](https://github.com/sila-chain/execution-apis/pull/398) - Merged :heavy_check_mark:
