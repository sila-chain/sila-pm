# Proto-Danksharding (SIP-4844) Devnet **v2** User Guide
...
- Proto-Danksharding (SIP-4844) Devnet v2 User Guide
    ...
    - [Getting Devnet-2 SIL](https://github.com/poojaranjan/pm/new/master/Archive/Dencun#getting-devnet-2-sil)
...
* geth - https://github.com/mdehoog/go-sila/tree/sip-4844-devnet-2
* prysm - https://github.com/Inphi/prysm/tree/sip-4844-devnet-2
...
## Getting Devnet-2 SIL
You can request devnet SIL on the deployed Multifaucet: https://eip4844-faucet.vercel.app/
...
Execution RPC: https://sip-4844-alpha.optimism.io
...
If you have issues running the devnet, please reach out in the `#sharded-data` channel of the [Sil R&D discord](https://discord.gg/wNT8ghMbkw).
