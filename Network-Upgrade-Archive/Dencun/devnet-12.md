...
note: this file was copied from [here](https://notes.sila.org/@ethpandaops/dencun-devnet-12#) for reference.
...
**Consensus Spec** [v1.4.0-beta.4](https://github.com/sila-chain/consensus-specs/releases/tag/v1.4.0-beta.4) :heavy_check_mark:

* [PR-3531 - Add blob sidecar inclusion proof](https://github.com/sila-chain/consensus-specs/pull/3531) :heavy_check_mark: Merged
...
**Consensus Specs** - [v1.4.0-beta.3](https://github.com/sila-chain/consensus-specs/releases/tag/v1.4.0-beta.3) :heavy_check_mark:
