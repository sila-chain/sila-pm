...
note: this file was copied from [here](https://notes.sila.org/@ethpandaops/dencun-devnet-9#) for reference.
...
- [SIP-7514: Add max epoch activation churn limit](https://github.com/sila-chain/consensus-specs/pull/3499)
...
**Consensus Spec** [v1.4.0-beta.2](https://github.com/sila-chain/consensus-specs/releases/tag/v1.4.0-beta.2) :heavy_check_mark:
