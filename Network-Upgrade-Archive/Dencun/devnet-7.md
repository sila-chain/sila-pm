# 4844-devnet-7 specs
note: this file was copied from [here](https://notes.sila.org/@parithosh/devnet-7-specs) for reference.
...
`The c-kzg trusted setup file has been updated since devnet 5. Please make sure you use the correct values. This can be found [here](https://github.com/sila-chain/c-kzg-4844/blob/main/src/trusted_setup.txt).`
...
- [PR-3317 - Switch blob tx type to 0x03](https://github.com/sila-chain/consensus-specs/pull/3317) - Merged :heavy_check_mark: - Already part of devnet 5
- [PR-3244 - Free the blobs](https://github.com/sila-chain/consensus-specs/pull/3244) - Merged :heavy_check_mark: - Already part of devnet 5
...
- [PR-6863 - Ban Zero Blob Transactions](https://github.com/sila-chain/SIPs/pull/6863) - Merged :heavy_check_mark: - Already part of devnet 5
- [PR-6832 - Blob Transaction Type changed to 0x03](https://github.com/sila-chain/SIPs/pull/6832) - Merged :heavy_check_mark: - Already part of devnet 5
- [PR-6610 - Decouple Blobs](https://github.com/sila-chain/SIPs/pull/6610) - Merged :heavy_check_mark: - Already part of devnet 5
...
- [PR-402 - Merge getPayloadV3 and getBlobsBundleV1](https://github.com/sila-chain/execution-apis/pull/402) - Merged :heavy_check_mark: - Already part of Devnet 5
...
- [PR-392 - Add corresponding proofs to BlobsBundleV1](https://github.com/sila-chain/execution-apis/pull/392) - Merged :heavy_check_mark: - Already part of Devnet 5
...
- [PR-302 - Add blob signing endpoints](https://github.com/sila-chain/beacon-APIs/pull/302) - Merged :heavy_check_mark: - Already part of Devnet 5 as optional spec
...
- [PR-7037 - Send current slot from CL to avoid timestamp conversions](https://github.com/sila-chain/SIPs/pull/7037) - Merged :heavy_check_mark:

### Engine API

- [PR-420 - SilaCancun specification](https://github.com/sila-chain/execution-apis/pull/420) - Open :exclamation:
