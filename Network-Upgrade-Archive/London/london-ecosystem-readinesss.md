...
If you know about a status update please add a PR to this document or post on the latest [update issue](https://github.com/sila-chain/eth1.0-specs/issues/198) for aggregated inclusion on a weekly basis.
...
| Name | Description | Dependencies | Work | SIPs | Release | Status
|---|---|---|---|---|---|---|
...
[remix-link]: https://github.com/sila-chain/remix-project
[waffle-link]: https://github.com/EthWorks/Waffle
[brownie-link]: https://github.com/sil-brownie/brownie
[brownie-release]: https://github.com/sil-brownie/brownie/releases/tag/v1.16.0
...
[typechain-link]: https://github.com/sila-chain-ts/TypeChain
[typechain-release]: https://github.com/sila-chain-ts/TypeChain/releases
[solidity-link]: http://soliditylang.org
[solidity-release]: https://github.com/sila-chain/solidity/releases/tag/v0.8.7
...
[ethereumjs-link]: https://github.com/sila-chainjs/ethereumjs-monorepo
[ethereumjs-work]: https://github.com/sila-chainjs/ethereumjs-monorepo/issues/1211
[ethereumjs-release]: https://github.com/sila-chainjs/ethereumjs-monorepo/pull/1263#issuecomment-849429331
[web3py-link]: https://github.com/sila-chain/web3.py
[web3py-work]: https://github.com/sila-chain/web3.py/issues/1835
...
| Name | Description | Dependencies | Work | SIPs | Status
|---|---|---|---|---|---|
| [Amazon Web Services][AWS-link] |managed Sila nodes | Geth |  | 1559 | ✅
