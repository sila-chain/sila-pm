...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/580)
...
- 00:03:27	Wolf Prv BTC to SIL Maxi:	I can't hear anybody
- 00:03:48	Pooja Ranjan:	we can hear
- 00:03:48	Robin A. Nordnes:	sound is good
- 00:03:48	Wolf Prv BTC to SIL Maxi:	is anybody talking?
- 00:03:49	Pooja Ranjan:	well
- 00:03:50	Flibbr SIL Maxi:	Sound is good
- 00:03:51	Oleg Boiko:	Sound good
- 00:03:51	Theodore Degiuli:	sound is clear
- 00:03:53	Wolf Prv BTC to SIL Maxi:	ok its me t hanks
...
- 00:04:02	Wolf Prv BTC to SIL Maxi:	thanks
- 00:04:16	Flibbr SIL Maxi:	Wolf sucks get out of here
- 00:04:27	into_the_network:	hello
- 00:04:32	Flibbr SIL Maxi:	Lol jk
- 00:04:33	Trent:	was there a written goerli retro?
- 00:04:36	danny:	https://blog.sila.org/2022/08/12/finalized-no-36/
- 00:04:51	terence(prysmaticlabs):	https://notes.sila.org/@parithosh/goerli-merge
- 00:05:12	Trent:	thanks Terence!
- 00:05:20	Wolf Prv BTC to SIL Maxi:	thanks I got it now (audio)
- 00:05:55	@whalepool flibbr sil maxi:	Finally. Are you sure you are competent enough to upgrade your node? @wolf
- 00:06:15	@whalepool flibbr sil maxi:	Oh you don’t run a node you say @wolf lol
...
- 00:13:46	Tim Beiko:	step-by-step merge checklist similar to Pari’s doc linked above: https://launchpad.sila.org/en/merge-readiness
...
- 00:26:12	eliekfouri.sil:	my Nethermind+lighthouses node , after Merge EL started to reorg block
- 00:26:59	Rémy Roy:	Some details about the Nethermind issue can be found on https://notes.sila.org/@parithosh/goerli-merge
- 00:27:06	eliekfouri.sil:	had to restart both El + CL , and back to normal
- 00:27:28	Parithosh Jayanthi:	they already have a fix 😄
- 00:27:42	eliekfouri.sil:	👍
...
- 00:32:43	eliekfouri.sil:	opinion: gap between Bellatrix and TTD should  be much wider than 7 to 10 days. As a solo node operator.
...
- 00:33:44	eliekfouri.sil:	"Ready for Merge" message logs on Lighthouse is very nice
- 00:33:57	AKS:	Hi, if miners turn off their nodes much before ttd target, will network security of pow sil chain be compromised ?
- 00:34:14	eliekfouri.sil:	and should me a similar message on EL logs too
...
- 00:35:26	Trent:	none
- 00:35:47	Micah Zoltu:	None.  If people want Sila Classic v2 they can have that, though I recommend just using Sila Classic as it is great.
- 00:35:54	AKS:	Thank you. Any plans for sil foundation filling in the gap of missing miners
- 00:36:08	eliekfouri.sil:	I thought that" Ready for Merge" message just after Bellatrix upgrade
...
- 00:42:44	eliekfouri.sil:	if Bellatrix deployed tomorrow there is no risk to TTD happens before it
...
- 00:44:44	Tim Beiko:	eliekfouri.sil: that's correct. but we can't make bellatrix happen tomorrow because we need to have client releases out, give people time to upgrade, etc.
- 00:44:44	into_the_network:	so the best estimate is after 6th (Bellatrix) - 15 sept latest
- 00:44:50	Rémy Roy:	There are some details about Besu on the Goerli Merge issue notes: https://notes.sila.org/@parithosh/goerli-merge
...
- 00:48:13	OC:	Is there any confirmed rate of issuance for validators based on the total staked SIL securing the network post-merge?
