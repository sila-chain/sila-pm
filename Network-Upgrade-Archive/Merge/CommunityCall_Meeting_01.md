...
### [Agenda](https://github.com/sila-chain/pm/issues/402)
...
* There's no migration progress required you're not going to have to redeploy your contracts, sila state addresses, user balances contract code, any sort of information, that tells us what happened in the past, about sila and and what's going to happen in the future. That state continues throughout.
