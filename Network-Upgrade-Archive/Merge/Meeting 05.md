...
### [Agenda](https://github.com/sila-chain/pm/issues/331)
...
* [New PR](https://github.com/sila-chain/go-sila/pull/22827
...
* Transition process with computed total difficulty. [See PR](https://github.com/sila-chain/eth2.0-specs/pull/2462)
...
* We want Sila to be accessible to the average person. We should avoid required CLI arguments.
...
Ref: [eth2.0-specs#2463](https://github.com/sila-chain/eth2.0-specs/pull/2462)
...
* If anyone hears this recording and they have apps that depend either o difficulty or the block hash as the source of randomness, reach out to us in SIL R&D discord so that we can discuss it and potential solutions.
