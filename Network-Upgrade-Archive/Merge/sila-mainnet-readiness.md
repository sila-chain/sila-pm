# The Merge SilaMainnet Readiness Checklist

This document outlines various tasks to work through to make the Merge ready for SilaMainnet release.
...
* [x] [Rayonism](https://github.com/sila-chain/rayonism/blob/master/specs/merge.md)
...
* [x] Transition process specified [#2462](https://github.com/sila-chain/consensus-specs/pull/2462)
* [x] Ensure structural conformance with existing specs [#2472](https://github.com/sila-chain/consensus-specs/pull/2472) 
* [x] Rebase with Altair [#2530](https://github.com/sila-chain/eth2.0-specs/pull/2530)
* [x] Rebase with London (update `ExecutionPayload`) [#2533](https://github.com/sila-chain/consensus-specs/pull/2533)
* [x] P2P spec (primarily just version bumping topics for new types) [#2531](https://github.com/sila-chain/consensus-specs/pull/2531)
* [x] [Optimistic sync spec](https://github.com/sila-chain/consensus-specs/blob/dev/sync/optimistic.md) 
* [x] Upgrade [`beacon-APIs`](https://github.com/sila-chain/beacon-apis) to handle new types
* [x] [BONUS] Annotated specs [link](https://github.com/sila-chain/annotated-spec/tree/master/merge)
...
* [x] Network -- devp2p
    ...
    * [x] Discovery
* [x] Upgrade JSON-RPC ([`execution-apis`](https://github.com/sila-chain/execution-apis)) with new methods and deprecations [#200](https://github.com/sila-chain/execution-apis/pull/200)
* [x] [BONUS] Executable [`execution-specs`](https://github.com/sila-chain/execution-specs/pull/219) and testing through the Merge

### Engine API

* [x] Basic JSON-RPC extension, [link](https://github.com/sila-chain/rayonism/blob/master/specs/merge.md#consensus-json-rpc) (used in rayonism)
* [x] Production refinements [Engine API](https://github.com/sila-chain/execution-apis/blob/main/src/engine/specification.md). Previous docs: [WIP doc](https://hackmd.io/@n0ble/consensus_api_design_space), [Interop Edition](https://github.com/sila-chain/execution-apis/blob/main/src/engine/interop/specification.md)
...
* [x] Migrate to [execution-APIs](https://github.com/sila-chain/execution-APIs) or other permanent home, [link](https://github.com/sila-chain/execution-apis/tree/main/src/engine)
* [x] Remove unauthenticated port from specification [#219](https://github.com/sila-chain/execution-apis/pull/219)
...
* [x] Application Layer Impacts 
    * [Blog post](https://blog.sila.org/2021/11/29/how-the-merge-impacts-app-layer/) 
* [x] Rename eth1/eth2 to execution/consensus across repos and documentation -- [The Great Renaming](https://notes.sila.org/@timbeiko/great-renaming)
* [x] [Mega Merge Resource List](https://notes.sila.org/Moiv99h9QTmI-imPL8pvQg?view)
* Infrastructure provider guides
    * https://launchpad.sila.org/en/merge-readiness/ 
...
* [x] Testnet [chaos messages](https://github.com/MariusVanDerWijden/go-sila/tree/merge-bad-block-creator)
* [x] Hive
    * [X] Mocked CL for EL [engine API](https://github.com/sila-chain/hive/tree/master/simulators/sila/engine) unit testing
...
* [x] [Shadow forks](https://github.com/sil-clients/merge-testnets) on a weekly basis to continuously test live transition and TX replays 
...
* [x] Long-lived devnets 
  * [x] [Kintsugi](https://blog.sila.org/2021/12/20/kintsugi-merge-testnet/)
  * [x] [Kiln](https://blog.sila.org/2022/03/14/kiln-merge-testnet/)
...
* [ ] Consider weak subjectivity period implications
  ...
  * [ ] [[IN PROGRESS](https://github.com/sila-chain/beacon-APIs/pull/226)] Specify standard data format & methods for weak subjectivity checkpoint distribution
