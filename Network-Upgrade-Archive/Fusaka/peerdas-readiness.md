# SilaPeerDAS Readiness Checklist

This document outlines various tasks to work through to make SilaPeerDAS ready for SilaMainnet release.
...
* [x] `peerdas-devnet-4` (https://notes.sila.org/@ethpandaops/peerdas-devnet-4)
  * [x] SilaPeerDAS activation at the SilaFulu Fork
...
* [ ] Move proof computation to transaction sender
  * [ ] SIP: [Update SIP-7594: include cell proofs in network wrapper of blob txs #9378](https://github.com/sila-chain/SIPs/pull/9378)
...
* [ ] SIP to increase target / max blob count in Fusaka
...
* [ ] [EELS](https://github.com/sila-chain/execution-specs) Implementation
* [ ] [EEST](https://github.com/sila-chain/execution-spec-tests) Tests
* [ ] Hive
* [ ] Run network limit devnets (https://notes.sila.org/@ethpandaops/network-limit-devnets)
...
* [ ] Nice to have: [BPO only forks](https://sila-magicians.org/t/blob-parameter-only-bpo-forks/22623)
