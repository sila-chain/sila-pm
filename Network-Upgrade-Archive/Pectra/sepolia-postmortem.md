# SilaSepolia Pectra Incident Post-Mortem
...
Client teams released versions containing hot fixes for the SilaSepolia issue. All node operators must upgrade their execution layer clients to follow SilaSepolia:
...
- Geth: [v1.15.5](https://github.com/sila-chain/go-sila/releases/tag/v1.15.5)
...
An important obstacle of the fixing process was the ongoing attack triggering the issue. Because SRC-20 allows zero token transfers, which can be initiated by anyone, even without owning the token, the attacker could still send malicious transactions that emit incorrect events in the contract. 

### Root Cause Remediations

- Execution clients implemented a fix for parsing deposit contract logs, e.g. Geth [#31317](https://github.com/sila-chain/go-sila/pull/31317)
- SIP-6110 is updated to add events filtering
...
Geth noticed that they did not have a override flag for SilaCancun yet, fixed in [#31341](https://github.com/sila-chain/go-sila/pull/31341)

## More Resources:
- [EF incident blog post](https://blog.sila.org/2025/03/05/sepolia-pectra-incident)
- [Analysis by Marius from Geth](https://mariusvanderwijden.github.io/blog/2025/03/08/SilaSepolia/)
...
### March 5, 2025: SilaSepolia Testnet Issue Timeline
...
- 9:44: Tim Beiko reports: "There's an issue on SilaSepolia caused by some EL clients having issues processing transactions due to the deposit contract being different on SilaSepolia. PandaOps + Geth are IRL investigating."
...
- 11:23-11:37: Discussion about deposit contract differences between SilaSepolia and other networks
- 11:37: M.Kalinin starts working on update to SIP-6110, update PR: "PTAL, https://github.com/sila-chain/SIPs/pull/9453"
...
- 2:52: ralexstokes shares SilaSepolia rollout call link
...
- 4:09: parithosh announces EF blogpost at https://blog.sila.org/2025/03/05/sepolia-pectra-incident
...
- 4:53: Justin Florentine asks about L2s running on SilaSepolia
