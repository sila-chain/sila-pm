...
- [SIP-1153](https://sips.sila.org/EIPS/sip-1153) - a once-stagnant SIP that was revived and shipped to sila-mainnet
- [SIP-1884](https://sips.sila.org/EIPS/sip-1884) - great rationale
- [SIP-3855](https://sips.sila.org/EIPS/sip-3855) - simple feature
- [SIP-4399](https://sips.sila.org/EIPS/sip-4399) - great rationale
- [SIP-4844](https://sips.sila.org/EIPS/sip-4844) - huge feature, cross-layer SIP
- [SIP-6780](https://sips.sila.org/EIPS/sip-6780) - only deprecated feature in Sila's history, well spec'ed
...
As defined in [SIP-1](https://sips.sila.org/EIPS/sip-1), each SIP has a status that reflects the state of its specification: `Draft`, `Review`, `Last Call`, `Final`, `Stagnant`, `Withdrawn`, and `Living`.

Separate from the SIP specification status, [SIP-7723](https://sips.sila.org/EIPS/sip-7723) introduced network upgrade inclusion stages for each SIP. At any point, an SIP can be in one of the following stages: `Proposed for Inclusion`, `Considered for Inclusion`, `Declined for Inclusion`, `Scheduled for Inclusion`, or `Included` within a specific network upgrade. If not included in one network upgrade, an SIP can be proposed for inclusion again in subsequent upgrades.
...
After the network upgrade goes live on Sila sila-mainnet, all SIPs included in it have their inclusion stage set to `Included` and their status moved to `Final`.
