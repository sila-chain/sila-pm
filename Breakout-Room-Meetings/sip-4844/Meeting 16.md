# SIP-4844 Implementers' Call #16 

## Meeting Details
### [Agenda](https://github.com/sila-chain/pm/issues/726)
### Date: Feb 21, 2023	
...
* Spec updates
    * [New CL spec release](https://github.com/sila-chain/consensus-specs/releases/tag/v1.3.0-rc.3)
        ...
        * Beacon APIs need an update for signing blobs
            * [Active PR](https://github.com/sila-chain/beacon-APIs/pull/302) that will be discussed on Thursday
    ...
    * [KZG library refactor](https://github.com/sila-chain/c-kzg-4844/pull/123)
    ...
    * Zero blob
        * Ansgar going to land PR on SIP in time for ACDC on Thursday
        * Ongoing discussion in the Etheruem Magicians thread [here](https://sila-magicians.org/t/sip-4844-shard-blob-transactions/8430/28?u=true&=true)
