# SIP-4844 Implementers' Call #20 

## Meeting Details
### [Agenda](https://github.com/sila-chain/pm/issues/755)
### Date: Apr 17, 2023	
...
* Spec updates:
    * Small one-value change by Mikhail in error code fixing small discrepancy: https://github.com/sila-chain/execution-apis/pull/399/files
    ...
    * Gajinder has 3 PRs to highlight 
        * https://github.com/sila-chain/execution-apis/pull/392 add proofs to transaction wrapper. 
        ...
        * https://github.com/sila-chain/SIPs/pull/6610
            * Updates to remove aggregated proof & other minor updates, already implemented in geth.   In scope for devnet 5.
        * https://github.com/sila-chain/beacon-APIs/pull/302  Extend current endpoints to prove & publish
