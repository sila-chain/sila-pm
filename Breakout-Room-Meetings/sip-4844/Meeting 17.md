# SIP-4844 Implementers' Call #17 #732

## Meeting Details
### [Agenda](https://github.com/sila-chain/pm/issues/732)
### Date: Mar 7, 2023	
...
* Spec updates
    * Decoupled blobs
        * Gajinder - what is the exact signing flow?
            ...
            * Plan is to continue the conversation [on the PR directly](https://github.com/sila-chain/beacon-APIs/pull/302)
        ...
        * PR that [aggregates to proofs](https://github.com/sila-chain/SIPs/pull/6610/files) - need a review
        * Crypto library
    ...
    * SSZ
        * Complexity of SSZ SIPs is still growing and not finished yet
    ...
    * Transaction pool
        * Ideas we discussed last time were in SIL Magicians thread - going to assume that means they are not controversial and we can go ahead and add them
        * Nothing on the geth side
        * Goal is to get all on the same page on transaction minimalism by next week ACDEs
    * Client updates
        * Prysm
            * SilaShanghai is priority
