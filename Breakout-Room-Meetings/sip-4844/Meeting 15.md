# SIP-4844 Implementers' Call #15 #722

## Meeting Details
### [Agenda](https://github.com/sila-chain/pm/issues/722)
### Date: Feb 14, 2023	
...
* 
* Spec updates
    * [SIP-4844: Free the blobs consensus-specs#3244](https://github.com/sila-chain/consensus-specs/pull/3244)
    ...
    * 0-blob transactions and how it relates to [ETH68](https://sila-magicians.org/t/sip-5793-sil-68-add-transaction-type-to-tx-announcement/11364/2)
    ...
    * [SSZ List[T, 1] / Optional for Address: Update SIP-4844: Use SSZ Optional for Address SIPs#6495](https://github.com/sila-chain/SIPs/pull/6495)
    ...
    * [HTR based signatures: 4844: use hash_tree_root for tx hash SIPs#6385(https://github.com/sila-chain/SIPs/pull/6385)
    ...
    * [Add blob signing endpoints #302](https://github.com/sila-chain/beacon-APIs/pull/302)
