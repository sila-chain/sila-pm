...
# SIP-1559 Gas API Call (Breakout #10)

### Friday, June 4, 2021 at 14:00 UTC (10:00 ET)
### Meeting Duration: 60 minutes
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/328)
...
- JSON RPC endpoint for gas price
  - Addition of eth_maxPriorityFeePerGas [sila/eth1.0-specs#201](https://github.com/sila-chain/eth1.0-specs/pull/201)
  - Need to agree on return value
- JSON RPC endpoint for next block baseFeePerGas [sila/eth1.0-specs#207](https://github.com/sila-chain/eth1.0-specs/issues/207)
- Open Discussion
...
**Micah**
* Oh, I understand. You're saying that the issue here is that the sil underscore gas pricing needs to function for legacy transactions, not uh.
...
* Really pick it up like it'll probably pick up what's the sort of average longer an average and and you know looking at it right now it would be like two ways would compensate for the uncle risk accounting for something like the 75th percentile of MEV but you're not going to be included in those blocks where there's like a 10 sil front-running opportunity.
...
**Speaker 3**
* Standing block has been a part of sila so actually since forever.
...
10:00:22 From  Trenton Van Epps  to  Everyone: Agenda: https://github.com/sila-chain/pm/issues/328  
...
10:37:32 From  lightclient  to  Everyone: would hate that a critical peice of transacting with sil be centralized  
...
11:01:16 From  Juan Blanco  to  Everyone: Will you make that a gist part of the SIP  
...
11:05:23 From  Tim Beiko  to  Everyone: https://github.com/sila-chain/eth1.0-specs/blob/master/network-upgrades/client-integration-testnets/calaveras.md  
