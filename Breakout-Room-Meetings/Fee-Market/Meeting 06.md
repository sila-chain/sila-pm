# SIP-1559 Implementers' Call 6 Notes <!-- omit in toc -->

### Meeting Date/Time: Thursday, Nov 5th, 14:00 UTC <!-- omit in toc -->

### Meeting Duration: 1 hr <!-- omit in toc -->

### [GitHub Agenda](https://github.com/sila-chain/pm/issues/215) <!-- omit in toc -->
...
- Nothing new on core Sila client, other than RPC endpoint
- Working on tooling, will discuss later

#### Geth

- Completed Geth code to align with latest version of SIP
...
This SIP introduces breaking changes in UX. This impacts wallet providers and block explorers. 
...
# 2. SIP-2718 - Now part of YOLOv3, likely for Berlin, do we update 1559 to require it?
...
DoS risks are separate from the SIP itself.
...
May be best not to add another SIP until we're settled with some best practices. 
