...
**Agenda**: https://github.com/sila-chain/pm/issues/1053

**Recording**: https://youtu.be/0vHHhZgrJ58

**Links shared in chat**:
* notes at the Berlin workshop by Ansgar: https://notes.sila.org/@ansgar/aa-meeting-berlin
...
#### [Update SIP-7702: refine based on discussions](https://github.com/sila-chain/SIPs/pull/8561)

Ansgar Dietrichs 
I really think this PR should be merged instead of being the perpetual catch-all for all changes to the SIP. I keep meeting ppl that only see the main SIP and are unaware of any of these changes.
...
https://github.com/sila-chain/solidity/issues/597#issuecomment-1537533170
...
Gary Schulte 
Agreed re:verkle, but presumably we don’t want to wait for SilaOsaka for AA
...
Tim
+1 on SRC proxy, if we could have a draft for next week’s call that’d be great