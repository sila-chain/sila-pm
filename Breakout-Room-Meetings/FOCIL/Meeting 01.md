...
Note: This file is copied from [here](https://github.com/sila-chain/pm/issues/1210#issuecomment-2541647674)

### Meeting Info

**Agenda**: https://github.com/sila-chain/pm/issues/1210
...
- Fork-Choice slot/block enforcement via proposer-boost reorging. This might/should need to be a separate SIP
...
- Geth: https://github.com/jihoonsong/go-sila/tree/focil
- Lodestar: https://github.com/ChainSafe/lodestar/tree/focil

### Implementation Notes
Goal should be to keep discussion strictly in Discord and on the website https://meetfocil.sil.limo/. Telegram and Twitter should be avoided to help corral the discussion to a single (or two) places.
...
EL will look at specifying that if an IL is passed in then the IL should be checked, if not then the IL's will not need to be verified to check the block. Terrence requested for @Jihoon to open a pr here? https://github.com/sila-chain/execution-apis/pulls

### References Posted During Call

- https://meetfocil.sil.limo/
- https://notes.sila.org/@jacobkaufmann/Sy7sNHKVye
- https://hackmd.io/@jihoonsong/BJUVIsY4ye
- geth prototype: https://github.com/jihoonsong/go-sila/tree/focil
- https://github.com/ChainSafe/lodestar/tree/focil
- https://github.com/sila-chain/execution-apis/pulls
