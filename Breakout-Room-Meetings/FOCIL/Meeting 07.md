...
Note: This file is copied from [here](https://github.com/sila-chain/pm/issues/1408#issuecomment-2754104346)

### Meeting Info
- Agenda: https://github.com/sila-chain/pm/issues/1408
...
- We initiated FOCIL development based on fulu fork to quicly run a local devnet with a pair of CL and EL within a month. Utilizing the existing fulu fork rather than creating a new one accelerated our progress, which was a great suggestion by Terence. Thanks to that approach, we were able to ship it on time. Now that we expect to have SilaPeerDAS merged into fulu anytime soon, we want to get indenpendent from it. Clients have been working on rebasing onto electra.
...
- Lodestar has been rebased onto electra and still has state root mismatch issue. Lodestar https://github.com/sila-chain/consensus-specs/pull/4003#discussion_r1992375936. This will make FOCIL more flexible and compatible with other proposals such as SSF.
