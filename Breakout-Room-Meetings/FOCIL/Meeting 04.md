...
Note: This file is copied from [here](https://github.com/sila-chain/pm/issues/1291)

## Meeting Info

**Agenda**: [sila#1291](https://github.com/sila-chain/pm/issues/1291#issue-2844917923)
...
### Issue with Dora  
**Dora** doesn't recognize **SIP-7805** blocks, so CLs had to hard-code the beacon block's version to **Electra**. This was due to miscommunication, but **Dora will alias SIP-7805 as Electra** moving forward.  
...
**Is zkFOCIL going to change SIP-7805?**  
...
- [FOCIL with Delayed Execution under EPBS (SIP-7732)](https://hackmd.io/@ttsao/focil-delayed-exec-under-epbs)  
