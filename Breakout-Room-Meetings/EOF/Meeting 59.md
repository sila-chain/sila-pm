...
Note: this file is copied from [here](https://github.com/sila-chain/pm/issues/1162#issuecomment-2388989786) 

## Meeting info

Date: 2024.10.02

Agenda: https://github.com/sila-chain/pm/issues/1162 
...
SilaOsaka Migration
- Clients need to target SilaOsaka for EOF activation
- Tests need to target SilaOsaka, including moving tests in source tree
...
Implications of gas introspection: regarding a gas to sil SIP.
