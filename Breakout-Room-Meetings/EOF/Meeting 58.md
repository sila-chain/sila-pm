...
Note: this file is copied from [here](https://github.com/sila-chain/pm/issues/1146#issuecomment-2358853729) 

## Meeting info

Date: 2024.9.18

Agenda: https://github.com/sila-chain/pm/issues/1146 
...
Also, 721 could be solved better with SRC-165 interface
...
Split is because of SIP bloat, adding a new SIP would counter the solution

At least 1 client wants to include it for V1

Absence could slow adoption of EOF (Any SRC-721/SRC-1155 or flashloan project for example)
