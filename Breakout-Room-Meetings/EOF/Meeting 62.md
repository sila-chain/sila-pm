...
Note: this file is copied from [here](https://github.com/sila-chain/pm/issues/1192#issuecomment-2504249197) 

## Meeting info

Date: 2024.11.27

Agenda: https://github.com/sila-chain/pm/issues/1192 
...
- feat(tests): port sila/tests test cases (tracking issue) execution-spec-tests#972 will ultimately port all old tests
