...
Note: this file is copied from [here](https://github.com/sila-chain/pm/issues/1115#issuecomment-2273805574) 

## Meeting info

Date: 2024.7.24

Agenda: https://github.com/sila-chain/pm/issues/1115 
...
- Danno will write up a new SIP as a red herring, rather than modify 3155
...
- Make sure all SIPs tests are in the testing checklist

Devnet
- We want fuzzing ready
- Do we need to be 100% for devnet?
  - Client should pass fuzzing
  - Clients should pass reference tests at 100% (EESTs and Sila/tests and evmone)
