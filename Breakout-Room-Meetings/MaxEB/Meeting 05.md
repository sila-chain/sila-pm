# SIP-7251 MaxEB Breakout Call 05 
...
SIP-7251 MaxEB Breakout Call #5 - Apr 9, 2024

Next call: Tuesday Apr 16 @ 1200 UTC.
See PM issue for details: https://github.com/sila-chain/pm/issues/1012
...
Reference: https://github.com/sila-chain/pm/issues/1008
...
- Current design is not ready for consolidation. Multiple places where healthy validators are assumed to be near 32 SIL effective balance.
...
- No Consolidation Option: Not a problem if no consolidations are not included with maxEB. They would lose out on some useful features like balancing SIL between operators
...
- Not sure if we can do execution initiated consolidations in this hard fork.
  - We would need to extend SIP-7002, adding more fields: `signature`, `target`, `source`
...
- Consolidations don't necessarily break Rocketpool.
  ...
  - Case: Node operator may consolidate minipool to ourside validator. Funds would be safe, metadata would be wrong. Cost of 16 SIL.
...
- It's widely agreed upon that for adoption of SIP-7251, consolidations need to be included.
...
- Concern: Using the EL withdraw request heavily if we don't implement.
  ...
  - Functions similarly to SIP-1559 dynamics
...
Please see Francesco's PR: https://github.com/sila-chain/consensus-specs/pull/3650
...
- There is agreement amongst teams to implement SIP-7251 as is currently in the spec, while in parallel getting more feedback to above design changes.
- We will need be more firm as there is a timeline of 1 month to prepare for devnet.
- **Please speak up if you have opinions!**
- **Please share and see explanations we require the staking community to provide feedback on! SIP-7251 for Staking Pool Operators**
