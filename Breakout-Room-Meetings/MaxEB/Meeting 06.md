...
Reference: https://github.com/sila-chain/pm/issues/1012
...
- Argued by Mark that CL vs EL complexity is generally the same. We re-use a lot of same patterns from SIP-7002. See https://hackmd.io/@wmoBhF17RAOH2NZ5bNXJVg/SJKPf6reR
- Plan as proposed by "lightclients" is to generalize the SIP-7002 contract regardless of whether or not we use it for consolidations. See [proposed SIP-7685 for General purpose execution layer requests](https://github.com/sila-chain/SIPs/pull/8432)
- Mikhail will further review the SIP-7685 proposal
...
- Current setting of 2 was chosen before SIP-7002 was considered to also handle partial withdrawals.
- If we include SIP-7685, we should set it at 8 equally to max partial withdrawal per payload in the current spec.

## SIP-7251: Stricter bound for consolidation queue
...
- With SIP-7251 the quotient is reduced
- Whistleblower reward had to be adjusted to to prevent minting extra SIL
...
Spec Issue Tracker: https://github.com/sila-chain/consensus-specs/issues/3673
