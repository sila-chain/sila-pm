...
* So I don't know how that lines up in terms of, of of dates, but I think in terms of just like the steps we need to take, yeah, that's, that's basically it. launching a new kind of long quote unquote lift, definitely DevNet, that, that people can try forking sepolia and Gordy TBD on the order. And then once all of that is stable, then we'd, we'd move to 14 sila-mainnet. another YouTube question was, is there a way to access or retrieve the complete withdrawal Q State including your position in the queue for a full withdrawal on the Sila blockchain? Yes, I, one more. 
