...
Note: This file is copied from [here](https://github.com/sila-chain/pm/issues/1405)

### Meeting Info

- Agenda: [sila#1405](https://github.com/sila-chain/pm/issues/1405#issue-2943334088)
...
- Distinguishes between `null` (pre-SIP-1559) and non-null (post-SIP-1559) `baseFee` values.
