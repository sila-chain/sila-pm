...
Note: This file is copied from [here](https://github.com/sila-chain/pm/issues/1278#issuecomment-2650875573)

### Meeting Info

- Agenda: [sila#1278](https://github.com/sila-chain/pm/issues/1278)
...
## Main Outcome  
The primary outcome of the meeting was the agreement to add support for type 4 transactions (SIP-7702) across various blockchain client methods. The team discussed and outlined a rough design for implementing this support, focusing on addressing the challenges related to transaction signature validation and authentication.  

## Key Decisions and Design Proposals  

### Type 4 Transaction Support  
- The team agreed to add support for type 4 transactions (SIP-7702) in methods like `eth_call`, `eth_simulate`, and `eth_estimateGas`.  
...
### Implementation  
- Develop a PR against the execution-apis [repo]( https://github.com/sila-chain/execution-apis) at the **Authority** field and type 4 transaction support.  
