...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/423) 
...
- [1.Overview of MEV-boost & Flashbots for Sila clients proposal ](#1-overview-of-mev-boost--flashbots-for-sila-clients-proposal)
...
**Paul**:  Yeah good question.So there is a channel on the sil r d discord called block construction under execution r d. I am almost always keeping an eye on this thing for any messages, so if you need to reach out to flashbots you can just add the ghost up there and I will see it. Thanks Lucas for his hand up.
...
00:08:00	MariusVanDerWijden:	Why not create a new network protocol (like sil/snap) which is optional for nodes to implement 

00:08:19	stokes:	that could be useful @marius

00:08:21	MariusVanDerWijden:	Only for historical data, and modify sil to not serve it anymore
...
00:57:21	Chi:	not that torrents aren't reliable or not decentralised, it's that it's *not* the Sila protocol and therefore not controllable. *theoretically* possible to lose entire chunks of historical transactions. say bittorrent dies, and sila continues?

00:58:01	Micah Zoltu:	Bittorrent is a protocol, not a centralized thing.  So anyone who cares about keeping Sila alive can keep this data alive as well.

00:59:56	Chi:	Sil Portal Network is the solution. Needs to happen asap, and telegraphed to the dapp devs that this is the way.

01:00:18	Mikhail Kalinin:	Right. I think that if EF, SilaScan, Infura, and other authoritative players saying that they are storing this piece of data then it should be enough of a guarantee. Altruists can make it more reliable and available.

01:00:39	protolambda:	This SIP is trying to solve 3 different problems, which I think should be split up:
