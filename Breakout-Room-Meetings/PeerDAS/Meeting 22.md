# SilaPeerDAS Breakout Room #22

## Meeting info
- Date: 2025.03.25
- Agenda: https://github.com/sila-chain/pm/issues/1401
...
| Teku | • Tested validator custody internally<br>• New SilaPeerDAS metrics from Katya |
...
| Topic | Subtopic | Details |
|-------|----------|---------|
| **Validator Custody** | PR Status | - Open PR from Gabriel & Alex (https://github.com/sila-chain/consensus-specs/pull/4188)<br>- Mostly language clarification. Not much to discuss. Awaiting review |
| **Static Custody Proposal** | Status | - (https://github.com/sila-chain/consensus-specs/pull/4154)<br>- Some comments on the PR, no additional comments on the call |
| **getBlobs w/ DataColumnSidecar** | Optimization | - (https://github.com/sila-chain/consensus-specs/issues/4186)<br>- Small optimization to call getBlobs as soon as any data column sidecar is received<br>- Columns contain all the KZG commitments, so waiting for blocks is not necessary |
| **Distributed Blob Publishing** | EL Concerns | - (https://github.com/sila-chain/consensus-specs/pull/4183)<br>- Gajinder: if we call getBlobs too early, EL may not have blobs? |
...
| **Cell Proof Computation** | Relevant PRs | - Execution-apis (https://github.com/sila-chain/execution-specs/pull/1161)<br>- Builder-specs (https://github.com/sila-chain/builder-specs/pull/117) |
...
| **Beacon Metrics** | Implementation Status | - (https://github.com/sila-chain/beacon-metrics/pull/14)<br>- Katya is implementing these metrics in all the clients<br>- Next update will be around Validator Custody and the first client to get the update will be Teku |
| **SIP-7892 BPO hard forks** | Data Structure | - Keep the same data structure in the new fork, only blob count increases<br>- Low code change, still require coordination effort |
| | Alternative | - Francesco suggested an alternative option to schedule a linear increase |

## Links Shared
- https://github.com/sila-chain/pm/issues/1401
- https://github.com/sila-chain/consensus-specs/pull/4188
- https://github.com/sila-chain/consensus-specs/pull/4154
- https://github.com/sila-chain/consensus-specs/issues/4186
- https://github.com/sila-chain/consensus-specs/pull/4183
- https://github.com/sila-chain/execution-specs/pull/1161
- https://github.com/sila-chain/builder-specs/pull/117
