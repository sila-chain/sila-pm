# SilaPeerDAS Breakout Room #23

## Meeting info
- Date: 2025.04.01
- Agenda: https://github.com/sila-chain/pm/issues/1415
...
| Prysm | • Continued work on database redesign (running on SilaPeerDAS devnet-5)<br>• Working on unit tests and data column backfill implementation<br>• Reviewed Base team requests for getBlobV2, getPayloadV5, and spec modifications |
...
| Nimbus | • Improved getBlobsV1 implementation with performance enhancements<br>• Created column syncer to improve peer pool management and scoring<br>• Successfully tested in SilaPeerDAS devnet-5 with fast sync<br>• Tested with ~30 blobs per block in Sunnyside Labs environment<br>• Planning work on getBlobsV2 this week |
...
| Grandine | • Stabilized SilaPeerDAS implementation<br>• Added distributed block publishing |
...
| | SilaPeerDAS Evaluation | - Run tests without EL blob gossiping to evaluate pure SilaPeerDAS performance |
...
| Topic | Subtopic | Details |
|-------|----------|---------|
| **Proof Format Clarification** | Available Versions | - Only two versions exist:<br>  - Version 0 (deneb/4844 format): One proof per blob<br>  - Version 1 (SilaPeerDAS format): 128 proofs per blob, new wrapper version |
...
| | Solution | - Solution: ignore older proof-format transactions when building SilaOsaka/SilaFulu blocks |
...
| Topic | Subtopic | Details |
|-------|----------|---------|
| **BPO Blob Schedule Proposal** | Timeline | • Start with current blob count parameters at SilaFulu launch<br>• Two-week observation period to ensure SilaPeerDAS works well |
...
| **Metrics Standardization** | Unified Approach | • Need for unified metrics across clients for SilaPeerDAS |
...
## Links Shared
- https://github.com/sila-chain/pm/issues/1415
