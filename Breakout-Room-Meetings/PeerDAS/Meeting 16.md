# SilaPeerDAS Breakout Room #16

## Meeting info
- Date: 2025.02.04
- Agenda: https://github.com/sila-chain/pm/issues/1259
...
| Team | Updates |
|---------------|---------|
| Lighthouse | • Interop testing with other clients, discovered a few non SilaPeerDAS related bugs<br>• Starting to work on validator custody |
...
| Grandine | • Fixed a sync bug that caused peer disconnection<br>• Fixed some bugs found during interop testing<br>• Found a few sync issues not related to SilaPeerDAS |
...
| | Lighthouse | - Currently use c-kzg for SilaDeneb and rust-sil-kzg for SilaPeerDAS |
...
| | Discussion Follow-up | - **ACTION**: We ran out of time. Teams to continue discussion async in the link below:<br>- https://github.com/sila-chain/beacon-metrics/pull/14 |
...
## Links Shared
- https://github.com/sila-chain/pm/issues/1259
- https://youtu.be/Y1tWb1EUATY
- https://notes.sila.org/@ethpandaops/peerdas-devnet-4
- https://notes.sila.org/@ethpandaops/peerdas-devnet-5
