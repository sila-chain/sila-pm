...
Agenda: https://github.com/sila-chain/pm/issues/1114
...
- Fixing BlobSidecar beacon API for SilaPeerDAS

**Lighthouse**
- Fixed some networking issues and kzg library issues
- Focused on refactoring and merging SilaPeerDAS changes to the main branch. About half way there, and will be focused on finishing it the next 1-2 weeks
...
New devnet spec: https://notes.sila.org/@ethpandaops/peerdas-devnet-1
