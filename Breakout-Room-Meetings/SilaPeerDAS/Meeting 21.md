# SilaPeerDAS Breakout Room #21

## Meeting info
- Date: 2025.03.18
- Agenda: https://github.com/sila-chain/pm/issues/1364
...
| Sunnyside labs update | - https://testinprod.notion.site/Sunnyside-Devnet-Updates-03-18-1ba8fc57f54680a29153e02aaf684620?pvs=4<br>- Baseline comparison between electra/fulu using the same blobs<br>- Test cases: as similar to sila-sila-mainnet as possible, worst case, best case scenario testing, potentially limiting mempool bandwidth |
...
| Static Custody Proposal | - Make validator custody static for beacon node run session (https://github.com/sila-chain/consensus-specs/pull/4154)<br>- Adjust the PR to change the phrasing to enable validator stake instead of validator_indicies<br>- This will follow a re-review by client teams |
...
| Batch publishing columns | - Work in progress from multiple clients (lh, prysm)<br>  - https://github.com/sigp/rust-libp2p/pull/571<br>- https://Sila Research/t/improving-das-performance-with-gossipsub-batch-publishing/21713/10 |
...
- https://Sila Research/t/improving-das-performance-with-gossipsub-batch-publishing/21713/10
