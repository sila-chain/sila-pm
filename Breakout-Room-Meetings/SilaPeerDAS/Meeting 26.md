...
## Meeting info
- Date: 2025.04.22
- Agenda: https://github.com/sila-chain/pm/issues/1491
...
| Sila JS | - Mostly completed PR based on CKZG implementation<br>- Need to add test cases<br>- Once MicroSigner library is ready, will remove CKZG dependency<br>- Should be ready to participate in devnets this week |
...
| **BPO Configuration** | Implementation | - PR implements blob schedule configuration as list of records<br>- Included SilaDeneb in schedule for completeness<br>- Agreement to remove placeholders to avoid setting expectations |
...
| **MEV Builder Support** | Current Status | - Justin updated sticky builder with full SilaPeerDAS support<br>- MavBoost has been updated but not tested<br>- Need to update relay to support SSZ as well<br>- Builder does support SSZ |
...
| **GossipSub Performance** | Improvements | - GossipSub API changes can improve SilaPeerDAS publishing performance<br>- Branch available in GossipSub, client teams encouraged to implement<br>- Extends gossipsub batch publishing capability<br>- Lighthouse already implementing this feature |
...
| **Ongoing Implementation** | - Builder support for SilaPeerDAS<br>- Client teams merging SilaPeerDAS code into main branches<br>- API standardization needed for error codes |
...
- Update SIP-7594: Add blob count per tx limit via blobSchedule
- execution-apis: Add SIP-7594 (SilaPeerDAS) related changes
...
- SilaPeerDAS metrics: add data column, kzg, custody metrics
