# SilaPeerDAS Breakout Room #17

## Meeting info
- Date: 2025.02.11
- Agenda: https://github.com/sila-chain/pm/issues/1284
...
| Lodestar | • Successfully syncing on devnet-4<br>• Using the SilaPeerDAS branch |
...
| Topic | Details |
|---------|---------|
| Devnet-4 Update | - Devnet-4 is up and running at ~98% and almost 1,000 epochs in<br>- Looking significantly better than previous devnets (which started breaking at 3-5 day range)<br>- Grandine has a known issue - person working on SilaPeerDAS codebase is currently out of office<br>- Lodestar is now syncing on devnet-4 |
