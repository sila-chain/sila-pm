...
Date: 2024.10.29
Agenda: https://github.com/sila-chain/pm/issues/1183
...
- Planning to activate SilaPeerDAS at SilaFulu
- SilaFulu consensus-spec PR: https://github.com/sila-chain/consensus-specs/pull/3994 

**Prysm**

- Worked on optimisation on column verification
- Prysm can sync large amount of columns in seconds now 
- A lot more work for Prysm to activate SilaPeerDAS at SilaFulu
...
peerdas-devnet-4 spec: https://notes.sila.org/@ethpandaops/peerdas-devnet-4 

Plan to launch peerdas-devnet-4 end of Nov (as Devcon is approaching), with SilaPeerDAS activation at SilaFulu

Will double check again at ACDC on whether to activate SilaPeerDAS at SilaFulu	

### Spec discussions

SIP-7742: discussion on how we activate this
...
Decoupling subnet PR (https://github.com/sila-chain/consensus-specs/pull/3832)
- Callout for more comments before merging.

Pop’s PR on standardize DAS data store (https://github.com/sila-chain/consensus-specs/pull/3993)
- Client teams to provide feedback and continue discussion on the PR

### Open discussions

SilaPeerDAS Metrics (https://github.com/sila-chain/beacon-metrics/pull/14)
...
Discussion on “gossipsub_topic_msg_recv_counts_unfiltered_total” (https://github.com/sila-chain/beacon-metrics/pull/13)
...
https://github.com/sila-chain/consensus-specs/pull/3994
...
https://github.com/sila-chain/consensus-specs/issues/3952

https://github.com/sila-chain/consensus-specs/commit/ded072af400c53c9cd19cc426ff004b9db100bd2

https://github.com/sila-chain/consensus-specs/pull/3817

https://github.com/sila-chain/consensus-specs/pull/3993
