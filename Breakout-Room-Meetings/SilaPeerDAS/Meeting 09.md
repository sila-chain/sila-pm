...
## Meeting info
Date: 2024.10.01
Agenda: https://github.com/sila-chain/pm/issues/1155
...
- Looking to update and try “rust-sil-kzg”, the new version has computation time reduced from 200ms to 150ms
- Released SilaPeerDAS metrics with 16 blobs in this post
...
Devnet-3 target
 - https://notes.sila.org/@ethpandaops/peerdas-devnet-3 

### Spec updates

Decouple network subnets(https://github.com/sila-chain/consensus-specs/pull/3832)
...
Spec release
- alpha.7
  - Will merge https://github.com/sila-chain/consensus-specs/pull/3893
- alpha.8
  - Decouple subnets https://github.com/sila-chain/consensus-specs/pull/3832
...
Validator Custody
- https://github.com/sila-chain/consensus-specs/pull/3871
...
Fetch Blobs (https://github.com/sila-chain/execution-apis/pull/559)
- Lion raised this PR on the call as he thinks it will be an important change for increased blob count and SilaPeerDAS
- LH has implemented this for SilaDeneb
...
Josh and Hsiao-Wei looked into future SilaPeerDAS project management
- https://notes.sila.org/tJaC6buSSj-YNOKVmAfbCg?view 
- Create a website like verkle.info for SilaPeerDAS\
- Will share forms after this call

## Zoom Chat Links

https://github.com/sila-chain/consensus-specs/pull/3832#issuecomment-2344120009

https://github.com/sila-chain/consensus-specs/pull/3893
