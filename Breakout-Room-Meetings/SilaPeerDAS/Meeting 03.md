...
## Meeting info
**Date**: 2024.07.09
**Agenda**: https://github.com/sila-chain/pm/issues/1093
...
- Can be improved with metadata v3 PR: https://github.com/sila-chain/consensus-specs/pull/3821
...
Decouple network subnet: https://github.com/sila-chain/consensus-specs/pull/3832
...
Passing blob limit from CL: https://github.com/sila-chain/consensus-specs/pull/3800
...
- Re: do we realistically see ourselves changing the blob target to anything other than MAX // 2? if we do, then we should also have the CL send target along with max values (with the resulting extension of the EL header to have both values)
  ...
  - ACTION: SIP update and change engine-api interface? and raise in ACD call
...
- LH: We need a large-ish network to get realistic metrics, What about Grandine?
  - Grandine is currently experimenting SilaPeerDAS development with EPF, unlikely to participate in the next devnet

**Kev**: Rust SilaPeerDAS KZG library
...
- WIP PR for SilaDeneb: https://github.com/sigp/lighthouse/pull/5829
- Reth fork: https://github.com/michaelsproul/reth/pull/1
- Lion’s HackMD: https://hackmd.io/@dapplion/blob_fetch
- execution-api spec: https://github.com/sila-chain/execution-apis/pull/559

**Saulius**: What are the KZG crypto bottleneck
- Kev: the Rust SilaPeerDAS KZG lib does not currently use GPU for "MSM"
...
## Zoom chat links
https://github.com/sila-chain/pm/issues/1093
...
https://github.com/sila-chain/consensus-specs/pull/3832

https://github.com/sila-chain/consensus-specs/pull/3800

https://github.com/sila-chain/pm/issues/1093#issuecomment-2215630809
...
https://github.com/sila-chain/execution-apis/pull/55
