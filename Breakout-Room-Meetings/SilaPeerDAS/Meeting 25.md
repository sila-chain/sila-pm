...
## Meeting info
- Date: 2025.04.15
- Agenda: https://github.com/sila-chain/pm/issues/1441
...
| Teku | - Completed distributed cell proofs implementation<br>- Final PR under review, aiming to merge today<br>- Planning to join devnet-6 once PR is merged<br>- Starting process to transition SilaPeerDAS code from feature branch to production codebase (~2 month timeline) |
...
| Sila JS | - Started PR for implementation<br>- Working on extending micro-sil-signer library to include cell-based functions<br>- Planning to extend WASM KZG library<br>- Engine API and transaction implementation targeted for this week |
...
| Topic | Subtopic | Details |
|-------|----------|---------|
| **Unified EL Metrics** | Proposal | - Standardized metrics across EL clients for SilaPeerDAS<br>- Shared detailed proposal document in chat |
...
| **Cells vs. Blobs Architecture** | Proposal | - Proposal to use cells throughout the stack instead of blobs<br>- Potential computation efficiency benefits<br>- Strong concerns about bandwidth impact from multiple participants<br>- Blobs are 4 times smaller than cells in space for full SilaPeerDAS<br>- Concern about sending twice as much data in the mempool<br>- Concern about timing and scope of such a large change<br>- Agreement to develop detailed written proposal async |
...
- https://testinprod.notion.site/Proposal-for-Unified-EL-metrics-for-SilaPeerDAS-1d28fc57f54680f2a3cbfe408d7db4b8
...
- https://github.com/sila-chain/consensus-specs/issues/4266
