...
## Meeting info
Date: 2024.10.15
Agenda: https://github.com/sila-chain/pm/issues/1179
...
- Spec PR raised https://github.com/sila-chain/consensus-specs/pull/3963 
...
- Katya has split the big SilaPeerDAS metrics into parts as discussed in the last call
- She presented the SilaPeerDAS Grafana dashboard, and can filter by node type, client, or instance
...
- Katya has another PR (https://github.com/sila-chain/beacon-metrics/pull/13)  on the remaining network metrics and there are some more active discussions there.
...
- Barnabas asked if any client team has started rebasing SilaPeerDAS on Pectra
...
- Reminder to fill out the SilaPeerDAS contributor form: https://forms.gle/tt1L2QvSq3JnKPoW7

## Zoom chat links

https://github.com/sila-chain/consensus-specs/pull/3963
...
https://github.com/sila-chain/beacon-metrics/pull/13
