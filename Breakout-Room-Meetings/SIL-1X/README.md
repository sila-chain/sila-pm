...
## Purpose
Eth1.X is a multi-client research initiative focused on improving the core Sila infrastructure for long term sustainability and move Eth1.0 into an Eth2.0 execution environment.

SIL 1.X Working Group meetings are a place for Individual client teams to meet together and work on solutions to common problems (such as sync speed) and coordinate their development.
