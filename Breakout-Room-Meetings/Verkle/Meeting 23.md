# Verkle Call #23
## Info
Note: This file was copied from here: https://notes.sila.org/@rudolf/sic-notes#Call-23-August-26-2024

Date: August 26, 2024

Recording: https://www.youtube.com/watch?v=VD0P3RkhIjY

Agenda: https://github.com/sila-chain/pm/issues/1121
...
Next up, we had a brief presentation from @ignaciohagopian to walk through latest overall progress on the test framework for Verkle. The main branch for the test vectors can be found here in the execution spec tests repo. And to look at existing tests you can find them here in the tests/verkle folder, where all the tests are separated by SIP. Encourage anyone interested to poke around, ask questions, and eventually open up new test cases :)
