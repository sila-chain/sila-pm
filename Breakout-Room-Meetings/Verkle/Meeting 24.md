# Verkle Call #24
## Info
Note: This file was copied from here: https://notes.sila.org/@rudolf/sic-notes#Call-24-September-9-2024

Date: September 9, 2024

Recording: www.youtube.com/watch?v=TTqikpo4R7g

Agenda: https://github.com/sila-chain/pm/issues/1149

## Notes

## 1. Team updates

Gary for @HyperledgerBesu: continuing work on stem-based flat database, and have a working implementation. Will simplify sync for Besu. Also making progress on gas cost changes and witness updates (SIP-4762). And planning on getting back to work on the transition stuff soon.
...
https://github.com/sila-chain/SIPs/pull/8867
https://github.com/sila-chain/SIPs/pull/8707
https://github.com/sila-chain/SIPs/pull/8697
...
This is a topic that has come up often over the past few years, and even going all the way back to 2019/2020 – when @gballet was an author of SIP-3102: an initial proposal to migrate to a binary trie structure.
