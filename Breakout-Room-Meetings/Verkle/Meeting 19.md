...
@ignaciohagopian
 has been working on for the verkle-specific SIPs.
...
Decision made on the call: agreed to bump it to 3 bytes (16mb), and Guillaume to update the SIP to reflect this.
...
Last up, we spent the remainder of the call discussing preimage distribution. @GabRocheleau shared an idea for using the execution witness in Verkle to distibute preimages just-in-time. You can read a bit more about this idea here: https://notes.sila.org/QUOsJN2mTQOqEtUQMsBUlw, and also a more detailed summary of the preimage distribution problem in general here: https://hackmd.io/@jsign/vkt-preimage-generation-and-distribution.
