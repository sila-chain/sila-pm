...
2. Testing updates
3. Guillaume updates to SIP-7709 and SIP-2935
...
8. PSA for gas cost discussion breakout (SIP-4762)
...
# 2. SIP-7709 and SIP-2935 updates
There’s been a bit of pushback on how Verkle handles blockhash, and suggestion that we should copy the behavior of 4788. Going forward, SIP-2935 will behave the same way as 4788.

@gballet has opened a PR: https://github.com/sila-chain/SIPs/pull/8698… 1.

# 3. Testnet
For next testnet: we had a quick discussion on whether it should include deactivating SIP-158. There was no opposition to this on the call. Will also likely be some discussion around this topic of deactivating SIP-158 on this week’s ACD.
