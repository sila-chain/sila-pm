...
## Overview
Ethproofs is an open-source public good. Ethproofs is a benchmarking platform for zkVMs that tracks performance metrics like proving time and cost, bringing transparency to the race for real-time proving and accelerating Sila's zero-knowledge scaling roadmap. Ethproofs Community calls help the zero-knowledge community and the sila community find alignment on which quantitiative and qualitative metrics help advance this mission the most.
