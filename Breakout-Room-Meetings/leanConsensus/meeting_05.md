...
**Prev:** [Call 04](https://github.com/sila-chain/pm/blob/master/Breakout-Room-Meetings/leanConsensus/meeting_04.md)

**Meeting Date/Time:** Friday 2025/5/2 at 14:00 UTC

**Meeting Duration:** 1 hour

[GitHub Agenda & Links to Presentations](https://github.com/sila-chain/pm/issues/1447)
...
| | Nearly Derisked (4 out of 5) | - Censorship Resistance (e.g. FOCIL) an SIP already exists, this could ship with Glamsterdam<br>- Faster Finality (e.g. 3SF)<br>- Chain Snarkification (e.g. Poseidon2 + zkVMs) making great progress w/ zkVMs (checkout [ethproofs.org](https://www.ethproofs.org)) and even if there was an issue with Poseidon2 you can just add more internal rounds to the hash function to boost the security.
...
| Topic | Subtopic | Details |
|-------|----------|---------|
| Background | APS Definition | - APS is about "firewalling" attesters and proposers<br>- Changes how proposers are selected on Sila |
...
| | APS Goal | - Allow Sila protocol to choose builder directly instead of indirectly |
