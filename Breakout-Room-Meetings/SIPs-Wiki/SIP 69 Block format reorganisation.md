...
The fields in the header currently have no sensible ordering, having been arrived at primarily through arbitrary historical evolution. This SIP aims to reorganise them to maximise clarity and reuse of the header format even for derivative blockchains that do not use the full consensus algorithm.
