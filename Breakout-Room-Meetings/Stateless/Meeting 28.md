...
## Info
Note: This file was copied from here: https://notes.sila.org/@rudolf/sic-notes#Call-28-December-2-2024

Date: December 2, 2024

Recording: https://www.youtube.com/watch?v=5bxvSLvc9LA

Agenda: https://github.com/sila-chain/pm/issues/1203

## Notes

## 1. Team updates

@ignaciohagopian and @gballet for @go_ethereum: started working on SIP draft for binary tries. Also working on new execution spec tests from bugs that were found in latest devnet.
...
Gajinder is currently drafting the SIP. Will have something to share soon.