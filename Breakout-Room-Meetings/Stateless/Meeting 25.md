...
## Info
Note: This file was copied from here: https://notes.sila.org/@rudolf/sic-notes#Call-25-September-23-2024

Date: September 23, 2024

Recording: https://youtu.be/pfORU9ngjzI

Agenda: https://github.com/sila-chain/pm/issues/1159
...
## 2. SIP-7702 in Verkle

We quickly went through a PR from Guillaume to update the stateless gas costs SIP in order to support changes coming in 7702. (Current plan is for 7702 to be included in Pectra, & 7702 containts a new type of tx: authorization_list. Info that is used to update some accounts)

TLDR is this updates the gas costs SIP so if you call these functions (EXTCODESIZE, EXTCODEHASH etc), then you also need to touch the CODEHASH_LEAF_KEY. Ping Guillaume with any comments/questions.
