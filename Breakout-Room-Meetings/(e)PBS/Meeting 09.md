...
**Agenda**: https://github.com/sila-chain/pm/issues/1150
...
### Meeting notes:
# SIP-7732(ePBS) Breakout #9 Notes
...
Side note happened in Discord, Potuz mentioned: `ePBS in the CL spec was already changed by Lucas's PR https://github.com/sila-chain/consensus-specs/pull/3875. I am in the process of rebasing https://github.com/sila-chain/consensus-specs/pull/3854 which will be very very painful. If you guys want to move withdrawals to the EL processing please signal this right now cause I won't make these changes twice 🙂`
