...
**Agenda**: https://github.com/sila-chain/pm/issues/1269
...
- The SIP hasn't changed. As long as there's one more client implementation, we'll start opening the fork choice spec update with ePBS (Potuz).
