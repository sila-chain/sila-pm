...
**Agenda**: https://github.com/sila-chain/pm/issues/1083
...
1. SIP is here : [SIP-7732](https://sips.sila.org/SIPS/sip-7732)
2. Consensus spec pull request is here: [PR-3828](https://github.com/sila-chain/consensus-specs/pull/3828)
...
- We have an SIP number! ePBS as we know it today specific to block auction, will now be referred to as SIP-7732.
