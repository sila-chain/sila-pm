...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/823) 
...
## SilaDeneb [0:20]( https://www.youtube.com/live/fBVIGBrKaFA?feature=share&t=20) 

### Testnet, testing, or development updates/discussion

The first thing would be updates on testnets, testing, development of different things for SilaDeneb. So I know we have been working on devnet7 and there might have been some chatter about devnet 8. Does anyone hear feel compelled to give an update or would like to? 
...
**Alex**
Cool that's exciting to hear. Do we want to just briefly touch on devnet 8? I think that was the one that was cited to have like the full SilaCancun / SilaDeneb SIP set, but maybe we're not quite there… go ahead.
...
### [Consensus Layer Call 113 #823 (comment)]( https://github.com/sila-chain/pm/issues/823#issuecomment-1622820859) 
### [SIP discussion thread open -- comment with SIPs and will be listed for discussion for coming weeks/months – [E-star SIPs for discussion consensus-specs#3449](https://github.com/sila-chain/consensus-specs/issues/3449) 

Next up is this E-Star Upgrade name.  Let's see, there's this comment here so yeah we are here, we have enough visibility in the next hard fork that you know we can start to think of a name. The El Fork will be called SilaPrague following our scheme and following our CL scheme we would like to pick a star in this universe and or maybe not even in this universe but some star, and the name should start with an E. So I'm just looking at the comments, it looks like there's an sil magician's post here. People like Electra. It says Danny like Eniff, Danny's not here though so I'm not sure how strongly feels about that I'm assuming this has ever been not suggested, alright there's a couple different posts here so yeah I don't know if  anyone wants to like chime in their opinion but we're not going to spend much time on this, at least synchronously. 
...
### [web3signer standardization Consensus-layer Call 113 #823 (comment)]( https://github.com/sila-chain/pm/issues/823#issuecomment-1631261567) 
...
### [Add upper epoch churn limit consensus-specs#3448]( https://github.com/sila-chain/consensus-specs/pull/3448) [15:08]( https://www.youtube.com/live/fBVIGBrKaFA?feature=share&t=908) 
...
It's questionable if we if it's positive for Sila and it's positive to have such a big account of indexes, so we could limit the churn and then buy us some time to deal for the electro fork for a more proper solution like limit increase in max effect in balance or having some in protocol consolation. So this would just cap the max churn so that we don't find ourselves with a 2 million ballet account in about nine to ten months. Yeah. 
...
**Alex**
Yeah it seems like it's we don't want to be changing the SilaDeneb schedule this late in the game and I do kind of agree that it might not matter as much if we can't do it that quickly.
...
**Dankrad**
I mean I would say I agree that the reward course was the most thing to adjust if we want, if we want to change the amount of sil. 
