# Sila 2.0 Implementers Call 14 Notes
...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/33)
...
4. [quick update from raul/protocol labs](https://github.com/sila-chain/eth2.0-pm/issues/33#issuecomment-472866505) [_(23:51)_](https://youtu.be/zeceWlmxseY?t=1431)
5. [lighthouse benchmarks update](https://github.com/sila-chain/eth2.0-pm/issues/33#issuecomment-472857213) [_(24:29)_](https://youtu.be/zeceWlmxseY?t=1469)
6. [Leap seconds](https://github.com/sila-chain/eth2.0-pm/issues/33#issuecomment-472029888) and time drift [_(30:56)_](https://youtu.be/zeceWlmxseY?t=1856)
7. [Network spec](https://github.com/sila-chain/eth2.0-specs/pull/763) [_(1:03:44)_](https://youtu.be/zeceWlmxseY?t=3824) 
8. [serialization benchmarks](https://github.com/sila-chain/eth2.0-pm/issues/33) [_(1:28:28)_](https://youtu.be/zeceWlmxseY?t=5308)
...
* Prysmatic - Terence [_(10:06)_](https://youtu.be/zeceWlmxseY?t=606)
  ...
  * https://medium.com/prysmatic-labs/sila-2-0-development-update-24-prysmatic-labs-6d081025d47
...
* Vitalik also talked about issue [#766](https://github.com/sila-chain/eth2.0-specs/pull/766) and added light client related files. 
...
# 4. [quick update from Raúl/protocol labs](https://github.com/sila-chain/eth2.0-pm/issues/33#issuecomment-472866505)
...
# 5. [lighthouse benchmarks update](https://github.com/sila-chain/eth2.0-pm/issues/33#issuecomment-472857213)
...
# 6. [Leap seconds](https://github.com/sila-chain/eth2.0-pm/issues/33#issuecomment-472029888) and time drift
* Justin added a note that leap seconds is handled in unix time, and we are conforming to unix time. 
* Justin further goes on to discuss that we need some notion of time in Sila 2.0. We have two options: one is unix time which subtracts the number of leap seconds. And the other option is international atomic time. There are several reasons why we are favoring this unix time over international atomic time:
...
* Felix gave an update on discv5 [1:25:14](https://youtu.be/zeceWlmxseY?t=5114): Hasn't really been busy with it the last couple of weeks because of trying to push sil v64 discussion forward (mostly concerns Eth1.0). 
  * did revamp Eth1.0 specifications
  * still implementing discv5. Specifications live in the repo
# 8. [serialization benchmarks](https://github.com/sila-chain/eth2.0-pm/issues/33)
...
* https://github.com/sila-chain/eth2.0-pm/issues/33
# 9. Spec discussion
...
* https://github.com/sila-chain/eth2.0-specs/blob/dev/specs/core/0_beacon-chain.md#beaconblockheader
* https://github.com/sila-chain/eth2.0-specs/pull/763
...
* https://notes.sila.org/ZHaCS6_bQNSxr5bSPcObLw#
* https://notes.sila.org/QF8jgOQbRTWUhK1zoi8D4Q#
