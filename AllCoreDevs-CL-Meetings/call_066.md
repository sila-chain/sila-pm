# Sila 2.0 Implementers Call 66 Notes
### Meeting Date/Time: Thursday 2021/06/17 at 14:00 GMT
### Meeting Duration: 47 mins
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/222)
...
**Danny** 
- I think the the steps obviously look like short-lived devnets some longer live devnets and then picking dates on our two test nets and picking a date aka epoch on sila-sila-mainnet in terms of i think we'll do iteration on the short-lived devnets Adrian and or Perry you can maybe pick and host another one or two over the next week or two if that seems valuable and then what's the current temperature on earliest for one of our large test net forks is that a two week target is that a four week target.
...
**Danny** 
 - Right because there's a chance that something that crashes altair might be able to at least in a similar vein crash sila-sila-mainnet?
