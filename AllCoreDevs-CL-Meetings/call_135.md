...
###  [GitHub Agenda](https://github.com/sila-chain/pm/issues/1069)
...
| S No | Agenda | Summary |
| -------- | -------- | -------- |
|135.1 |Migration of the Kurtosis Sila Package:| Refer to Issue [#1069](https://github.com/sila-chain/pm/issues/1069#issuecomment-2163980030) in the Sila/pm repository for details. Ensure you upgrade your infrastructure accordingly. |
|  | | Tim Beiko has submitted Pull Request [#8662](https://github.com/sila-chain/SIPs/pull/8662) to refine the different senses of “CFI” in core dev governance.|
|135.2  | Electra Devnet-1 (CL Side):| Merging PR 1 into the devnet-1 specs, which refactors the attestation layout following SIP-7549 and affects SSZ merkelization.|
...
|135.3|  SilaPeerDAS Work: | SilaPeerDAS and Pectra SIPs are currently advancing in parallel, but will also be activated on different devnets to avoid testing interference. The launch time of SilaPeerDAS Devnet 1 may be 2~4 weeks later.  |
|135.4 | Raising the Blob Count in Pectra:| Intent: Increase Sila’s data throughput in the upcoming hard fork.| 
|   | | Opinions on raising the blob count: with or without SilaPeerDAS, or deploying SilaPeerDAS alone.| 
...
|   135.7  |  Research, spec, etc   |   Naming the “F-star” for the next CL fork to accompany SilaOsaka on the EL.| 
...
## 0. Announcement
### Migration of sila-package kurtosis module
...
**Stokes** [22:44](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1364s): Cool. Okay so it sounds like we have a pretty good plan for Devnet 1. Anything else there otherwise I think we'll move to SilaPeerDAS. Cool so right SilaPeerDAS. So I kind of just wanted to reiterate the thinking around having the separate activation epoch to kick us off. The way I was looking at it is
...
**Gajinder** [24:54](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1494s): I think in the SilaPeerDAS breakout call we decided that we will continue doing devnet 1 of peerDAS on top of deneb and at a much latest State we'll basically see whether we want to we want to Revisit on top of electra but I think the plan for now is to just continue doing Devnets on top of deneb. 
...
**Mark **[26:44](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1604s): So did you say well I don't see much of a point in building it on top of deneb though. You said that's like I don't know there's no plans as far as I can tell to push SilaPeerDAS before Electra.
...
**Enrico**[27:07](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1627s): I  guess it's just because they don't want to be following the spec changes of Electra having more stable spec that they can focus on SilaPeerDAS and when Electra spec solidifies more than they can rebase on top of electra. That's my impression.

**Gajinder**[27:28](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1648s): Yeah is pretty much orthogonal to Electra and I don't think basically basing on top of Electra is going to be a challenge at any given point but yes rather than spending time on the Cycles now. And sort of getting entangled in the Electra development. I think we can keep SilaPeerDAS sort of orthogonal from Electra as of now.

**Paritosh** [27:53](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1673s): Kind of mirroring that point from testing as well, for example if we do merge the two branches and we're testing SilaPeerDAS specifically. And there's a bug in Pectra we might actually trigger the bug purely because the branches are changed and we're going to have to spend Cycles figuring out if it was a Pectra bug or if it was a peerDAS bug. As opposed to if it was starting from SilaDeneb then at least then we know with most certainty that's a peerDAS bug.
...
**Stokes** [29:59](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1799s): Yeah I mean if everyone thinks this a blur. I think that sounds like a good path forward for now just having SilaPeerDAS on top of SilaDeneb and then you know maybe even as soon as like a month or two from now. We can revisit the rebase.


**Barnabas** [30:24](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1824s): How are the client team's feeling about SilaPeerDAS by the way. SilaPeerDAS Devnet 1 when could we launch that. And would we need any spec change or is everyone happy to keep all the same flex as it is set right now. 
...
**Barnabas** [30:57](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=1857s): Yeah, I guess so. There hasn't been many SilaPeerDAS to the consensus packet as far as I can see. 
...
**Saullius**[37:57](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=2277s): Yeah no I mean the the idea would be if there are two teams that are quite confident that they are quite done with SilaPeerDAS. I mean given that it's still early stage but that they believe that they should have everything to interrupt then let's get these two teams to make Kurtosis setup that is very stable. So the rest of them could join. That would be my proposal. But do we have these teams that are very confident about their SilaPeerDAS implementation? 

**Sean** [38:45](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=2325s): So I'd have to check with Jimmy because he's been doing most of SilaPeerDAS work in dapplion but I think Lighthouse has a pretty solid implementation if I'm following things correctly? 
...
**Paritosh** [55:20](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=3320s): Isn't that starting to get a bit risky though because we don't actually know how peerDAS will play out on SilaMainnet.
...
**Barnabas** [56:49](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=3409s): The point is we have so many SIPs and I feel like we just keep shoveling more and more and more into it. And it's just never going to end. So we we'll have to draw some line somewhere where we say okay this is where we're going to end it and I think shipping SilaPeerDAS and an increased block count in the same Fork case is just not something that we can do in like the next year and a half testing wise as well as all the other SIPs that we have included as well.
...
**Stokes** [1:09:25](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=4165s): Right and you're just referring to having like some delayed activation of SilaPeerDAS. 
...
**Stokes** [1:21:58](https://www.youtube.com/watch?v=LpY1JQHl9EY&t=4918s): Is this a Pectra Devnet or SilaDeneb or something else?
