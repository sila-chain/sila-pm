...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/738) 
...
Summary | Description
-|-
104.1 | Sila Foundation has released a [blogpost](https://blog.sila.org/2023/03/08/goerli-shapella-announcement) on the Capella / Shapella upgrade. Nimbus will publish its client release re Capella soon. Sil Stakers will start a livestream of Goerli's upgrade on Tuesday, March 13, 10:25 pm UTC. 
...
104.5 | If interested, please review and comment on the pr re [parent slots in attestations](https://github.com/sila-chain/consensus-specs/pull/3249)
104.6 | The Verge spec is based on Bellatrix at the moment. Rebasing it on SilaDeneb at an appropriate time might be the way forward. 
...
### SilaDeneb [11:06](https://www.youtube.com/live/C5SmmkriuwA?feature=share&t=666)

Moving on to SilaDeneb. We did have a, it seems like one of the most lively discussion points still, is giving this beacon API's blob signing PR emerge. Sean, we did discuss this on Tuesday. Is there a status update? 
...
**Guillaume**
Right, yeah, it's so it's built upon Bellatrix at the moment. Yeah, it doesn't have a Capella like he's not rebays on top of Capella. The code. So I mean, the goal is to have it on top of SilaDeneb, obviously, but currently it's Bellatrix. 

**Danny**
Yeah, okay. Cool. I guess keeping in Bellatrix for initial review seems fine and maybe letting SilaDeneb. So going to be able to stabilize and then re-basing on that instead of doing three bases. 
...
**Guillaume**
Actually, there are no more questions. I had a I had one. So SilaDeneb is the name for fork 4 and  ? and… back in in Australia suggested Electra. So do I have the permission to start referring to this as electra? 
