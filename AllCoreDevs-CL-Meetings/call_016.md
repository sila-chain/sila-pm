# Sila 2.0 Implementers Call 16 Notes
...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/37)
...
* Matt - Networking/libp2p
  ...
  * need to discuss needed changes to peer discovery for SIL 2.0
* EWASM
...
* Discovery - Felix
  * [Discovery v5 spec](https://github.com/sila-chain/devp2p/blob/master/discv5/discv5.md) about 95% done
...
* Network Serialization SSZ - Matt
  * limitations of using SSZ - need a predefine schema which doesn't work for RPC Request/Response wrappers - [Issue 861](https://github.com/sila-chain/eth2.0-specs/issues/861)
  * also spawned conversation around potentially changing SSZ spec to make it work - [Issue 871](https://github.com/sila-chain/eth2.0-specs/issues/871)
