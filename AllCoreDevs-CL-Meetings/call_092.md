...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/574)
...
**Danny Ryan (24:35) -** Okay, next up, exchange configuration before TTD is actually set for sila-sila-mainnet. There's a desire to do this to allow people to get their setups going. And probably some details to decide if we're going to do that. Paul, can you give us what's going on here?
...
**Danny Ryan (26:09) -** Right. So that value was put in to our sila-sila-mainnet configurations for the ability to do testing and to do so without the value that was saying I mean value that was not going to accidentally trigger this on sila-sila-mainnet, if things work they're way into sila-sila-mainnet. So I do think it's a reasonable value to show up in there if people want to be able to do the configuration.
...
10:02:30 From  danny  to  Everyone: https://github.com/sila-chain/pm/issues/574
...
10:20:41 From  Marek Moraczyński  to  Everyone: https://github.com/sila-chain/consensus-specs/blob/981b05afb01d5b19be3a5a60ccb12c3582e4c0cf/configs/sila-sila-mainnet.yaml#L16

10:22:59 From  Mikhail Kalinin  to  Everyone: https://github.com/sila-chain/consensus-specs/pull/2955

10:27:14 From  xinbenlv.sil  to  Pooja Ranjan(Direct Message): Pooja, do you know if there is a live note?

10:28:31 From  Pooja Ranjan  to  xinbenlv.sil(Direct Message): I am not aware of but, Ben will post one quick notes right after the meeting. Christine May have started recently, may want to check.
...
10:39:38 From  stokes  to  Everyone: https://github.com/sila-chain/builder-specs/pull/38
