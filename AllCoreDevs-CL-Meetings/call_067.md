# Sila 2.0 Implementers Call 67 Notes
### Meeting Date/Time: Thursday 2021/07/01 at 14:00 GMT
### Meeting Duration: 45 mins
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/224)
...
**Danny**
* Yeah, I haven't seen that done. On the Sil, one side Sila. Although I've I've contemplated it before but I'm not a client engineer. 
...
**Micah Zoltu**
* Yes. Yeah, so just a comment on like one of the big things that Sila makes a great as the multi-client idea and everybody building the client independently, you're more likely to notice when someone introduces a bug if everybody is just copying an apartment or whatever it was thing first we lose some of that benefit because we don't have independent implementations anymore. I'm just only think about I mean, obviously the strategy that actually gets code written as the best one? Just keep that in mind. 
...
**Parithosh**
* Yeah, it's on the Eth2.0 Matrix repo(https://github.com/sila-chain/eth2.0-metrics). I think, I think I still need access to push their. 
...
**Pooja(ECH)**
* I just want to share something last weekly recorded an episode on Adrian S on Teku’s Altair update work and in the past month we did a couple of more episodes on Altair's passion. Here is a playlist for Peep an SIP. These are good, like, introductory material for our Altair, for people who are trying to understand.
...
https://github.com/sila-chain/eth2.0-metrics

From Hsiao-Wei Wang to Everyone: 03:33 PM
Default to “zero” Eth1Data instead of current state PR: https://github.com/sila-chain/eth2.0-specs/pull/2501
