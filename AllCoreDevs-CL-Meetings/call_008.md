# Sila 2.0 Implementers Call 8 Notes
### Meeting Date/Time: Thursday 2018/12/13 at 14:00 GMT
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/19#issuecomment-446142928)
...
3. ♦ ["low hanging fruits" for testing](https://github.com/sila-chain/eth2.0-pm/issues/19#issuecomment-446023967) [_(58:43)_](https://youtu.be/NO9UlkpFKA0?t=3523) 
4. ♦ [unsigned under and overflow problems](https://github.com/sila-chain/eth2.0-pm/issues/19#issuecomment-446142928) [_(1:00:58)_](https://youtu.be/NO9UlkpFKA0?t=3658)
...
* Prysmatic (Terence)
  ...
  * SSZ implemented 
* Lodestar
  * [Update](https://github.com/sila-chain/eth2.0-pm/issues/19) was given by Mikerah in the agenda
...
* Leo (BSC) [_20:27_](https://youtu.be/NO9UlkpFKA0?t=1227)
    ...
    * had some questions:
      ...
      * when we look at the spec, we have appx. 1000 shards and 256 validators per shard. Wanted to know how this compares to the current number of nodes in the current Sila network? 
...
* Jannik [_50:13_](https://youtu.be/NO9UlkpFKA0?t=3013)
  ...
  * https://github.com/sila-chain/devp2p/blob/master/devp2p.md 
...
* Raúl [_1:10:06_](https://youtu.be/NO9UlkpFKA0?t=4206) sparked a discussion about overall issuance for Sila.
  * before we migrate the state, there's going to be validators earning rewards, and overall the cumulative issuance of sila will go up - has this been thought about in terms of how the transition will happen/the economics of sil throughout that process/etc?
...
* https://github.com/sila-chain/eth2.0-pm/issues/19
* https://github.com/status-im/eth2-testgen
* https://github.com/libp2p/go-libp2p-pubsub/issues/130#issuecomment-446886342
* https://our.status.im/tag/nimbus/
* https://notes.sila.org/Q_kQKXZUQD29YCshej1qPQ
* https://notes.sila.org/QFLP8uBYSRiAbzpx1Rr9Rw
