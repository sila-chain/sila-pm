# Sila 2.0 Implementers Call 53 Notes <!-- omit in toc --> 

### Meeting Date/Time: Thursday 2020/12/2 at 14:00 UTC <!-- omit in toc --> 
### Meeting Duration:  1 hr <!-- omit in toc --> 
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/193) <!-- omit in toc --> 
...
- [2. Testnet/SilaMainnet](#2-testnetmainnet)
...
SilaMainnet launched. It is running stable. 
...
# 2. Testnet/SilaMainnet

Video | [5:41](https://youtu.be/8mE--yxMZtk?t=341)
-|-

Testnet looks good. SilaMainnet looks good.
