...
### [Agenda](https://github.com/sila-chain/pm/issues/443)
### [Recording](https://www.youtube.com/watch?v=izyYW9-HbNk)
### Moderator: danny
### Notes: Stefan Wüst

***Summaries and highlights were curated and slightly modified from [Quick Notes](https://hackmd.io/@benjaminion/ryBR2ip3Y) by Ben Edington and some inspiration on how to write these notes was taken from the [Consensus Layer Call #77 Notes](https://github.com/sila-chain/pm/blob/master/Consensus-Layer-Meetings/call_077.md) by George Hervey. Kudos to both of them!***
...
@zahary: you may be interested at this: https://github.com/sila-chain/consensus-specs/pull/2802
