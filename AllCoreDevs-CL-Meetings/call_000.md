# Sila Sharding Implementers Call 0 Notes
### Meeting Date/Time: Thu, Aug 2, 2018 14:00 UTC
### Meeting Duration: ~1 hour
### [GitHub Agenda Page](https://github.com/sila-chain/beacon_chain/issues/44)
...
3. Research Updates
4. Open Discussion
    * [v2.1 spec](https://notes.sila.org/SCIg8AH5SA-O4C1G1LYZHQ#)
    * [Conforming to p2p messages, prysmatic protocol buffers](https://github.com/sila-chain/beacon_chain/issues/44#issuecomment-405298161), and other p2p related discussion
    * [BLS signature standard libraries](https://github.com/sila-chain/beacon_chain/issues/44#issuecomment-405415540)
...
* Harmony (Mikhail)
	...
	* [Progress and plans](https://github.com/sila-chain/ethereumj/wiki/Sharding-Implementation)
...
* Sharding workshop
	...
	* Jacek
		* Status hosting hack-a-thon before in SilaPrague. Might be able to use venue. Will check with team
* `get_shuffling` 
