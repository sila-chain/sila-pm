...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/484) <!-- omit in toc --> 
...
**Danny**: V2   other than his name change can be kind of done overtime because of the way that the API port has the old one. So this is the only thing that would make v1 and v2s not be able to talk to each other so I would suggest that everyone just change the name now because otherwise, we are gonna have a headache. The name change at this point is headache. But that API or that SIP around random had the name changed . so it was best to probably ripple it everywhere. Okay so I think Tuesday with name change rather than Monday with uncertainty around name change or wednesday if that’s what people need. 
...
**Danny**: Should we talk about it on the [PR](https://github.com/sila-chain/beacon-APIs/pull/190)
...
Please refer detail presentation note for  [“safe-head” confirmation](https://notes.sila.org/@adiasg/safe-head) rule
...
**Proto**: Team made a demo of “blob transactions” (data availability) at EthDenver. Preparing an SIP, and it will also involve consensus layer work.
...
https://github.com/sila-chain/pm/issues/484

- From danny to Everyone 02:23 PM

https://notes.sila.org/@timbeiko/kiln-milestones

- From pari to Everyone 02:25 PM

Current versions used in merge-devnet-4 can be found here: https://notes.sila.org/D5xK4XrmTb6MKGudf_hcrg
...
All namespaces (sil etc) are available on the authenticated port
cc Paul

- From Dankrad Feist to Everyone 02:40 PM

Next Adias and I would like to discuss the safe head rule: https://notes.sila.org/@adiasg/safe-head
