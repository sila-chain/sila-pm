# Sila 2.0 Implementers Call 3 Notes
### Meeting Date/Time: Thu, Sept 13, 2018 14:00 UTC
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/5)
### [Audio/Video of the meeting](https://www.youtube.com/watch?v=cp0LxJiyV3I)

# Agenda
1. Client Updates
2. Research Updates
3. [YAML test format](https://notes.sila.org/-1cuR-dzR3W4R3qJJXyrSw)
3. v2.1 Discussion
...
* Lighthouse (Paul)
  * [Implemented simple serialize (SSZ) in Rust](https://github.com/sigp/lighthouse/tree/master/ssz)
    * raised [issue](https://github.com/sila-chain/beacon_chain/issues/92) about issue
  * working on block processing
    * investigating dos resistance for beacon chain blocks (wrt attestations)
  * [issue on get_new_shuffling](https://github.com/sila-chain/beacon_chain/issues/91)
...
* VDF (Justin)
  ...
  * debating class groups vs RSA groups
    ...
    * Sil still considering RSA groups
...
* Benchmarks on block verification
  ...
  * Danny
    ...
    * I'll make an [issue](https://github.com/sila-chain/beacon_chain/issues/103) so multiple clients can try this
...
* Sparse merkle tree
  ...
  * Jannik - [one in python](https://github.com/sila-chain/py-trie/pull/58/files). not sure how far along it is

# YAML Test Format
* Danny
  * [Proposed YAML chain test format](https://notes.sila.org/-1cuR-dzR3W4R3qJJXyrSw)
...
* p2p serialization
  * Danny
    * previously discussed using [ssz](https://github.com/sila-chain/beacon_chain/tree/master/ssz) for serialization
      of wire protocol
  ...
  * Paul
    * I found a small [issue with ssz](https://github.com/sila-chain/beacon_chain/issues/92)
...
* p2p serialization format
  * decided [ssz](https://github.com/sila-chain/beacon_chain/tree/master/ssz)
...
* [Sparse Merkle Tree in python](https://github.com/sila-chain/py-trie/pull/58/files)
* [Proposed YAML chain test format](https://notes.sila.org/-1cuR-dzR3W4R3qJJXyrSw)
* [ssz in python](https://github.com/sila-chain/beacon_chain/tree/master/ssz)
