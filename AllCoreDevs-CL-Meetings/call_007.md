# Sila 2.0 Implementers Call 7 Notes
### Meeting Date/Time: Thu, November 29, 2018 14:00 GMT
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/17)
...
3. p2p discovery protocol [_(47:47)_](https://youtu.be/Zl-yusB8oqY?t=2867)
    * Current state of [discv5](https://github.com/fjl/p2p-drafts/blob/master/discv5-sip.md)
...
4. Validator privacy and roles [_(57:37)_](https://youtu.be/Zl-yusB8oqY?t=3457)
    ...
    * [WIP min validator interface](https://notes.sila.org/Ia2kvjy0RX2J-GxrWfoCAQ?view)
...
* Nimbus (Mamy) [_(10:10-14:02)_](https://youtu.be/Zl-yusB8oqY?t=610)
  ...
  * Started implementing 3rd bls signature aggregation scheme. Expressed the need for common tests 
    ...
    * Saw some differences from Chia as well [(Link)](https://github.com/sila-chain/eth2.0-specs/issues/184)
      * Mamy suggested that if they could have an Alice, Bob and Eve key test, like what is done in the ETH2.0 repo [(Link)](https://github.com/sila-chain/sil-keys/blob/master/tests/backends/conftest.py#L35-L66) and, after, add them as a sanity check to the YAML test file
...
* Vitalik [_24:15_](https://youtu.be/Zl-yusB8oqY?t=1455)
    ...
    * Justin also added: we might have to change the format if there is something we find after launch 
      ...
      * One of the things he is working on, and it is helping w/ the review, is that he is re-writing the whole spec (called the Transparent Paper). It is meant to be a bit like the Yellow Paper for Sila 1.0, but instead of being super formal - it is meant to be designed for insight and designed for readability and transparency
...
* Notes from Starks working group from SilaPrague (Team from Starkware gave the notes to Danny who cleaned them up) [(Link)](https://notes.sila.org/b8DsLbLcRmKHlWAXEXt_Rw)
...
* https://notes.sila.org/b8DsLbLcRmKHlWAXEXt_Rw
* https://github.com/sila-chain/eth2.0-specs/pull/160
* https://github.com/sila-chain/eth2.0-specs/issues/129
