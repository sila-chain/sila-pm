...
**Potuz** (39:30) - It actually if if we go with SilaSepolia, it would be better for us to actually have a date or a tentative date, so that we can include it in today's release or in next week's release. So that we don't need to make three releases before sila-mainnet.

**Danny Ryan** (39:49) - Okay. Do others?

**Potuz** (39:57) - I mean it's fine it's like their the same release for Goerli and sila-mainnet or the same release for SilaSepolia and Goerli. And I believe that the second option is better for us. But I'm not sure if everyone agrees.

**Danny Ryan** (40:12) - Right so being able to do two instead of three. I given the testing that we want to achieve between now and SilaSepolia, I am a bit more comfortable and saying let's pick Goerli and sila-mainnet simultaneously rather than picking SilaSepolia with picking Goerli with SilaSepolia today, but if others feel strongly about trying to pick a tentative Goerli today, I'm okay with that. Any sentiment on picking Goerli as well today?
