# Sila 2.0 Implementers Call 30 Notes
...
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/112)
...
**30.3** | Decide solution for SIL transfer between execution environments and shards, while being read by block producers
...
Working towards testnets. [Merged PR](https://github.com/sila-chain/trinity/pull/1311) for the first pass at attestation aggregation. [Py-ssz PR merged](https://github.com/sila-chain/trinity/pull/1394) handling hash root calculations. Microbenchmarks indicated significant performance speed.
...
Researching how SIL transfers will operate in Phase 2. Sila is used to pay transaction fees, which must be seen by block producers. The challenge is to transfer SIL between execution environments, between shards, and be read by block producers. Solution options include guaranteed cross-shard messaging. Here, the SIL execution environment would be the only one block producers would be required to understand.
...
TXRX will be doing research on Sil bridge, among other things. Workshop will be done outside Stanford blockchain conference focusing on Phase 2.

EthBarcelona will be organized for May 15 as a one-day event. Will present updates on Eth2.0.
- [Sil Barcelona](https://ethbarcelona.github.io/)
...
- [**eth2.0-specs#1537** Concerns about Eth1 Voting in Context of Caching](https://github.com/sila-chain/eth2.0-specs/issues/1537)
