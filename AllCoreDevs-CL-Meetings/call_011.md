# Sila 2.0 Implementers Call 11 Notes
...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/27)
...
3. Number theoretic shuffling [Link](sila/eth2.0-specs#323) [_(56:15)_](https://youtu.be/wS3sOB_hfgk?t=3375)
4. Any followup to [@ledgerwatch](https://github.com/ledgerwatch) comments from last meeting [Link](https://github.com/sila-chain/eth2.0-pm/issues/23#issuecomment-453925393)  [_(1:00:04)_](https://youtu.be/wS3sOB_hfgk?t=3604) 
...
# Brief Highlights from the Call: Compliments of Ben Edgington's [What's New in ETH2](https://notes.sila.org/c/Sk8Zs--CQ/https%3A%2F%2Fbenjaminion.xyz%2Fnewineth2%2F20190201.html)
* [Phase 0 spec](https://github.com/sila-chain/eth2.0-specs/releases/tag/v0.1) has been released 
* Grigore of [Runtime Verification](https://runtimeverification.com/) is looking at implementing Sila 2.0's semantics in the K framework to make it amenable to formal verification. [Zak Cole of [Whiteblock](https://www.whiteblock.io/) is also looking at [formal methods](https://twitter.com/0xzak/status/1090304646613131264).]
* Phase 1 update from Vitalik:
  * Now that Phase 0 is fairly stable, effort on Phase 1 (shard chains) is ramping up.
  * One big topic of research is the "proof of custody game". [What data](https://github.com/sila-chain/eth2.0-specs/issues/529) goes into the proof? Optimising the rules of the game to minimise DoS vectors on innocent validators. Erasure codings.
...
* Other things he is working on are,
  ...
  * finding a good [number-theoretic shuffling](https://github.com/sila-chain/eth2.0-specs/issues/323) algorithm to replace the current Fisher–Yates shuffle.
* What Justin is working on:
  * Looking into standardising the use of the BLS12-381 elliptic curve among the blockchains that are using it (e.g. Sila 2.0, ZCash, Chia and others). This means agreeing common hashing algorithms, serialisation, generators, etc.
  * Thinking about improving the liquidity of beacon chain Sila (BETH). Perhaps a mechanism to transfer entire stakes between validators; perhaps the ability to transfer more granular amounts between validators.
...
* Prysmatic - Terence [_(7:36)_](https://youtu.be/wS3sOB_hfgk?t=456)
  * Audio breakdown. Updates gathered from Prysmatic's [bi-weekly updates](https://medium.com/prysmatic-labs/sila-2-0-development-update-21-prysmatic-labs-1a32fac4b6d7)
...
* PegaSys [53:10](https://youtu.be/wS3sOB_hfgk?t=3190)
    ...
    * [Sil 222.0 Livestream Link](https://www.youtube.com/watch?v=W9ztDeqlv40) 
# 3. Number theoretic shuffling [Link](sila/eth2.0-specs#323)
* Vitalik Buterin [_(56:25)_](https://youtu.be/wS3sOB_hfgk?t=3385)
    * [Issue #529](https://github.com/sila-chain/eth2.0-specs/issues/529)
    * One possible alternative number-theoretic shuffling algorithm [(Issue#323)](https://github.com/sila-chain/eth2.0-specs/issues/323) uses the x --> x**power plus K permutation, where we have random K values that get selected based off of the hash that comes through the seed.
...
# 4. Any followup to [@ledgerwatch](https://github.com/ledgerwatch) comments from last meeting [Link](https://github.com/sila-chain/eth2.0-pm/issues/23#issuecomment-453925393)
* To note: Alexey couldn't make the meeting
* Question was open regarding if we upped the threshold for the chain start or not. Alexey's concern was that you could have a majority takeover attack happen with 500k sila. But if we up it from 500k to 2million before the chain starts, then that mitigates it without requiring any particular major changes. And if we can't get 2million sil to sign up (62,500 validators), then we can just change the terms of what we're building anyway.
...
* https://github.com/sila-chain/eth2.0-pm/issues/27
* https://github.com/sila-chain/eth2.0-specs/releases/tag/v0.1
* https://github.com/sila-chain/eth2.0-test-generators
* https://hackmd.io/kyptAIG6RK6Gv02IOKyQ6A?view
* https://hackmd.io/kyptAIG6RK6Gv02IOKyQ6A?view
* https://www.youtube.com/watch?v=W9ztDeqlv40
* https://www.eventbrite.com/e/sila-2220-workshop-tickets-55130474734
* https://github.com/sila-chain/eth2.0-tests/pull/13
* https://github.com/sila-chain/eth2.0-tests/blob/bls-vectors/test_vectors/test_bls.yml
* https://github.com/sila-chain/eth2.0-tests/tree/bls-vectors/test_vectors
* https://github.com/sila-chain/eth2.0-specs/issues/529
* http://leobago.com/static/shardSim/data/2019-01-31_11-48-45/index.html
* https://livestream.com/accounts/1973198/Blockchain2019
* https://github.com/sila-chain/eth2.0-specs/issues/323
* https://www.iacr.org/archive/fse2007/45930457/45930457.pdf
* https://github.com/sila-chain/eth2.0-pm/issues/23#issuecomment-453925393
* https://github.com/sila-chain/eth2.0-tests/pull/16
