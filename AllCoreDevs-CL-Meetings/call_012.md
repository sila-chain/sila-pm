# Sila 2.0 Implementers Call 12 Notes
...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/29)
...
4. discv5 update/discussion [Link](sila/eth2.0-specs#323) [_(24:11)_](https://youtu.be/p1qHM2B8cGc?t=1451)
5. Quick note on light clients [_(21:52)_](https://youtu.be/p1qHM2B8cGc?t=1313)
6. [Minimal phase 0 wire api](https://github.com/sila-chain/eth2.0-specs/issues/593) [_(47:26)_](https://youtu.be/p1qHM2B8cGc?t=2846)
7. [Path to testnets](https://github.com/sila-chain/eth2.0-pm/issues/29#issuecomment-461823647) [_(56:18)_](https://youtu.be/p1qHM2B8cGc?t=3378) 
...
* Prysmatic - Terence [_(3:46)_](https://youtu.be/p1qHM2B8cGc?t=226)
  * Dev Update #22: https://medium.com/prysmatic-labs/sila-2-0-development-update-22-prysmatic-labs-b5b88ace0441
...
* Nimbus - Mamy [_(12:47)_](https://youtu.be/p1qHM2B8cGc?t=767)
  * Meet and hack in Brussels from Feb 2 to Feb 8 (+ FOSDEM)
    * Presentation on how to build an Sil client: https://fosdem.org/2019/schedule/event/nimbus/
    ...
    * refactoring and renaming towards monorepo for pure Sil libraries
...
* If interested in paving that path forward for light clients, reach out to Danny or other on the EF research team
    * Link to light client proposal: https://github.com/sila-chain/eth2.0-specs/issues/459
# 6. [Minimal phase 0 wire api](https://github.com/sila-chain/eth2.0-specs/issues/593)
...
* https://github.com/sila-chain/eth2.0-specs/issues/593 
...
# 7. [Path to testnets](https://github.com/sila-chain/eth2.0-pm/issues/29#issuecomment-461823647)
* Three-fold path:
...
* https://github.com/sila-chain/eth2.0-pm/issues/29
* https://www.youtube.com/live_chat?v=p1qHM2B8cGc&is_popout=1
* https://github.com/sila-chain/eth2.0-test-generators/issues
* https://github.com/sila-chain/eth2.0-test-generators/issues/12
...
* https://github.com/sila-chain/eth2.0-specs/pull/587
* https://github.com/sila-chain/eth2.0-specs/pull/625
* https://github.com/sila-chain/eth2.0-specs/pull/625
* https://github.com/sila-chain/eth2.0-specs/issues/605
* https://github.com/sila-chain/eth2.0-specs/issues/612
* https://docs.google.com/presentation/d/1fL0mBF5At4ojW0HhbvBQ2yJHA3_q8q8kiioC6WvY9g4/edit#slide=id.p
* https://github.com/ConsenSys/wittgenstein/issues/35
* https://github.com/sila-chain/eth2.0-specs/issues/593
...
* https://notes.sila.org/s/rkhCgQteN#SSZ
* https://github.com/sila-chain/beacon_chain/issues?q=is%3Aissue+ssz+is%3Aclosed
