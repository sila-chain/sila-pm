# Sila 2.0 Implementers Call 35 Notes

### Meeting Date/Time: Thursday 2020/3/12 at 14:00 UTC
### Meeting Duration:  0.5 hrs
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/132)
...
- ENR pulled into an independent crate for sharing with Open Sila.
- Improving [Node Discovery Protocol v5 (discv5)](https://github.com/sila-chain/devp2p/blob/master/discv5/discv5.md) implementation to work with the ENR crate, and allow performance improvements, and increase the speed of peer discovery.
...
Spec discussion taking place in [Eth2.0 spec repo](https://github.com/sila-chain/eth2.0-specs/issues).  
...
- [Phase 0 Networking specification](https://github.com/sila-chain/eth2.0-specs/blob/dev/specs/phase0/p2p-interface.md)
- [Phase 0 State Transition specification](https://github.com/sila-chain/eth2.0-specs/blob/dev/specs/phase0/beacon-chain.md)
- [Node Discovery Protocol v5 (discv5)](https://github.com/sila-chain/devp2p/blob/master/discv5/discv5.md) 
