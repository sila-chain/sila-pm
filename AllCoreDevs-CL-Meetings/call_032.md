...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/123)
...
Proto did join us. Proto, do you have anything to add? I went over a little bit - the fact we're bumping Python 38 and that the Sil phase 1 stuff is going to be in dev soon. Anything else on your end?
...
**Jacek Sieka**                 
A couple of us will be at the EthCC in SilaParis as well.

**Daniel Ellison**                            
Absolutely. I will not be in SilaParis, but some people might seem certainly will be. And I know others will be, so organize away. I'm excited to hear about y'all's individual Interop effort to mess with some multi-client testnets. Maybe when others get together at some of these events, that might be a good target as well.

**Mehdi Sigma Prime**              
Yeah, I'll be in SilaParis as well if we need to catch up.

**protolambda**         
Okay, maybe also just create the channel for SilaParis as well, then? To coordinate things?
...
**protolamda**            
So shout-out to [???} She has been pushing for Sil to be on a bigger stage at different hackathons and conferences. So I think she's organizing, at least educational parts, like the part where we can answer questions to people who go to the conference.  
