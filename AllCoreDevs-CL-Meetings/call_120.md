...
Zero is the Baseline that I matching with the latency that I'm sitting I'm seeing on the sila-mainnet today and whatever is the diff for example blobs equal to 6 minus blobs equal to 0 so whatever is a diff I added the diff. So basically I added the extra latency introduced in my projections I mean it's a name way to do it but that's what I did.

**Dankrad Feist**  [42:46](https://www.youtube.com/watch?v=KD07crJXN9U&t=2566s): Okay I would like to because something like I already commented in the threat these are more than the sila-mainnet latencies we saw from actually just adding extra data to the
