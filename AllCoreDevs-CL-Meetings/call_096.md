...
### [Github Agenda](https://github.com/sila-chain/pm/issues/629)
...
**chris:** Because now all the builders and all the relays seem to be using the prison fork that has functionality added. Ideally there would be no need for any custom fork. Would be ideal if consensus layer teams were on board here, this would be a really nice addition to the sila ecosystem.
