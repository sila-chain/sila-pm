# Sila 2.0 Implementers Call 9 Notes
...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/21)
...
* Pegasys - Joseph Delong [_(12:19)_](https://youtu.be/6trA-5rjZUQ?t=680)
  ...
  * Ben's What's New in ETH2 from Dec. 28: [_(Link)_](https://notes.sila.org/c/Sk8Zs--CQ/https%3A%2F%2Fbenjaminion.xyz%2Fnewineth2%2F20181228.html)
...
* Parity - Fredrik Harrysson [_(16:22)_](https://youtu.be/6trA-5rjZUQ?t=982)
  ...
  * Participation in the proposal to switch serialisation to Little-Endian [(Link)](https://github.com/sila-chain/eth2.0-specs/pull/139)
# 2. Research Updates  
...
* Mikerah asked a question regarding the running of beacon nodes (& incentives for running them)
    ...
    * [Link](https://github.com/sila-chain/eth2.0-specs/issues/157) to issue: #157
* Joseph Delong asked about issue #386 [(Link)](https://github.com/sila-chain/eth2.0-specs/issues/386) and why are validator balances no longer part of ValidatorRecord?
    * [PR#317](https://github.com/sila-chain/eth2.0-specs/pull/317) was the update that made the changes to that
...
* https://github.com/sila-chain/eth2.0-specs/issues/157
