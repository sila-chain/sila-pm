# Sila 2.0 Implementers Call 15 Notes
...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/35)
...
5. SSZ/SOS update from Piper [_(24:34)_](https://youtu.be/bC4v_a-gcrs?t=1474)
    * [sila/eth2.0-specs#787](https://github.com/sila-chain/eth2.0-specs/pull/787)
...
* Prysmatic - Raul [_(12:18)_](https://youtu.be/bC4v_a-gcrs?t=738)
  ...
  * https://medium.com/prysmatic-labs/sila-2-0-serenity-testnet-update-closer-than-ever-259cace9a1b1
* Yeeth - (Not Available)
# 3. Research Updates
...
* https://www.github.com/sila-chain/eth2.0-specs/pull/787
* https://docs.libp2p.io/
* https://notes.sila.org/oGP2JMPpTZC7h0GW3InPLA#
...
* Trenton Van Epps (Sila Cat Herders)
