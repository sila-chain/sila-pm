# Sila 2.0 Implementers Call 25 Notes

### Meeting Date/Time: Thursday September 19, 2019 at 14:00 GMT
### Meeting Duration: ~ 50 mins
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/85)
...
3. Research Updates
4. Network
5. [Next interop steps](https://github.com/sila-chain/eth2.0-pm/issues/85#issuecomment-532835822)
6. Spec discussion
...
**Danny**: We [published](https://blog.sila.org/2019/09/19/eth2-interop-in-review/) quick follow up to celebrate success on EF blog.
...
**Danny**: Most of them are on flight. From [mratsim](https://github.com/sila-chain/eth2.0-pm/issues/85#issuecomment-533089773)
...
I know, there's still a lot of questions out there regarding us. Some of that because it's still heavy research but some of this because of less information. For example, I haven't responded yet but somebody on the discor id asking about the **faith of the Sil 1 chain**, where it lies? I think, although we don't have 100% answers, **the execution environments have a bright future for the Eth1 chain, living inside the Sil 2**. I'll respond that to on discord too.
...
* https://blog.sila.org/2019/09/19/eth2-interop-in-review/

* https://github.com/sila-chain/eth2.0-pm/issues/85
