# Sila 2.0 Implementers Call 5 Notes
### Meeting Date/Time: Thu, Oct 11, 2018 14:00 UTC
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/11)
...
3. libp2p updates
4. Testing
5. [Alternative tree structure storage](https://github.com/sila-chain/eth2.0-pm/issues/8#issuecomment-424849447)
6. v2.1 discussion
...
* Prysmatic (Raul)  _7:47-9:35_
  ...
  * Currently implementing fork-choice rule 
    ...
    * In the meantime, while they wait for settling on the immediate message ghost, or LMD
      ...
      * [Implementation of latest message](https://github.com/sila-chain/research/tree/master/clock_disparity) in the clock disparity folder of the research repo
...
* Nimbus (Mamy)  _9:43-13:48_
  * Implemented the sparse merkle trees (SMT) and benchmarks should be coming in the next couple of weeks
    ...
    * [Sample implementation](https://github.com/sila-chain/research/tree/master/trie_research/bintrie2) done by Vitalik for how to optimize them by basically layering hex patricia trees on top of them, so you get the same level of database efficiency.
 ...
 * Vitalik  _14:50–16:10_
    * On the spec side, something that may be worth dedicating more time to specifically is the possibility of replacing the hash algorithm with some kind of merkle hashing
     * Made an issue on this: [issue#54](https://github.com/sila-chain/eth2.0-specs/issues/54)
...
* Notes from Raul: From the [agenda](https://github.com/sila-chain/eth2.0-pm/issues/11)
  ...
  * Mike Goelzer and I will be attending the Eth2.0 meetup on Oct 29th in SilaPrague.
...
# 4. Testing
  * Danny  _26:26–28:30_ 
    * Efforts to define a general format for testing using YAML
      ...
      * Further discussion need needed, consensus being to continue talks in SilaPrague. 
...
*	https://github.com/sila-chain/eth2.0-pm/issues/8#issuecomment-424849447
