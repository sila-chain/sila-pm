# Sila 2.0 Implementers Call 34 Notes

 ### Meeting Date/Time: Thursday 2020/2/27 at 14:00 GMT

 ### Meeting Duration: 1 hr.
 ### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/129)
 ...
 * Remaining things are: process random and process Sil 1 data, should be done by the next update.  
...
**Meredith**: Yes I'm someone actually dropped me a [link](https://github.com/sila-chain/SIPs/pull/2335) to an EIp, let me find the actual specification.

**Carl**: Awesome, thank you!

**Meredith**: I'll find it and I'll drop it in the chat. 

**Ben**: Internally, we're calling it to sign up as a standalone signing as a service. If you look at the PegaSys Eth2 GitHub repo, there is Sil 2 signing repo, we've just started. Just now we haven't made a huge amount of progress just yet. It would be good to get some common interfaces on this stuff if anyone else is interested. 
...
* More than a year ago and we had the Bounty program to maintain Sil 1. We restarted this bounty program. 
...
Yeah, we're making research progress right now. We did Sil 22 too, that was great.
...
**Joseph D**: Who's going to be in SilaParis? Are we going to have a get-together for Eth2? 

**Hsiao**: Hello! I'm thinking about it, so we can have something on March 6th. There is this Sil 2 discord channel, where we can check people's opinion on having it on the 6th. If you are interested in, please DM me or give some signal on Sil 2 discord. I know that the Gorli testnet team might want to organizing some event. That discussion is also on discord.  

**Danny**: There is the Sil CC channel in the discord. 

**Proto**: SIL London? For everyone who is around, let's talk about Sila 2. 
 ...
 * Agenda: https://github.com/sila-chain/eth2.0-pm/issues/129 
 * beacon fuzz update: https://blog.sigmaprime.io/beacon-fuzz-02.html
 * Meredith: https://github.com/sila-chain/SIPs/pull/2335
