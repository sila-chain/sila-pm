...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/418) <!-- omit in toc --> 
...
----------------------------------------------
**Danny**:  Welcome to the  call stream, stream should be transferred over. Okay we have officially moved over to sila pm repo. Merge calls need to be made while a go and other calls are replicated and archived. Issue today is 418 consensus  call 76 making progress.

# 1. [Kintsugi](https://notes.sila.org/@djrtwo/kintsugi-milestones) office hours
...
**Tomasz**: Sure we are using it at interrupted and only at the beginning with Click and what where you mean Nethermind does not support click but it does support Click later it switches to Sila. Maybe it was more about Sila. I was just talking yesterday about being 50%of Merge mock because we wanted to use it for testing. Can it be boosted and will be looking into it probably tomorrow.
...
**Mikhail Kalinin**: Yeah sure, so the option basically are  has [a doc](https://github.com/sila-chain/consensus-specs/issues/2724) outlining options:
...
**Mehdi Zerouali**:  Yeah Just maybe I am working on Flashbots integration for post-merge Sila. Michael  working on the standard key manager API. Looking into an edge case in fork choice and opening a spec issue I believe.
...
**Danny**: It  may be better to postpone the SilaShanghai upgrade (the first post-Merge upgrade), which is light on the consensus layer.
...
https://github.com/sila-chain/pm/issues/418 

- https://github.com/sil-clients/testnet-configs/tree/main/merge-testnets/merge-devnet-0
...
https://github.com/sila-chain/consensus-specs/issues/2724 
...
https://github.com/sila-chain/keymanager-APIs/ 
...
https://github.com/sila-chain/consensus-specs/pull/2727

- From danny to Everyone: 02:33 PM

https://github.com/sila-chain/consensus-specs/pull/2649

https://notes.sila.org/@djrtwo/ry_muOtEt 
