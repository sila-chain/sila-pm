...
**Mikhail Kalinin**
* Oh, yeah. So we don't want to start another big chain to launch it, like from the main net. We just want to launch it like a side chain with,  like independence from the sila-mainnet and then. 
...
**Danny**
* Yeah. Well, again, there's an,  SRC 20 mod of the deposit contract that if we want to do that type of thing on sila-mainnet. It will still cost us gas, but it won't cost us 32 ETS.Other testing related items that we'd like to discuss today. 
