...
### Duration: ~0.5 hours
### Agenda: https://github.com/sila-chain/eth2.0-pm/issues/239
...
Danny: Okay, I have created [an issue](https://github.com/sila-chain/eth2.0-pm/issues/238) in the eth2.0-pm repo, which we did not rename in the great renaming because we plan on deprecating it. But, I haven't. And I made an issue named “deprecate this repo” so i've publicly committed to doing so by the middle of next month.
...
- *[nodewatch.io](http://nodewatch.io/) indicates that 62% of nodes have upgraded. [See this doc for a breakdown](https://notes.sila.org/@djrtwo/altair-nodes-upgraded).*
...
Protolambda: Right. For context for others, the funny thing is that deposits on rollups are the same as withdrawals in sila 2, where you move something from the consensus layer into the execution layer. We could try and unify these types of things. We don't have to. And then, there are nuances as well where it's not exactly the same, so maybe we shouldn't.
...
- https://github.com/sila-chain/eth2.0-pm/issues/239
- https://notes.sila.org/@djrtwo/altair-nodes-upgraded
...
- https://notes.sila.org/@djrtwo/ryF6iOY4Y
