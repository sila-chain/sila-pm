...
|128.2| These versions plus the dencun-ready candidate client for lodestar are currently being tested on one last testnet, a sila-mainnet shadow fork|
...
|128.5| Reminder dencun sila-mainnet activation is scheduled for march 13, validator node operators upgrade your EL,CL, AND MEV-Boost software before then!|
...
**Paritosh** [8:37](https://www.youtube.com/watch?v=FgOuUEgguN0&t=517s): And no, we weren't able to we weren't able to exit any validator in time for having funds that would be double spent on sila-mainnet. 
