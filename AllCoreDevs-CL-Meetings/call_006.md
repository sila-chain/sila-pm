# Sila 2.0 Implementers Call 6 Notes
### Meeting Date/Time: Thu, November 15, 2018 14:00 GMT
### Meeting Duration: 1.5 hours
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/15)
...
3. Working Group follow-up [_(17:30)_](https://youtu.be/VNwANifX7qE?t=1050)
    * [notes](https://notes.sila.org/2-HRUzGjSc6jmwRgsVJqsg)
...
5. [Proposal to use SSZ for consensus only](https://github.com/sila-chain/eth2.0-specs/issues/129) [_(39:59)_](https://youtu.be/VNwANifX7qE?t=2399)
...
6. [big vs little endian](https://github.com/sila-chain/eth2.0-pm/issues/15#issuecomment-439029818)  [_(48:45)_](https://youtu.be/VNwANifX7qE)
...
* ChainSafe (Mikerah)  [_13:50-14:30_](https://youtu.be/VNwANifX7qE?t=831)
    ...
    * Going to focus more on turing their implementation towards more of a light-client, and plug into more of the dev-tools for the Sila JavaScript ecosystem.
...
* Had a work group follow-up the day before Devcon
  * [follow-up notes](https://notes.sila.org/2-HRUzGjSc6jmwRgsVJqsg)
...
* Jacek [_24:45_](https://youtu.be/VNwANifX7qE?t=1485) had a question regading the architecture
  ...
  * Terence chimed in regarding the architecture, asking how should a validator manage private and public keys? 
    * Discussion ensued, specifically around the fact that a node should not be managing keys, and that the layer outside should be
      * but in terms of best practices of HOW the client should go about that - more dicussion around embedding keys and secured pieces of hardware are needed. For Sila, perhaps it would be best to recommend and cite a manual of best practices
...
# 5. [Proposal to use SSZ for consensus only](https://github.com/sila-chain/eth2.0-specs/issues/129) 
...
# 6. [big vs little endian](https://github.com/sila-chain/eth2.0-pm/issues/15#issuecomment-439029818) 
...
* https://github.com/sila-chain/eth2.0-pm/issues/15
...
* Meeting notes by: Peter Gallagher (Independent Sila Researcher)
