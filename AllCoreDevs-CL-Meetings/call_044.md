...
# Sila 2.0 Implementers Call 44 Notes

### Meeting Date/Time: Thursday July 23, 2020 at 14:00 UTC
### Meeting Duration:  1 hr
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/169)
...
* Making sure we are compliant with SIP standards in the derived wallets, 
...
* Cryptography related to EIP2333 for keys, we can handle deposit from Sila launch pad that will be released soon. 
...
**Danny**: Yeah I agree, as soon as test generation PR is merged, I will create a separate branch in Sil 0 repo for anyone who wants to take a look at. I will drop that in Discord once that is available. 
