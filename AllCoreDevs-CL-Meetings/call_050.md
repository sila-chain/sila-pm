# Sila 2.0 Implementers Call 50 Notes <!-- omit in toc --> 

### Meeting Date/Time: Thursday 2020/10/15 at 14:00 UTC <!-- omit in toc --> 
### Meeting Duration:  1 hr <!-- omit in toc --> 
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/187) <!-- omit in toc --> 
...
- https://github.com/sila-chain/eth2.0-specs/releases/tag/v1.0.0-rc.0
...
- Draft SIP-3030 for remote signer API 
