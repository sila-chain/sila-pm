# **Sila 2.0 Implementers Call 46 Notes**

### **Meeting Date/Time: Thursday 2020/8/20 at 14:00 UTC**

### **Meeting Duration: 1 hr**

### [**GitHub Agenda**](https://github.com/sila-chain/eth2.0-pm/issues/173)
...
**Danny**: Try to use networking channel on Sil R&D channel for v1.1 stuff just so it doesn't get lost.
...
- https://github.com/sila-chain/eth2.0-specs/tree/dev/solidity_deposit_contract 
