...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/555)
...
**Danny Ryan (18:49):** Great. And any update on SilaSepolia?
...
**Dankrad Feist (35:24):** I mean, we know that, this is not news to me. I mean, this is clear that we built this process rolled into them. And the idea is that you can have that hopefully, like trustworthy individuals, organizations take on that role, so that people actually believe that Flashbots provides this or SilaScan provides this or someone and they will actually be trustworthy enough and if they aren't, then someone who can raise suspicion that they aren't then they can be kicked out.
...
**Chris Hager (47:40):** I think the most closely will be on the SIL R&D, the block construction channel. And the issue is this one here which already has a bunch of comments.
...
**Chris Hager (48:13):** Just let me add, I'm pleased to test on SilaSepolia, our (inaudible) relays available. 
...
**Chris Hager (49:18):** I think we can configure our relay on SilaSepolia to (inaudible) produce blocks for 60 (inaudible) which will be fine. We will return 205 
...
**Dustin (52:37):** There's a specific commit in say the Merge testnets or some SIL client
...
**Arnetheduck (59:54):** There's two formats for boot nodes and two formats for SIL one Genesis, if I remember right, vaguely from interrupt events.
...
**Marius Van Der Wijden (1:01:54):** Kind of, probably. We don't have this SIP to to hard fork mapping anywhere in the code.
...
**Danny Ryan (1:05:42):** Alright, anything else on Afri's checkpoint sync comments? If he joins us in a call or two, we can discuss more with him. Okay, next item on the agenda, open discussion, spec, research anything else? Okay, thank you. Happy SilaSepolia, Happy Shadow Fork. Happy Gray Glacier. Talk to you soon.
