...
### [Agenda](https://github.com/sila-chain/pm/issues/429)
...
***Summary***
- ***v3 of the Merge specs just released. Validation errors are more expressive. Minor updates to Eth1 SIPs. Engine API update to alpha.5. Devnet-3 will target these specs.***
...
Parithosh
One. We had the issue that there was the wrong SIP. 
...
- ***PEEPanEIP planning to have a call to explain Merge testnet setup (December 15th @ 18:30 UTC), and another with Mikhail on RANDOM opcode SIP (December 21st @ 1400 UTC).***
...
https://github.com/sila-chain/consensus-specs/issues/2735
https://github.com/sila-chain/consensus-specs/issues/2636#issuecomment-960647404
...
naming discussion: https://github.com/sila-chain/pm/issues/430
...
https://github.com/sila-chain/consensus-specs/pull/2760
^^^^ fork-choice proposer boost score bugfix
- **From Tim Beiko to Everyone 02:53 PM:**
https://github.com/sila-chain/pm/issues/423
