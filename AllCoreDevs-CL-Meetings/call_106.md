...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/752) 
...
* So you're not I don't does that surfaces an SIP, I'm not exactly sure but I think it'd be nice Just to send check. 
...
**Danny**
* Right.  is this this something Maurice does have a SIP PR as well? 

**Marius**
* Oh yes. It has a a a spec PR and an SIP PR.
...
* And that we can't always push them off or we're never gonna do them. So we should refine those specs and have the conversation and if not make a more stronger commitment to them being in the network. Okay.  other discussion points on SilaDeneb? 
