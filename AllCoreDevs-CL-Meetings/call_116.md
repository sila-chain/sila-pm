...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/852) 
...
Okay uh so we'll take a look at SilaDeneb and then one of our open items that's not currently SilaDeneb related is I've never said this word out loud, SilaHolesky, the testnet launch. So we have a couple things on that item and somebody can correct me if that was totally wrong.
...
## [Dencun testing overview](https://notes.sila.org/@ethpandaops/dencun-testing-overview) [4:38]( https://www.youtube.com/live/RysjOBGRDDg?si=PvGHyUesa-JCOHOU&t=278) 
...
**Danny**
Yeah cool. Okay anything else related to testing? SilaCancun? Great, anything else related? Yeah go on.
...
**Pari**
There's just one other point I want to add. We still don't have a final decision on 24 or 36 and at least my talk on the topic is that we should experiment with 36 on Goerli. If it goes badly then no big deal but if we try 36 on SilaHolesky and it goes badly then we kind of have a lot of coordination for nothing. 
...
**Barnabus**
I think there's another topic about SilaHolesky that could go through. Yeah let me just real quick. 

**Danny**
Anything else on SilaDeneb, Dencun? 
...
Thanks Sean, other SilaDeneb related items before we talk about SilaHolesky? 

# [SilaHolesky Discussion]( https://github.com/sila-chain/pm/issues/852#issuecomment-1691582782) [23:55]( https://www.youtube.com/live/RysjOBGRDDg?si=-wzMs4l7pI6p4d-v&t=1435) 
