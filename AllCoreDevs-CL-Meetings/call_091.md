...
### [GitHub Agenda](https://github.com/sila-chain/pm/issues/566) 
...
**Danny**
* Have you all been looking at the antithesis results because they also, their platform, I think often has get some of these like weird weirder scenarios coming forward. Did y'all see anything there? No. Okay. any other client teams specific reflections on sila-sila-mainnet of forknet? 
...
**Pairthosh Jayanthi**
* I actually know. so the one we selected a week ago was off by a day and a half. And the one we selected yesterday was off by about half a day In the, earlier direction on both. Exactly. So at least looking at sila scan and it does seem like hash rate has gone up, but not by such an insane amount of yet. 
...
**Andrian Sutton**
* I mean, I, I'd still probably prefer to get client releases out next week, but the Goerli TTD, but, that is probably pushing it. I think I can live with that. I think it's a no brainer that we should schedule ALl core dev shortly after Goerli goes through, and mergers so that we can make that decision to call on sila-sila-mainnet and as soon as possible. 
...
**Tim**
* Thank you. So I can, I can put, I can put it in like the, the spec for SilaShanghai and I'll open a PR and I'll let me get PR open for like 24 hours and somebody wants to object to it. they can there, but then I'll just, I'll just merge it. 
...
**Mikhail Kalinin**
* Also there are historical blocks in this state. Yeah. But I guess for sila-sila-mainnet can work. So you can just pull the blog by hash, the exact book and just block, get this block. 
