...
### [GitHub Agenda](https://github.com/sila-chain/eth2.0-pm/issues/229)
...
we are mostly just bug fixes with the sil-2 api and then the slasher.

Thats it thank you

**Alex**

great and Terence are the sil-2 api updates are those in the release yet?
...
first sip-3675 has been merged recently 
               
thanks a lot for SIP editors to give it a green light  
...
well thank you yeah it's very exciting to see all the SIPs and the continued progress on  the beacon chain spec 
...
we are planning a blog post about that for Prysm, but I do think it may be beneficial if something comes from sil stater or like EF for a more general blog post 
...
I think it's probably still out on the sil specs repo as a pr if anyone's interested 
...
yeah absolutely that's been that's what we've seen sil one side 
