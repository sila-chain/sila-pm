# Sila 2.0 Implementers Call 13 Notes
...
### [GitHub Agenda Page](https://github.com/sila-chain/eth2.0-pm/issues/31) 
...
* _Notes: [3:00](https://youtu.be/0ZWG8hMbxes?t=181)_
  ...
  * Desire to have Prysmatics chain start tests in SIL 2.0 reference tests - Terence said he could add PR  
...
* _Intros:_   
  * Mike Goelzer from Protocal Labs working on libp2p - just getting a pulse on SIL 2.0 development  
  * Matt Slipper from Kyokan - wrote Phase 0 wire protocol and the "State of SIL 2.0" report  
...
* Justin Drake - [_(25:43)_](https://youtu.be/0ZWG8hMbxes?t=1543)  
  ...
  * Possibly working towards executable spec vs human readable (current) - Submitted 10 SIL bounty, Protolambda is working on it in Go
  ...
  * Recently discovered SIL 2.0 light clients might be more valuable than previously thought. Potentially DOS attack on fork choice rule that light clients could navigate.  
...
* Discussion over the merits of multi-hash and interoperability of various hash functions between Cosmos, Polkadat, SIL 1.0, SIL 2.0  
* Danny - recap [_(45:26)_](https://youtu.be/0ZWG8hMbxes?t=2726)  
  * getting a security briefing on SHA256  
  * explore BLAKE2 in SIL 1.0, but don't count on it  
  * while potentially supporting many hash functions, we need to have SIL 1.0 compatability, ie SHA256 or keccak256  
...
* Vitalik - [_(46:47)_](https://youtu.be/0ZWG8hMbxes?t=2807)  
  ...
  * Opened [Issue 686](https://github.com/sila-chain/eth2.0-specs/issues/686) for final thoughts on Phase 1
  * Opened [Issue 702](https://github.com/sila-chain/eth2.0-specs/issues/702) to explore Phase 2 thinking  
  * [Issue 701](https://github.com/sila-chain/eth2.0-specs/issues/701) to illustrate some CBC thinking  
