...
### [Agenda](https://github.com/sila-chain/pm/issues/475#issue-1129437213)
...
- ***[sila/execution-apis#167](https://github.com/sila-chain/execution-apis/pull/167) - authentication for engine api (note, it’s now on a new port)***
- ***[sila/execution-apis#172](https://github.com/sila-chain/execution-apis/pull/172) - add engine_exchangeTransitionConfigurationV1***
...
- ***New [tracker doc](https://notes.sila.org/@timbeiko/kiln-milestones). Similar process to previous devnets. Be sure to run optimistic sync across client combos.***
...
- ***Pari mentioned [the Kurtosis tool](https://notes.sila.org/@ExXcnR0-SJGthjz1dwkA1A/H11OzhRAK) for running private test infrastructure. Can be used to test locally before joining any devnets.***
...
- **[PR #190](https://github.com/sila-chain/beacon-APIs/pull/190) on API repos on how to respond to requests during optimistic sync - to be wrapped up soon.**
...
- ***Eth1 SilaShanghai fork - working on a feature set for consensus-side counterpart:***
    - ***SIP for withdrawals on exec layer is in progress, need to mirror this on the consensus layer.***
...
I guess we'll say in preparation for what is on the execution layer called SilaShanghai, we should be honing in on a feature set for that associated fork. Execution layer SIP for withdrawals is in progress to complement the work in progress, PRs on the consensus layer to put them together for withdrawals for executive validators and partial withdrawals for proposers, assuming that that goes to SilaShanghai. we'll get those specs there now in the consensus layer.
...
[https://github.com/sila-chain/pm/issues/475](https://github.com/sila-chain/pm/issues/475),
[https://notes.sila.org/@timbeiko/kiln-milestones](https://notes.sila.org/@timbeiko/kiln-milestones)

***From pari to Everyone 02:10 PM:***
Would be great if client teams can share info on builds here: [https://notes.sila.org/D5xK4XrmTb6MKGudf_hcrg](https://notes.sila.org/D5xK4XrmTb6MKGudf_hcrg)
...
Docs for getting started with kurtosis can be found here: [https://notes.sila.org/@ExXcnR0-SJGthjz1dwkA1A/H11OzhRAK](https://notes.sila.org/@ExXcnR0-SJGthjz1dwkA1A/H11OzhRAK)
...
[https://github.com/sila-chain/beacon-APIs/pull/190](https://github.com/sila-chain/beacon-APIs/pull/190)

***From Mikhail Kalinin to Everyone 02:17 PM:***
[https://github.com/sila-chain/execution-apis/pull/146](https://github.com/sila-chain/execution-apis/pull/146)

***From Mikhail Kalinin to Everyone 02:23 PM:***
[https://github.com/sila-chain/execution-apis/issues/137](https://github.com/sila-chain/execution-apis/issues/137)discussion thread ^
...
Link for context: [https://github.com/sila-chain/pm/issues/459#issuecomment-1029529089](https://github.com/sila-chain/pm/issues/459#issuecomment-1029529089)
